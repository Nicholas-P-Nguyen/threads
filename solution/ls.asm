...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 eb 05 00 00       	call   62d <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 10 0b 00 00       	push   $0xb10
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 d9 05 00 00       	call   62d <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb 00 0f 00 00       	mov    $0xf00,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 00 0f 00 00       	add    $0xf00,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 56 05 00 00       	call   66d <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 51 05 00 00       	call   685 <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 fa 04 00 00       	call   655 <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 33 04 00 00       	call   645 <read>
 ...
 313:	e8 3d 03 00 00       	call   655 <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 c8 01 00 00       	call   645 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 8b 01 00 00       	call   66d <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 8e 01 00 00       	call   685 <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 54 01 00 00       	call   655 <close>
  return r;
...
thread_create(void (*fn)(void *), void *arg)
{
 ...
 597:	68 00 20 00 00       	push   $0x2000
 59c:	e8 2f 04 00 00       	call   9d0 <malloc>
  if(mem == 0)
 5a1:	83 c4 10             	add    $0x10,%esp
 5a4:	85 c0                	test   %eax,%eax
 5a6:	74 32                	je     5da <thread_create+0x4a>
 ...
 5af:	74 12                	je     5c3 <thread_create+0x33>
 5b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    p++;
 5b8:	83 c3 01             	add    $0x1,%ebx
  while ((uint)p % 4096 != 0) {
 5bb:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 5c1:	75 f5                	jne    5b8 <thread_create+0x28>
    printf(1, "LOLOLOL %p\n", fn);
    free(stack);
    return -1;
  }
 ...
 5c6:	53                   	push   %ebx
 5c7:	e8 01 01 00 00       	call   6cd <clone>
  if(tid < 0){
 5cc:	83 c4 10             	add    $0x10,%esp
 5cf:	85 c0                	test   %eax,%eax
 5d1:	78 0e                	js     5e1 <thread_create+0x51>
    free(stack);
    return -1;
  }
  ...
  if(tid == 0){
 5d3:	74 1f                	je     5f4 <thread_create+0x64>
    exit();
  }
 ...
 5df:	eb f4                	jmp    5d5 <thread_create+0x45>
    free(stack);
 5e1:	83 ec 0c             	sub    $0xc,%esp
 5e4:	53                   	push   %ebx
 5e5:	e8 56 03 00 00       	call   940 <free>
    return -1;
 5ea:	83 c4 10             	add    $0x10,%esp
 5ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 5f2:	eb e1                	jmp    5d5 <thread_create+0x45>
    printf(1, "Entering thread function at %p\n", fn);
 5f4:	50                   	push   %eax
 5f5:	ff 75 08             	pushl  0x8(%ebp)
 5f8:	68 14 0b 00 00       	push   $0xb14
 5fd:	6a 01                	push   $0x1
 5ff:	e8 9c 01 00 00       	call   7a0 <printf>
    fn(arg);
 604:	5a                   	pop    %edx
 605:	ff 75 0c             	pushl  0xc(%ebp)
 608:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 60b:	89 1c 24             	mov    %ebx,(%esp)
 60e:	e8 2d 03 00 00       	call   940 <free>
    exit();
 613:	e8 15 00 00 00       	call   62d <exit>
...
{
  return join();
 620:	e9 c0 00 00 00       	jmp    6e5 <join>
...
0000062d <exit>:
SYSCALL(exit)
 62d:	b8 02 00 00 00       	mov    $0x2,%eax
 632:	cd 40                	int    $0x40
 634:	c3                   	ret    
...
0000063d <pipe>:
SYSCALL(pipe)
 63d:	b8 04 00 00 00       	mov    $0x4,%eax
 642:	cd 40                	int    $0x40
 644:	c3                   	ret    

00000645 <read>:
SYSCALL(read)
 645:	b8 05 00 00 00       	mov    $0x5,%eax
 64a:	cd 40                	int    $0x40
 64c:	c3                   	ret    

0000064d <write>:
SYSCALL(write)
 64d:	b8 10 00 00 00       	mov    $0x10,%eax
 652:	cd 40                	int    $0x40
 654:	c3                   	ret    

00000655 <close>:
SYSCALL(close)
 655:	b8 15 00 00 00       	mov    $0x15,%eax
 65a:	cd 40                	int    $0x40
 65c:	c3                   	ret    

0000065d <kill>:
SYSCALL(kill)
 65d:	b8 06 00 00 00       	mov    $0x6,%eax
 662:	cd 40                	int    $0x40
 664:	c3                   	ret    

00000665 <exec>:
SYSCALL(exec)
 665:	b8 07 00 00 00       	mov    $0x7,%eax
 66a:	cd 40                	int    $0x40
 66c:	c3                   	ret    

0000066d <open>:
SYSCALL(open)
 66d:	b8 0f 00 00 00       	mov    $0xf,%eax
 672:	cd 40                	int    $0x40
 674:	c3                   	ret    

00000675 <mknod>:
SYSCALL(mknod)
 675:	b8 11 00 00 00       	mov    $0x11,%eax
 67a:	cd 40                	int    $0x40
 67c:	c3                   	ret    

0000067d <unlink>:
SYSCALL(unlink)
 67d:	b8 12 00 00 00       	mov    $0x12,%eax
 682:	cd 40                	int    $0x40
 684:	c3                   	ret    

00000685 <fstat>:
SYSCALL(fstat)
 685:	b8 08 00 00 00       	mov    $0x8,%eax
 68a:	cd 40                	int    $0x40
 68c:	c3                   	ret    

0000068d <link>:
SYSCALL(link)
 68d:	b8 13 00 00 00       	mov    $0x13,%eax
 692:	cd 40                	int    $0x40
 694:	c3                   	ret    

00000695 <mkdir>:
SYSCALL(mkdir)
 695:	b8 14 00 00 00       	mov    $0x14,%eax
 69a:	cd 40                	int    $0x40
 69c:	c3                   	ret    

0000069d <chdir>:
SYSCALL(chdir)
 69d:	b8 09 00 00 00       	mov    $0x9,%eax
 6a2:	cd 40                	int    $0x40
 6a4:	c3                   	ret    

000006a5 <dup>:
SYSCALL(dup)
 6a5:	b8 0a 00 00 00       	mov    $0xa,%eax
 6aa:	cd 40                	int    $0x40
 6ac:	c3                   	ret    

000006ad <getpid>:
SYSCALL(getpid)
 6ad:	b8 0b 00 00 00       	mov    $0xb,%eax
 6b2:	cd 40                	int    $0x40
 6b4:	c3                   	ret    

000006b5 <sbrk>:
SYSCALL(sbrk)
 6b5:	b8 0c 00 00 00       	mov    $0xc,%eax
 6ba:	cd 40                	int    $0x40
 6bc:	c3                   	ret    

000006bd <sleep>:
SYSCALL(sleep)
 6bd:	b8 0d 00 00 00       	mov    $0xd,%eax
 6c2:	cd 40                	int    $0x40
 6c4:	c3                   	ret    

000006c5 <uptime>:
SYSCALL(uptime)
 6c5:	b8 0e 00 00 00       	mov    $0xe,%eax
 6ca:	cd 40                	int    $0x40
 6cc:	c3                   	ret    

000006cd <clone>:
SYSCALL(clone)
 6cd:	b8 16 00 00 00       	mov    $0x16,%eax
 6d2:	cd 40                	int    $0x40
 6d4:	c3                   	ret    

000006d5 <lock>:
SYSCALL(lock)
 6d5:	b8 17 00 00 00       	mov    $0x17,%eax
 6da:	cd 40                	int    $0x40
 6dc:	c3                   	ret    

000006dd <unlock>:
SYSCALL(unlock)
 6dd:	b8 18 00 00 00       	mov    $0x18,%eax
 6e2:	cd 40                	int    $0x40
 6e4:	c3                   	ret    

000006e5 <join>:
SYSCALL(join)
 6e5:	b8 19 00 00 00       	mov    $0x19,%eax
 6ea:	cd 40                	int    $0x40
 6ec:	c3                   	ret    
 ...
 6fc:	89 d1                	mov    %edx,%ecx
{
 ...
 729:	0f b6 92 94 0b 00 00 	movzbl 0xb94(%edx),%edx
 ...
 76e:	56                   	push   %esi
 76f:	57                   	push   %edi
 770:	e8 d8 fe ff ff       	call   64d <write>
  while(--i >= 0)
 ...
 7a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7e5:	57                   	push   %edi
 7e6:	56                   	push   %esi
 7e7:	e8 61 fe ff ff       	call   64d <write>
 ...
 819:	ff 24 85 3c 0b 00 00 	jmp    *0xb3c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 83e:	e8 0a fe ff ff       	call   64d <write>
        putc(fd, c);
 ...
 84f:	57                   	push   %edi
 850:	56                   	push   %esi
 851:	e8 f7 fd ff ff       	call   64d <write>
        putc(fd, c);
 ...
 8bb:	57                   	push   %edi
 8bc:	56                   	push   %esi
 8bd:	e8 8b fd ff ff       	call   64d <write>
        while(*s != 0){
 ...
 8fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8ff:	e8 49 fd ff ff       	call   64d <write>
        ap++;
 ...
 927:	90                   	nop
          s = "(null)";
 928:	ba 34 0b 00 00       	mov    $0xb34,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 941:	a1 10 0f 00 00       	mov    0xf10,%eax
{
 ...
 981:	5b                   	pop    %ebx
  freep = p;
 982:	89 15 10 0f 00 00    	mov    %edx,0xf10
}
 988:	5e                   	pop    %esi
 989:	5f                   	pop    %edi
 98a:	5d                   	pop    %ebp
 ...
 9b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9bc:	89 15 10 0f 00 00    	mov    %edx,0xf10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 3d 10 0f 00 00    	mov    0xf10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4a:	e8 f1 fe ff ff       	call   940 <free>
  return freep;
 a4f:	8b 15 10 0f 00 00    	mov    0xf10,%edx
 ...
 a7c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a7f:	89 15 10 0f 00 00    	mov    %edx,0xf10
}
 ...
 a8f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a90:	c7 05 10 0f 00 00 14 	movl   $0xf14,0xf10
 a97:	0f 00 00 
    base.s.size = 0;
 a9a:	bf 14 0f 00 00       	mov    $0xf14,%edi
    base.s.ptr = freep = prevp = &base;
 a9f:	c7 05 14 0f 00 00 14 	movl   $0xf14,0xf14
 aa6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 aa9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 aab:	c7 05 18 0f 00 00 00 	movl   $0x0,0xf18
 ab2:	00 00 00 
    if(p->s.size >= nunits){
