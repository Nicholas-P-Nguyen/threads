...
80102088:	68 2e 7c 10 80       	push   $0x80107c2e
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 8d 5b 10 80 	movl   $0x80105b8d,0x14(%eax)
  p->context = (struct context*)sp;
...
80103ddf:	ff 73 68             	pushl  0x68(%ebx)
...
80103f2b:	0f 85 95 00 00 00    	jne    80103fc6 <wait+0x106>
  pushcli();
80103f31:	e8 8a 07 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80103f36:	e8 b5 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f3b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f41:	e8 ca 07 00 00       	call   80104710 <popcli>
  if(p == 0)
...
80103fb5:	e8 f6 07 00 00       	call   801047b0 <release>
        return pid;
...
80103fd3:	e8 d8 07 00 00       	call   801047b0 <release>
      return -1;
...
80103ffc:	e8 0f 08 00 00       	call   80104810 <acquire>
  pushcli();
80104001:	e8 ba 06 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80104006:	e8 e5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010400b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104011:	e8 fa 06 00 00       	call   80104710 <popcli>
...
80104029:	e8 82 07 00 00       	call   801047b0 <release>
}
...
8010404c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010404f:	e8 6c 06 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80104054:	e8 97 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104059:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010405f:	e8 ac 06 00 00       	call   80104710 <popcli>
  if(p == 0)
...
80104080:	e8 8b 07 00 00       	call   80104810 <acquire>
    release(lk);
80104085:	89 34 24             	mov    %esi,(%esp)
80104088:	e8 23 07 00 00       	call   801047b0 <release>
  p->chan = chan;
...
801040aa:	e8 01 07 00 00       	call   801047b0 <release>
    acquire(lk);
...
801040bb:	5d                   	pop    %ebp
    acquire(lk);
801040bc:	e9 4f 07 00 00       	jmp    80104810 <acquire>
...
8010410f:	e8 fc 06 00 00       	call   80104810 <acquire>
...
80104150:	c9                   	leave  
  release(&ptable.lock);
80104151:	e9 5a 06 00 00       	jmp    801047b0 <release>
...
8010416f:	e8 9c 06 00 00       	call   80104810 <acquire>
...
801041ab:	e8 00 06 00 00       	call   801047b0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c8:	e8 e3 05 00 00       	call   801047b0 <release>
}
...
801041fb:	68 47 7e 10 80       	push   $0x80107e47
...
80104265:	e8 f6 03 00 00       	call   80104660 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801042ac:	e8 0f 04 00 00       	call   801046c0 <pushcli>
  c = mycpu();
801042b1:	e8 3a f6 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801042b6:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801042bc:	89 55 e0             	mov    %edx,-0x20(%ebp)
  popcli();
801042bf:	e8 4c 04 00 00       	call   80104710 <popcli>
  int i, tid;
  struct proc *np;
  struct proc *curproc = myproc();
  ...
  // Allocate process.
  if ((np = allocproc()) == 0) {
801042c4:	e8 e7 f4 ff ff       	call   801037b0 <allocproc>
801042c9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801042cc:	85 c0                	test   %eax,%eax
801042ce:	0f 84 e4 00 00 00    	je     801043b8 <clone+0x118>
    return -1;
  }

  // Use same page directory as parent (same addr space)
  np->pgdir = curproc->pgdir;
801042d4:	8b 55 e0             	mov    -0x20(%ebp),%edx
801042d7:	89 c7                	mov    %eax,%edi
801042d9:	8b 42 04             	mov    0x4(%edx),%eax
801042dc:	89 47 04             	mov    %eax,0x4(%edi)

  // Copy parent thread stack to child stack
  char *dest_ptr = (char*) stack;
  char *source_ptr = (char*) curproc->kstack;
801042df:	8b 72 08             	mov    0x8(%edx),%esi
  for (i = 0; i < PGSIZE; i++) {
801042e2:	31 c0                	xor    %eax,%eax
801042e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    dest_ptr[i] = source_ptr[i];
801042e8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801042ec:	88 0c 03             	mov    %cl,(%ebx,%eax,1)
  for (i = 0; i < PGSIZE; i++) {
801042ef:	83 c0 01             	add    $0x1,%eax
801042f2:	3d 00 10 00 00       	cmp    $0x1000,%eax
801042f7:	75 ef                	jne    801042e8 <clone+0x48>
  }

  // update cloned thread's stack pointer & other metadata
  np->kstack = (char*) stack;
801042f9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
801042fc:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->kstack = (char*) stack;
80104301:	89 5f 08             	mov    %ebx,0x8(%edi)
  np->sz = curproc->sz;
80104304:	8b 02                	mov    (%edx),%eax
  np->parent = curproc;
80104306:	89 57 14             	mov    %edx,0x14(%edi)
  np->sz = curproc->sz;
80104309:	89 07                	mov    %eax,(%edi)
  np->parent = curproc;
8010430b:	89 f8                	mov    %edi,%eax
  *np->tf = *curproc->tf;
8010430d:	8b 72 18             	mov    0x18(%edx),%esi
80104310:	8b 7f 18             	mov    0x18(%edi),%edi
80104313:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
...
80104315:	89 c7                	mov    %eax,%edi
  ...
  for(i = 0; i < NOFILE; i++)
80104317:	89 fe                	mov    %edi,%esi
  uint offset = (uint)curproc->tf->esp - (uint)curproc->kstack;
80104319:	8b 4a 18             	mov    0x18(%edx),%ecx
  np->tf->esp = (uint)stack + offset;
8010431c:	8b 40 18             	mov    0x18(%eax),%eax
8010431f:	03 59 44             	add    0x44(%ecx),%ebx
80104322:	2b 5a 08             	sub    0x8(%edx),%ebx
80104325:	89 58 44             	mov    %ebx,0x44(%eax)
  np->tf->eax = 0;
80104328:	8b 47 18             	mov    0x18(%edi),%eax
  for(i = 0; i < NOFILE; i++)
8010432b:	31 db                	xor    %ebx,%ebx
8010432d:	89 d7                	mov    %edx,%edi
  np->tf->eax = 0;
8010432f:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80104336:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010433d:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[i])
80104340:	8b 44 9f 28          	mov    0x28(%edi,%ebx,4),%eax
80104344:	85 c0                	test   %eax,%eax
80104346:	74 10                	je     80104358 <clone+0xb8>
      np->ofile[i] = filedup(curproc->ofile[i]);
80104348:	83 ec 0c             	sub    $0xc,%esp
8010434b:	50                   	push   %eax
8010434c:	e8 4f cb ff ff       	call   80100ea0 <filedup>
80104351:	83 c4 10             	add    $0x10,%esp
80104354:	89 44 9e 28          	mov    %eax,0x28(%esi,%ebx,4)
  for(i = 0; i < NOFILE; i++)
80104358:	83 c3 01             	add    $0x1,%ebx
8010435b:	83 fb 10             	cmp    $0x10,%ebx
8010435e:	75 e0                	jne    80104340 <clone+0xa0>

  np->cwd = idup(curproc->cwd);
80104360:	83 ec 0c             	sub    $0xc,%esp
80104363:	ff 77 68             	pushl  0x68(%edi)
80104366:	89 7d e0             	mov    %edi,-0x20(%ebp)
80104369:	e8 e2 d3 ff ff       	call   80101750 <idup>
8010436e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80104371:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104374:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80104377:	89 47 68             	mov    %eax,0x68(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
8010437a:	83 c2 6c             	add    $0x6c,%edx
8010437d:	8d 47 6c             	lea    0x6c(%edi),%eax
80104380:	6a 10                	push   $0x10
80104382:	52                   	push   %edx
80104383:	50                   	push   %eax
80104384:	e8 07 07 00 00       	call   80104a90 <safestrcpy>

  tid = np->pid;
80104389:	8b 5f 10             	mov    0x10(%edi),%ebx

  acquire(&ptable.lock);
8010438c:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104393:	e8 78 04 00 00       	call   80104810 <acquire>
  np->state = RUNNABLE;
80104398:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
8010439f:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043a6:	e8 05 04 00 00       	call   801047b0 <release>
...
801043bd:	eb ef                	jmp    801043ae <clone+0x10e>
801043bf:	90                   	nop
...
801043c4:	53                   	push   %ebx
  pushcli();
801043c5:	e8 f6 02 00 00       	call   801046c0 <pushcli>
  c = mycpu();
801043ca:	e8 21 f5 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801043cf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801043d5:	e8 36 03 00 00       	call   80104710 <popcli>
  struct proc *p;
  int havekids, tid;
  struct proc *curproc = myproc();
...
801043dd:	68 20 1d 11 80       	push   $0x80111d20
801043e2:	e8 29 04 00 00       	call   80104810 <acquire>
...
801043ea:	31 c0                	xor    %eax,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801043ec:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801043f1:	eb 10                	jmp    80104403 <join+0x43>
801043f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801043f7:	90                   	nop
801043f8:	83 c3 7c             	add    $0x7c,%ebx
801043fb:	81 fb 54 3c 11 80    	cmp    $0x80113c54,%ebx
80104401:	74 1b                	je     8010441e <join+0x5e>
      // Finding the child process
      if (p->parent != curproc) {
80104403:	39 73 14             	cmp    %esi,0x14(%ebx)
80104406:	75 f0                	jne    801043f8 <join+0x38>
        continue;
      }
...
8010440c:	74 62                	je     80104470 <join+0xb0>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010440e:	83 c3 7c             	add    $0x7c,%ebx
      havekids = 1;
80104411:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104416:	81 fb 54 3c 11 80    	cmp    $0x80113c54,%ebx
8010441c:	75 e5                	jne    80104403 <join+0x43>
        return tid;
      }
    }
...
80104420:	0f 84 97 00 00 00    	je     801044bd <join+0xfd>
80104426:	8b 46 24             	mov    0x24(%esi),%eax
80104429:	85 c0                	test   %eax,%eax
8010442b:	0f 85 8c 00 00 00    	jne    801044bd <join+0xfd>
  pushcli();
80104431:	e8 8a 02 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80104436:	e8 b5 f4 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010443b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104441:	e8 ca 02 00 00       	call   80104710 <popcli>
  if(p == 0)
80104446:	85 db                	test   %ebx,%ebx
80104448:	0f 84 86 00 00 00    	je     801044d4 <join+0x114>
  p->chan = chan;
8010444e:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104451:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104458:	e8 73 f8 ff ff       	call   80103cd0 <sched>
  p->chan = 0;
8010445d:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80104464:	eb 84                	jmp    801043ea <join+0x2a>
80104466:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010446d:	8d 76 00             	lea    0x0(%esi),%esi
        kfree(p->kstack);
80104470:	83 ec 0c             	sub    $0xc,%esp
        tid = p->pid;
80104473:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104476:	ff 73 08             	pushl  0x8(%ebx)
80104479:	e8 42 e0 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
8010447e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->pid = 0;
80104485:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010448c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104493:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104497:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010449e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801044a5:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801044ac:	e8 ff 02 00 00       	call   801047b0 <release>
        return tid;
...
801044b4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801044b7:	89 f0                	mov    %esi,%eax
801044b9:	5b                   	pop    %ebx
801044ba:	5e                   	pop    %esi
801044bb:	5d                   	pop    %ebp
801044bc:	c3                   	ret    
...
801044bd:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801044c0:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801044c5:	68 20 1d 11 80       	push   $0x80111d20
801044ca:	e8 e1 02 00 00       	call   801047b0 <release>
      return -1;
801044cf:	83 c4 10             	add    $0x10,%esp
801044d2:	eb e0                	jmp    801044b4 <join+0xf4>
    panic("sleep");
801044d4:	83 ec 0c             	sub    $0xc,%esp
801044d7:	68 b4 7a 10 80       	push   $0x80107ab4
801044dc:	e8 9f be ff ff       	call   80100380 <panic>
...
8010451a:	68 44 7b 10 80       	push   $0x80107b44
...
80104575:	e8 c6 fa ff ff       	call   80104040 <sleep>
  while (lk->locked) {
...
801045d4:	e8 27 fb ff ff       	call   80104100 <wakeup>
  release(&lk->lk);
...
80104755:	68 4f 7b 10 80       	push   $0x80107b4f
8010475a:	e8 21 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010475f:	83 ec 0c             	sub    $0xc,%esp
80104762:	68 66 7b 10 80       	push   $0x80107b66
...
801047cb:	68 6d 7b 10 80       	push   $0x80107b6d
...
801048c0:	68 75 7b 10 80       	push   $0x80107b75
...
80104ce7:	83 fa 18             	cmp    $0x18,%edx
80104cea:	77 24                	ja     80104d10 <syscall+0x40>
80104cec:	8b 14 85 a0 7b 10 80 	mov    -0x7fef8460(,%eax,4),%edx
...
80104d18:	68 7d 7b 10 80       	push   $0x80107b7d
...
80104e74:	68 24 7c 10 80       	push   $0x80107c24
...
80104e8c:	68 23 7c 10 80       	push   $0x80107c23
...
80104ea1:	68 17 7c 10 80       	push   $0x80107c17
...
80104ebf:	68 26 7c 10 80       	push   $0x80107c26
80104ec4:	e8 b7 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ec9:	83 ec 0c             	sub    $0xc,%esp
80104ecc:	68 08 7c 10 80       	push   $0x80107c08
...
801052cd:	58                   	pop    %eax
801052ce:	5a                   	pop    %edx
801052cf:	68 24 7c 10 80       	push   $0x80107c24
...
801052e8:	68 23 7c 10 80       	push   $0x80107c23
...
8010594e:	e8 0d e8 ff ff       	call   80104160 <kill>
...
80105a1d:	e8 1e e6 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
...
80105ac8:	78 16                	js     80105ae0 <sys_clone+0x30>
    return -1;
  }
  return clone(stack);
80105aca:	83 ec 0c             	sub    $0xc,%esp
80105acd:	ff 75 f4             	pushl  -0xc(%ebp)
80105ad0:	e8 cb e7 ff ff       	call   801042a0 <clone>
...
80105af4:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
...
80105aff:	e8 dc f0 ff ff       	call   80104be0 <argptr>
80105b04:	83 c4 10             	add    $0x10,%esp
80105b07:	85 c0                	test   %eax,%eax
80105b09:	78 15                	js     80105b20 <sys_lock+0x30>
    return -1;
  }
...
80105b0f:	e8 dc e9 ff ff       	call   801044f0 <lock>
80105b14:	83 c4 10             	add    $0x10,%esp
}
80105b17:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b1a:	c9                   	leave  
80105b1b:	c3                   	ret    
80105b1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80105b20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b25:	eb f0                	jmp    80105b17 <sys_lock+0x27>
...
80105b33:	53                   	push   %ebx
  ...
  if (argptr(0, (char**)&l, sizeof(int)) < 0) {
80105b34:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
...
80105b3f:	e8 9c f0 ff ff       	call   80104be0 <argptr>
80105b44:	83 c4 10             	add    $0x10,%esp
80105b47:	85 c0                	test   %eax,%eax
80105b49:	78 15                	js     80105b60 <sys_unlock+0x30>
    return -1;
  }
...
80105b4f:	e8 ac e9 ff ff       	call   80104500 <unlock>
...
80105b65:	eb f0                	jmp    80105b57 <sys_unlock+0x27>
...
{
  return join();
80105b70:	e9 4b e8 ff ff       	jmp    801043c0 <join>
...
80105bb7:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
80105bbe:	08 00 00 8e 
80105bc2:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
80105bc9:	80 
80105bca:	c1 ea 10             	shr    $0x10,%edx
80105bcd:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
80105bd4:	80 
  for(i = 0; i < 256; i++)
...
80105be7:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
80105bee:	00 00 ef 
  initlock(&tickslock, "time");
80105bf1:	68 69 7c 10 80       	push   $0x80107c69
80105bf6:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105bfb:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
80105c01:	c1 e8 10             	shr    $0x10,%eax
80105c04:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
80105c0a:	e8 31 ea ff ff       	call   80104640 <initlock>
}
...
80105c2b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c2f:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
80105c74:	ff 24 85 10 7d 10 80 	jmp    *-0x7fef82f0(,%eax,4)
...
80105d47:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105d52:	ff 70 10             	pushl  0x10(%eax)
80105d55:	68 cc 7c 10 80       	push   $0x80107ccc
...
80105da7:	68 74 7c 10 80       	push   $0x80107c74
...
80105de5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105de8:	e8 e3 ee ff ff       	call   80104cd0 <syscall>
    if(myproc()->killed)
...
80105e60:	68 80 3c 11 80       	push   $0x80113c80
80105e65:	e8 a6 e9 ff ff       	call   80104810 <acquire>
      wakeup(&ticks);
80105e6a:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105e71:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105e78:	e8 83 e2 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105e7d:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105e84:	e8 27 e9 ff ff       	call   801047b0 <release>
...
80105ec0:	ff 73 30             	pushl  0x30(%ebx)
80105ec3:	68 98 7c 10 80       	push   $0x80107c98
80105ec8:	e8 d3 a7 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105ecd:	83 c4 14             	add    $0x14,%esp
80105ed0:	68 6e 7c 10 80       	push   $0x80107c6e
...
80105f67:	74 78                	je     80105fe1 <uartinit+0xd1>
  uart = 1;
80105f69:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105f70:	00 00 00 
...
80105f7c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f7f:	bf 90 7d 10 80       	mov    $0x80107d90,%edi
...
80105ff0 <uartputc>:
  if(!uart)
80105ff0:	a1 c0 44 11 80       	mov    0x801144c0,%eax
...
80106067:	6a 00                	push   $0x0
  jmp alltraps
80106069:	e9 07 fb ff ff       	jmp    80105b75 <alltraps>
...
80106070:	6a 01                	push   $0x1
  jmp alltraps
80106072:	e9 fe fa ff ff       	jmp    80105b75 <alltraps>
...
80106079:	6a 02                	push   $0x2
  jmp alltraps
8010607b:	e9 f5 fa ff ff       	jmp    80105b75 <alltraps>
...
80106082:	6a 03                	push   $0x3
  jmp alltraps
80106084:	e9 ec fa ff ff       	jmp    80105b75 <alltraps>
...
80106094:	6a 05                	push   $0x5
  jmp alltraps
80106096:	e9 da fa ff ff       	jmp    80105b75 <alltraps>
...
8010609d:	6a 06                	push   $0x6
  jmp alltraps
8010609f:	e9 d1 fa ff ff       	jmp    80105b75 <alltraps>
...
801060a6:	6a 07                	push   $0x7
  jmp alltraps
801060a8:	e9 c8 fa ff ff       	jmp    80105b75 <alltraps>
...
801060ad:	6a 08                	push   $0x8
  jmp alltraps
801060af:	e9 c1 fa ff ff       	jmp    80105b75 <alltraps>
...
801060b6:	6a 09                	push   $0x9
  jmp alltraps
801060b8:	e9 b8 fa ff ff       	jmp    80105b75 <alltraps>
...
801060bd:	6a 0a                	push   $0xa
  jmp alltraps
801060bf:	e9 b1 fa ff ff       	jmp    80105b75 <alltraps>
...
801060cb:	6a 0c                	push   $0xc
  jmp alltraps
801060cd:	e9 a3 fa ff ff       	jmp    80105b75 <alltraps>
...
801060d2:	6a 0d                	push   $0xd
  jmp alltraps
801060d4:	e9 9c fa ff ff       	jmp    80105b75 <alltraps>
...
801060d9:	6a 0e                	push   $0xe
  jmp alltraps
801060db:	e9 95 fa ff ff       	jmp    80105b75 <alltraps>
...
801060e2:	6a 0f                	push   $0xf
  jmp alltraps
801060e4:	e9 8c fa ff ff       	jmp    80105b75 <alltraps>
...
801060eb:	6a 10                	push   $0x10
  jmp alltraps
801060ed:	e9 83 fa ff ff       	jmp    80105b75 <alltraps>
...
801060f2:	6a 11                	push   $0x11
  jmp alltraps
801060f4:	e9 7c fa ff ff       	jmp    80105b75 <alltraps>
...
801060fb:	6a 12                	push   $0x12
  jmp alltraps
801060fd:	e9 73 fa ff ff       	jmp    80105b75 <alltraps>
...
80106104:	6a 13                	push   $0x13
  jmp alltraps
80106106:	e9 6a fa ff ff       	jmp    80105b75 <alltraps>
...
8010610d:	6a 14                	push   $0x14
  jmp alltraps
8010610f:	e9 61 fa ff ff       	jmp    80105b75 <alltraps>
...
80106116:	6a 15                	push   $0x15
  jmp alltraps
80106118:	e9 58 fa ff ff       	jmp    80105b75 <alltraps>
...
8010611f:	6a 16                	push   $0x16
  jmp alltraps
80106121:	e9 4f fa ff ff       	jmp    80105b75 <alltraps>
...
80106128:	6a 17                	push   $0x17
  jmp alltraps
8010612a:	e9 46 fa ff ff       	jmp    80105b75 <alltraps>
...
80106131:	6a 18                	push   $0x18
  jmp alltraps
80106133:	e9 3d fa ff ff       	jmp    80105b75 <alltraps>
...
8010613a:	6a 19                	push   $0x19
  jmp alltraps
8010613c:	e9 34 fa ff ff       	jmp    80105b75 <alltraps>
...
80106143:	6a 1a                	push   $0x1a
  jmp alltraps
80106145:	e9 2b fa ff ff       	jmp    80105b75 <alltraps>
...
8010614c:	6a 1b                	push   $0x1b
  jmp alltraps
8010614e:	e9 22 fa ff ff       	jmp    80105b75 <alltraps>
...
80106155:	6a 1c                	push   $0x1c
  jmp alltraps
80106157:	e9 19 fa ff ff       	jmp    80105b75 <alltraps>
...
8010615e:	6a 1d                	push   $0x1d
  jmp alltraps
80106160:	e9 10 fa ff ff       	jmp    80105b75 <alltraps>
...
80106167:	6a 1e                	push   $0x1e
  jmp alltraps
80106169:	e9 07 fa ff ff       	jmp    80105b75 <alltraps>
...
80106170:	6a 1f                	push   $0x1f
  jmp alltraps
80106172:	e9 fe f9 ff ff       	jmp    80105b75 <alltraps>
...
80106179:	6a 20                	push   $0x20
  jmp alltraps
8010617b:	e9 f5 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106182:	6a 21                	push   $0x21
  jmp alltraps
80106184:	e9 ec f9 ff ff       	jmp    80105b75 <alltraps>
...
8010618b:	6a 22                	push   $0x22
  jmp alltraps
8010618d:	e9 e3 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106194:	6a 23                	push   $0x23
  jmp alltraps
80106196:	e9 da f9 ff ff       	jmp    80105b75 <alltraps>
...
8010619d:	6a 24                	push   $0x24
  jmp alltraps
8010619f:	e9 d1 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061a6:	6a 25                	push   $0x25
  jmp alltraps
801061a8:	e9 c8 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061af:	6a 26                	push   $0x26
  jmp alltraps
801061b1:	e9 bf f9 ff ff       	jmp    80105b75 <alltraps>
...
801061b8:	6a 27                	push   $0x27
  jmp alltraps
801061ba:	e9 b6 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061c1:	6a 28                	push   $0x28
  jmp alltraps
801061c3:	e9 ad f9 ff ff       	jmp    80105b75 <alltraps>
...
801061ca:	6a 29                	push   $0x29
  jmp alltraps
801061cc:	e9 a4 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061d3:	6a 2a                	push   $0x2a
  jmp alltraps
801061d5:	e9 9b f9 ff ff       	jmp    80105b75 <alltraps>
...
801061dc:	6a 2b                	push   $0x2b
  jmp alltraps
801061de:	e9 92 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061e5:	6a 2c                	push   $0x2c
  jmp alltraps
801061e7:	e9 89 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061ee:	6a 2d                	push   $0x2d
  jmp alltraps
801061f0:	e9 80 f9 ff ff       	jmp    80105b75 <alltraps>
...
801061f7:	6a 2e                	push   $0x2e
  jmp alltraps
801061f9:	e9 77 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106200:	6a 2f                	push   $0x2f
  jmp alltraps
80106202:	e9 6e f9 ff ff       	jmp    80105b75 <alltraps>
...
80106209:	6a 30                	push   $0x30
  jmp alltraps
8010620b:	e9 65 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106212:	6a 31                	push   $0x31
  jmp alltraps
80106214:	e9 5c f9 ff ff       	jmp    80105b75 <alltraps>
...
8010621b:	6a 32                	push   $0x32
  jmp alltraps
8010621d:	e9 53 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106224:	6a 33                	push   $0x33
  jmp alltraps
80106226:	e9 4a f9 ff ff       	jmp    80105b75 <alltraps>
...
8010622d:	6a 34                	push   $0x34
  jmp alltraps
8010622f:	e9 41 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106236:	6a 35                	push   $0x35
  jmp alltraps
80106238:	e9 38 f9 ff ff       	jmp    80105b75 <alltraps>
...
8010623f:	6a 36                	push   $0x36
  jmp alltraps
80106241:	e9 2f f9 ff ff       	jmp    80105b75 <alltraps>
...
80106248:	6a 37                	push   $0x37
  jmp alltraps
8010624a:	e9 26 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106251:	6a 38                	push   $0x38
  jmp alltraps
80106253:	e9 1d f9 ff ff       	jmp    80105b75 <alltraps>
...
8010625a:	6a 39                	push   $0x39
  jmp alltraps
8010625c:	e9 14 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106263:	6a 3a                	push   $0x3a
  jmp alltraps
80106265:	e9 0b f9 ff ff       	jmp    80105b75 <alltraps>
...
8010626c:	6a 3b                	push   $0x3b
  jmp alltraps
8010626e:	e9 02 f9 ff ff       	jmp    80105b75 <alltraps>
...
80106275:	6a 3c                	push   $0x3c
  jmp alltraps
80106277:	e9 f9 f8 ff ff       	jmp    80105b75 <alltraps>
...
8010627e:	6a 3d                	push   $0x3d
  jmp alltraps
80106280:	e9 f0 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106287:	6a 3e                	push   $0x3e
  jmp alltraps
80106289:	e9 e7 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106290:	6a 3f                	push   $0x3f
  jmp alltraps
80106292:	e9 de f8 ff ff       	jmp    80105b75 <alltraps>
...
80106299:	6a 40                	push   $0x40
  jmp alltraps
8010629b:	e9 d5 f8 ff ff       	jmp    80105b75 <alltraps>
...
801062a2:	6a 41                	push   $0x41
  jmp alltraps
801062a4:	e9 cc f8 ff ff       	jmp    80105b75 <alltraps>
...
801062ab:	6a 42                	push   $0x42
  jmp alltraps
801062ad:	e9 c3 f8 ff ff       	jmp    80105b75 <alltraps>
...
801062b4:	6a 43                	push   $0x43
  jmp alltraps
801062b6:	e9 ba f8 ff ff       	jmp    80105b75 <alltraps>
...
801062bd:	6a 44                	push   $0x44
  jmp alltraps
801062bf:	e9 b1 f8 ff ff       	jmp    80105b75 <alltraps>
...
801062c6:	6a 45                	push   $0x45
  jmp alltraps
801062c8:	e9 a8 f8 ff ff       	jmp    80105b75 <alltraps>
...
801062cf:	6a 46                	push   $0x46
  jmp alltraps
801062d1:	e9 9f f8 ff ff       	jmp    80105b75 <alltraps>
...
801062d8:	6a 47                	push   $0x47
  jmp alltraps
801062da:	e9 96 f8 ff ff       	jmp    80105b75 <alltraps>
...
801062e1:	6a 48                	push   $0x48
  jmp alltraps
801062e3:	e9 8d f8 ff ff       	jmp    80105b75 <alltraps>
...
801062ea:	6a 49                	push   $0x49
  jmp alltraps
801062ec:	e9 84 f8 ff ff       	jmp    80105b75 <alltraps>
...
801062f3:	6a 4a                	push   $0x4a
  jmp alltraps
801062f5:	e9 7b f8 ff ff       	jmp    80105b75 <alltraps>
...
801062fc:	6a 4b                	push   $0x4b
  jmp alltraps
801062fe:	e9 72 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106305:	6a 4c                	push   $0x4c
  jmp alltraps
80106307:	e9 69 f8 ff ff       	jmp    80105b75 <alltraps>
...
8010630e:	6a 4d                	push   $0x4d
  jmp alltraps
80106310:	e9 60 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106317:	6a 4e                	push   $0x4e
  jmp alltraps
80106319:	e9 57 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106320:	6a 4f                	push   $0x4f
  jmp alltraps
80106322:	e9 4e f8 ff ff       	jmp    80105b75 <alltraps>
...
80106329:	6a 50                	push   $0x50
  jmp alltraps
8010632b:	e9 45 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106332:	6a 51                	push   $0x51
  jmp alltraps
80106334:	e9 3c f8 ff ff       	jmp    80105b75 <alltraps>
...
8010633b:	6a 52                	push   $0x52
  jmp alltraps
8010633d:	e9 33 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106344:	6a 53                	push   $0x53
  jmp alltraps
80106346:	e9 2a f8 ff ff       	jmp    80105b75 <alltraps>
...
8010634d:	6a 54                	push   $0x54
  jmp alltraps
8010634f:	e9 21 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106356:	6a 55                	push   $0x55
  jmp alltraps
80106358:	e9 18 f8 ff ff       	jmp    80105b75 <alltraps>
...
8010635f:	6a 56                	push   $0x56
  jmp alltraps
80106361:	e9 0f f8 ff ff       	jmp    80105b75 <alltraps>
...
80106368:	6a 57                	push   $0x57
  jmp alltraps
8010636a:	e9 06 f8 ff ff       	jmp    80105b75 <alltraps>
...
80106371:	6a 58                	push   $0x58
  jmp alltraps
80106373:	e9 fd f7 ff ff       	jmp    80105b75 <alltraps>
...
8010637a:	6a 59                	push   $0x59
  jmp alltraps
8010637c:	e9 f4 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106383:	6a 5a                	push   $0x5a
  jmp alltraps
80106385:	e9 eb f7 ff ff       	jmp    80105b75 <alltraps>
...
8010638c:	6a 5b                	push   $0x5b
  jmp alltraps
8010638e:	e9 e2 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106395:	6a 5c                	push   $0x5c
  jmp alltraps
80106397:	e9 d9 f7 ff ff       	jmp    80105b75 <alltraps>
...
8010639e:	6a 5d                	push   $0x5d
  jmp alltraps
801063a0:	e9 d0 f7 ff ff       	jmp    80105b75 <alltraps>
...
801063a7:	6a 5e                	push   $0x5e
  jmp alltraps
801063a9:	e9 c7 f7 ff ff       	jmp    80105b75 <alltraps>
...
801063b0:	6a 5f                	push   $0x5f
  jmp alltraps
801063b2:	e9 be f7 ff ff       	jmp    80105b75 <alltraps>
...
801063b9:	6a 60                	push   $0x60
  jmp alltraps
801063bb:	e9 b5 f7 ff ff       	jmp    80105b75 <alltraps>
...
801063c2:	6a 61                	push   $0x61
  jmp alltraps
801063c4:	e9 ac f7 ff ff       	jmp    80105b75 <alltraps>
...
801063cb:	6a 62                	push   $0x62
  jmp alltraps
801063cd:	e9 a3 f7 ff ff       	jmp    80105b75 <alltraps>
...
801063d4:	6a 63                	push   $0x63
  jmp alltraps
801063d6:	e9 9a f7 ff ff       	jmp    80105b75 <alltraps>
...
801063dd:	6a 64                	push   $0x64
  jmp alltraps
801063df:	e9 91 f7 ff ff       	jmp    80105b75 <alltraps>
...
801063e6:	6a 65                	push   $0x65
  jmp alltraps
801063e8:	e9 88 f7 ff ff       	jmp    80105b75 <alltraps>
...
801063ef:	6a 66                	push   $0x66
  jmp alltraps
801063f1:	e9 7f f7 ff ff       	jmp    80105b75 <alltraps>
...
801063f8:	6a 67                	push   $0x67
  jmp alltraps
801063fa:	e9 76 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106401:	6a 68                	push   $0x68
  jmp alltraps
80106403:	e9 6d f7 ff ff       	jmp    80105b75 <alltraps>
...
8010640a:	6a 69                	push   $0x69
  jmp alltraps
8010640c:	e9 64 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106413:	6a 6a                	push   $0x6a
  jmp alltraps
80106415:	e9 5b f7 ff ff       	jmp    80105b75 <alltraps>
...
8010641c:	6a 6b                	push   $0x6b
  jmp alltraps
8010641e:	e9 52 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106425:	6a 6c                	push   $0x6c
  jmp alltraps
80106427:	e9 49 f7 ff ff       	jmp    80105b75 <alltraps>
...
8010642e:	6a 6d                	push   $0x6d
  jmp alltraps
80106430:	e9 40 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106437:	6a 6e                	push   $0x6e
  jmp alltraps
80106439:	e9 37 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106440:	6a 6f                	push   $0x6f
  jmp alltraps
80106442:	e9 2e f7 ff ff       	jmp    80105b75 <alltraps>
...
80106449:	6a 70                	push   $0x70
  jmp alltraps
8010644b:	e9 25 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106452:	6a 71                	push   $0x71
  jmp alltraps
80106454:	e9 1c f7 ff ff       	jmp    80105b75 <alltraps>
...
8010645b:	6a 72                	push   $0x72
  jmp alltraps
8010645d:	e9 13 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106464:	6a 73                	push   $0x73
  jmp alltraps
80106466:	e9 0a f7 ff ff       	jmp    80105b75 <alltraps>
...
8010646d:	6a 74                	push   $0x74
  jmp alltraps
8010646f:	e9 01 f7 ff ff       	jmp    80105b75 <alltraps>
...
80106476:	6a 75                	push   $0x75
  jmp alltraps
80106478:	e9 f8 f6 ff ff       	jmp    80105b75 <alltraps>
...
8010647f:	6a 76                	push   $0x76
  jmp alltraps
80106481:	e9 ef f6 ff ff       	jmp    80105b75 <alltraps>
...
80106488:	6a 77                	push   $0x77
  jmp alltraps
8010648a:	e9 e6 f6 ff ff       	jmp    80105b75 <alltraps>
...
80106491:	6a 78                	push   $0x78
  jmp alltraps
80106493:	e9 dd f6 ff ff       	jmp    80105b75 <alltraps>
...
8010649a:	6a 79                	push   $0x79
  jmp alltraps
8010649c:	e9 d4 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064a3:	6a 7a                	push   $0x7a
  jmp alltraps
801064a5:	e9 cb f6 ff ff       	jmp    80105b75 <alltraps>
...
801064ac:	6a 7b                	push   $0x7b
  jmp alltraps
801064ae:	e9 c2 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064b5:	6a 7c                	push   $0x7c
  jmp alltraps
801064b7:	e9 b9 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064be:	6a 7d                	push   $0x7d
  jmp alltraps
801064c0:	e9 b0 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064c7:	6a 7e                	push   $0x7e
  jmp alltraps
801064c9:	e9 a7 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064d0:	6a 7f                	push   $0x7f
  jmp alltraps
801064d2:	e9 9e f6 ff ff       	jmp    80105b75 <alltraps>
...
801064d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801064de:	e9 92 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801064ea:	e9 86 f6 ff ff       	jmp    80105b75 <alltraps>
...
801064f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801064f6:	e9 7a f6 ff ff       	jmp    80105b75 <alltraps>
...
801064fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106502:	e9 6e f6 ff ff       	jmp    80105b75 <alltraps>
...
80106509:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010650e:	e9 62 f6 ff ff       	jmp    80105b75 <alltraps>
...
80106515:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010651a:	e9 56 f6 ff ff       	jmp    80105b75 <alltraps>
...
80106521:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106526:	e9 4a f6 ff ff       	jmp    80105b75 <alltraps>
...
8010652d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106532:	e9 3e f6 ff ff       	jmp    80105b75 <alltraps>
...
80106539:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010653e:	e9 32 f6 ff ff       	jmp    80105b75 <alltraps>
...
80106545:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010654a:	e9 26 f6 ff ff       	jmp    80105b75 <alltraps>
...
80106551:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106556:	e9 1a f6 ff ff       	jmp    80105b75 <alltraps>
...
8010655d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106562:	e9 0e f6 ff ff       	jmp    80105b75 <alltraps>
...
80106569:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010656e:	e9 02 f6 ff ff       	jmp    80105b75 <alltraps>
...
80106575:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010657a:	e9 f6 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106581:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106586:	e9 ea f5 ff ff       	jmp    80105b75 <alltraps>
...
8010658d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106592:	e9 de f5 ff ff       	jmp    80105b75 <alltraps>
...
80106599:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010659e:	e9 d2 f5 ff ff       	jmp    80105b75 <alltraps>
...
801065a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065aa:	e9 c6 f5 ff ff       	jmp    80105b75 <alltraps>
...
801065b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801065b6:	e9 ba f5 ff ff       	jmp    80105b75 <alltraps>
...
801065bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801065c2:	e9 ae f5 ff ff       	jmp    80105b75 <alltraps>
...
801065c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801065ce:	e9 a2 f5 ff ff       	jmp    80105b75 <alltraps>
...
801065d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801065da:	e9 96 f5 ff ff       	jmp    80105b75 <alltraps>
...
801065e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801065e6:	e9 8a f5 ff ff       	jmp    80105b75 <alltraps>
...
801065ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801065f2:	e9 7e f5 ff ff       	jmp    80105b75 <alltraps>
...
801065f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801065fe:	e9 72 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106605:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010660a:	e9 66 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106611:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106616:	e9 5a f5 ff ff       	jmp    80105b75 <alltraps>
...
8010661d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106622:	e9 4e f5 ff ff       	jmp    80105b75 <alltraps>
...
80106629:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010662e:	e9 42 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106635:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010663a:	e9 36 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106641:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106646:	e9 2a f5 ff ff       	jmp    80105b75 <alltraps>
...
8010664d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106652:	e9 1e f5 ff ff       	jmp    80105b75 <alltraps>
...
80106659:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010665e:	e9 12 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106665:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010666a:	e9 06 f5 ff ff       	jmp    80105b75 <alltraps>
...
80106671:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106676:	e9 fa f4 ff ff       	jmp    80105b75 <alltraps>
...
8010667d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106682:	e9 ee f4 ff ff       	jmp    80105b75 <alltraps>
...
80106689:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010668e:	e9 e2 f4 ff ff       	jmp    80105b75 <alltraps>
...
80106695:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010669a:	e9 d6 f4 ff ff       	jmp    80105b75 <alltraps>
...
801066a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066a6:	e9 ca f4 ff ff       	jmp    80105b75 <alltraps>
...
801066ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801066b2:	e9 be f4 ff ff       	jmp    80105b75 <alltraps>
...
801066b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801066be:	e9 b2 f4 ff ff       	jmp    80105b75 <alltraps>
...
801066c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801066ca:	e9 a6 f4 ff ff       	jmp    80105b75 <alltraps>
...
801066d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801066d6:	e9 9a f4 ff ff       	jmp    80105b75 <alltraps>
...
801066dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801066e2:	e9 8e f4 ff ff       	jmp    80105b75 <alltraps>
...
801066e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801066ee:	e9 82 f4 ff ff       	jmp    80105b75 <alltraps>
...
801066f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801066fa:	e9 76 f4 ff ff       	jmp    80105b75 <alltraps>
...
80106701:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106706:	e9 6a f4 ff ff       	jmp    80105b75 <alltraps>
...
8010670d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106712:	e9 5e f4 ff ff       	jmp    80105b75 <alltraps>
...
80106719:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010671e:	e9 52 f4 ff ff       	jmp    80105b75 <alltraps>
...
80106725:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010672a:	e9 46 f4 ff ff       	jmp    80105b75 <alltraps>
...
80106731:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106736:	e9 3a f4 ff ff       	jmp    80105b75 <alltraps>
...
8010673d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106742:	e9 2e f4 ff ff       	jmp    80105b75 <alltraps>
...
80106749:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010674e:	e9 22 f4 ff ff       	jmp    80105b75 <alltraps>
...
80106755:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010675a:	e9 16 f4 ff ff       	jmp    80105b75 <alltraps>
...
80106761:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106766:	e9 0a f4 ff ff       	jmp    80105b75 <alltraps>
...
8010676d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106772:	e9 fe f3 ff ff       	jmp    80105b75 <alltraps>
...
80106779:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010677e:	e9 f2 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106785:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010678a:	e9 e6 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106791:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106796:	e9 da f3 ff ff       	jmp    80105b75 <alltraps>
...
8010679d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067a2:	e9 ce f3 ff ff       	jmp    80105b75 <alltraps>
...
801067a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067ae:	e9 c2 f3 ff ff       	jmp    80105b75 <alltraps>
...
801067b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801067ba:	e9 b6 f3 ff ff       	jmp    80105b75 <alltraps>
...
801067c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801067c6:	e9 aa f3 ff ff       	jmp    80105b75 <alltraps>
...
801067cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801067d2:	e9 9e f3 ff ff       	jmp    80105b75 <alltraps>
...
801067d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801067de:	e9 92 f3 ff ff       	jmp    80105b75 <alltraps>
...
801067e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801067ea:	e9 86 f3 ff ff       	jmp    80105b75 <alltraps>
...
801067f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801067f6:	e9 7a f3 ff ff       	jmp    80105b75 <alltraps>
...
801067fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106802:	e9 6e f3 ff ff       	jmp    80105b75 <alltraps>
...
80106809:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010680e:	e9 62 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106815:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010681a:	e9 56 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106821:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106826:	e9 4a f3 ff ff       	jmp    80105b75 <alltraps>
...
8010682d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106832:	e9 3e f3 ff ff       	jmp    80105b75 <alltraps>
...
80106839:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010683e:	e9 32 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106845:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010684a:	e9 26 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106851:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106856:	e9 1a f3 ff ff       	jmp    80105b75 <alltraps>
...
8010685d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106862:	e9 0e f3 ff ff       	jmp    80105b75 <alltraps>
...
80106869:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010686e:	e9 02 f3 ff ff       	jmp    80105b75 <alltraps>
...
80106875:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010687a:	e9 f6 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106881:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106886:	e9 ea f2 ff ff       	jmp    80105b75 <alltraps>
...
8010688d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106892:	e9 de f2 ff ff       	jmp    80105b75 <alltraps>
...
80106899:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010689e:	e9 d2 f2 ff ff       	jmp    80105b75 <alltraps>
...
801068a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068aa:	e9 c6 f2 ff ff       	jmp    80105b75 <alltraps>
...
801068b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801068b6:	e9 ba f2 ff ff       	jmp    80105b75 <alltraps>
...
801068bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801068c2:	e9 ae f2 ff ff       	jmp    80105b75 <alltraps>
...
801068c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801068ce:	e9 a2 f2 ff ff       	jmp    80105b75 <alltraps>
...
801068d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801068da:	e9 96 f2 ff ff       	jmp    80105b75 <alltraps>
...
801068e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801068e6:	e9 8a f2 ff ff       	jmp    80105b75 <alltraps>
...
801068ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801068f2:	e9 7e f2 ff ff       	jmp    80105b75 <alltraps>
...
801068f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801068fe:	e9 72 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106905:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010690a:	e9 66 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106911:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106916:	e9 5a f2 ff ff       	jmp    80105b75 <alltraps>
...
8010691d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106922:	e9 4e f2 ff ff       	jmp    80105b75 <alltraps>
...
80106929:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010692e:	e9 42 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106935:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010693a:	e9 36 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106941:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106946:	e9 2a f2 ff ff       	jmp    80105b75 <alltraps>
...
8010694d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106952:	e9 1e f2 ff ff       	jmp    80105b75 <alltraps>
...
80106959:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010695e:	e9 12 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106965:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010696a:	e9 06 f2 ff ff       	jmp    80105b75 <alltraps>
...
80106971:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106976:	e9 fa f1 ff ff       	jmp    80105b75 <alltraps>
...
8010697d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106982:	e9 ee f1 ff ff       	jmp    80105b75 <alltraps>
...
80106989:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010698e:	e9 e2 f1 ff ff       	jmp    80105b75 <alltraps>
...
80106995:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010699a:	e9 d6 f1 ff ff       	jmp    80105b75 <alltraps>
...
801069a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069a6:	e9 ca f1 ff ff       	jmp    80105b75 <alltraps>
...
801069ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801069b2:	e9 be f1 ff ff       	jmp    80105b75 <alltraps>
...
801069b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801069be:	e9 b2 f1 ff ff       	jmp    80105b75 <alltraps>
...
801069c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801069ca:	e9 a6 f1 ff ff       	jmp    80105b75 <alltraps>
...
801069d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801069d6:	e9 9a f1 ff ff       	jmp    80105b75 <alltraps>
...
801069dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801069e2:	e9 8e f1 ff ff       	jmp    80105b75 <alltraps>
...
801069e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801069ee:	e9 82 f1 ff ff       	jmp    80105b75 <alltraps>
...
801069f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801069fa:	e9 76 f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a01:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a06:	e9 6a f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a0d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a12:	e9 5e f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a19:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a1e:	e9 52 f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a25:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a2a:	e9 46 f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a31:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a36:	e9 3a f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a3d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a42:	e9 2e f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a49:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a4e:	e9 22 f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a55:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a5a:	e9 16 f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a61:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106a66:	e9 0a f1 ff ff       	jmp    80105b75 <alltraps>
...
80106a6d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106a72:	e9 fe f0 ff ff       	jmp    80105b75 <alltraps>
...
80106a79:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106a7e:	e9 f2 f0 ff ff       	jmp    80105b75 <alltraps>
...
80106a85:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106a8a:	e9 e6 f0 ff ff       	jmp    80105b75 <alltraps>
...
80106a91:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106a96:	e9 da f0 ff ff       	jmp    80105b75 <alltraps>
...
80106a9d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106aa2:	e9 ce f0 ff ff       	jmp    80105b75 <alltraps>
...
80106aa9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106aae:	e9 c2 f0 ff ff       	jmp    80105b75 <alltraps>
...
80106ab5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106aba:	e9 b6 f0 ff ff       	jmp    80105b75 <alltraps>
...
80106ac1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106ac6:	e9 aa f0 ff ff       	jmp    80105b75 <alltraps>
...
80106acd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106ad2:	e9 9e f0 ff ff       	jmp    80105b75 <alltraps>
...
80106c25:	e8 a6 dc ff ff       	call   801048d0 <memset>
...
80106c6d:	68 98 7d 10 80       	push   $0x80107d98
...
80106d10:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106d44:	0f 84 c2 00 00 00    	je     80106e0c <switchuvm+0xec>
  pushcli();
80106d4a:	e8 71 d9 ff ff       	call   801046c0 <pushcli>
...
80106e5f:	e8 6c da ff ff       	call   801048d0 <memset>
...
80106e92:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e93:	e9 d8 da ff ff       	jmp    80104970 <memmove>
    panic("inituvm: more than a page");
80106e98:	83 ec 0c             	sub    $0xc,%esp
80106e9b:	68 dd 7d 10 80       	push   $0x80107ddd
...
80106f00:	68 f7 7d 10 80       	push   $0x80107df7
...
80106f88:	68 98 7e 10 80       	push   $0x80107e98
...
80106feb:	e8 e0 d8 ff ff       	call   801048d0 <memset>
...
80107029:	68 15 7e 10 80       	push   $0x80107e15
...
8010708b:	68 2d 7e 10 80       	push   $0x80107e2d
...
8010716c:	68 49 7e 10 80       	push   $0x80107e49
...
801071a0:	e8 2b d7 ff ff       	call   801048d0 <memset>
...
801071b1:	ff 73 0c             	pushl  0xc(%ebx)
...
8010720b:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010723c:	68 5a 7e 10 80       	push   $0x80107e5a
...
801072b2:	68 64 7e 10 80       	push   $0x80107e64
...
80107310:	e8 5b d6 ff ff       	call   80104970 <memmove>
...
80107367:	ff 75 e0             	pushl  -0x20(%ebp)
...
80107387:	68 7e 7e 10 80       	push   $0x80107e7e
...
80107440:	e8 2b d5 ff ff       	call   80104970 <memmove>
    len -= n;
    buf += n;
