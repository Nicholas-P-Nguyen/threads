...
801001be:	e8 3d 45 00 00       	call   80104700 <holdingsleep>
...
801001ff:	e8 fc 44 00 00       	call   80104700 <holdingsleep>
...
8010020f:	e8 ac 44 00 00       	call   801046c0 <releasesleep>
...
801003c8:	e8 a3 43 00 00       	call   80104770 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010041a:	e8 e1 5c 00 00       	call   80106100 <uartputc>
...
80100505:	e8 f6 5b 00 00       	call   80106100 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 ea 5b 00 00       	call   80106100 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 de 5b 00 00       	call   80106100 <uartputc>
...
80100551:	e8 2a 45 00 00       	call   80104a80 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 75 44 00 00       	call   801049e0 <memset>
  outb(CRTPORT+1, pos);
...
80100579:	68 25 76 10 80       	push   $0x80107625
...
801005ab:	e8 70 43 00 00       	call   80104920 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 d7 42 00 00       	call   801048c0 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
80100636:	0f b6 92 50 76 10 80 	movzbl -0x7fef89b0(%edx),%edx
  }while((x /= base) != 0);
...
801007e8:	e8 33 41 00 00       	call   80104920 <acquire>
...
80100837:	90                   	nop
        s = "(null)";
80100838:	bf 38 76 10 80       	mov    $0x80107638,%edi
      for(; *s; s++)
...
8010085b:	e8 60 40 00 00       	call   801048c0 <release>
...
80100873:	68 3f 76 10 80       	push   $0x8010763f
...
80100893:	e8 88 40 00 00       	call   80104920 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 eb 3e 00 00       	call   801048c0 <release>
  if(doprocdump) {
...
80100a70:	e8 db 3c 00 00       	call   80104750 <initlock>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 57 67 00 00       	call   80107290 <setupkvm>
...
80100ba3:	e8 08 65 00 00       	call   801070b0 <allocuvm>
...
80100bd9:	e8 e2 63 00 00       	call   80106fc0 <loaduvm>
...
80100c1b:	e8 f0 65 00 00       	call   80107210 <freevm>
  if(ip){
...
80100c62:	e8 49 64 00 00       	call   801070b0 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 a8 66 00 00       	call   80107330 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cd3:	e8 08 3f 00 00       	call   80104be0 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 f4 3e 00 00       	call   80104be0 <strlen>
...
80100cf8:	e8 03 68 00 00       	call   80107500 <copyout>
...
80100d11:	e8 fa 64 00 00       	call   80107210 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 98 67 00 00       	call   80107500 <copyout>
...
80100da1:	e8 fa 3d 00 00       	call   80104ba0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dcd:	e8 5e 60 00 00       	call   80106e30 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 36 64 00 00       	call   80107210 <freevm>
  return 0;
...
80100dec:	68 61 76 10 80       	push   $0x80107661
...
80100e16:	68 6d 76 10 80       	push   $0x8010766d
80100e1b:	68 60 ef 10 80       	push   $0x8010ef60
80100e20:	e8 2b 39 00 00       	call   80104750 <initlock>
}
...
80100e71:	e8 4a 3a 00 00       	call   801048c0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 31 3a 00 00       	call   801048c0 <release>
}
...
80100ecc:	e8 ef 39 00 00       	call   801048c0 <release>
  return f;
}
...
80100edb:	68 74 76 10 80       	push   $0x80107674
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 7f 39 00 00       	call   801048c0 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 4d 39 00 00       	jmp    801048c0 <release>
...
80100fbc:	68 7c 76 10 80       	push   $0x8010767c
...
801010a2:	68 86 76 10 80       	push   $0x80107686
...
80101177:	68 8f 76 10 80       	push   $0x8010768f
...
801011b1:	68 95 76 10 80       	push   $0x80107695
...
80101227:	68 9f 76 10 80       	push   $0x8010769f
...
801012e4:	68 b2 76 10 80       	push   $0x801076b2
...
80101325:	e8 b6 36 00 00       	call   801049e0 <memset>
  log_write(bp);
...
8010136a:	e8 b1 35 00 00       	call   80104920 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 e4 34 00 00       	call   801048c0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 b6 34 00 00       	call   801048c0 <release>
      return ip;
...
80101438:	68 c8 76 10 80       	push   $0x801076c8
...
80101515:	68 d8 76 10 80       	push   $0x801076d8
...
80101541:	e8 3a 35 00 00       	call   80104a80 <memmove>
  brelse(bp);
...
8010156c:	68 eb 76 10 80       	push   $0x801076eb
80101571:	68 60 f9 10 80       	push   $0x8010f960
80101576:	e8 d5 31 00 00       	call   80104750 <initlock>
  for(i = 0; i < NINODE; i++) {
8010157b:	83 c4 10             	add    $0x10,%esp
8010157e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
80101580:	83 ec 08             	sub    $0x8,%esp
80101583:	68 f2 76 10 80       	push   $0x801076f2
80101588:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 8c 30 00 00       	call   80104620 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 bf 34 00 00       	call   80104a80 <memmove>
  brelse(bp);
...
801015f3:	68 58 77 10 80       	push   $0x80107758
...
8010168e:	e8 4d 33 00 00       	call   801049e0 <memset>
      dip->type = type;
...
801016c3:	68 f8 76 10 80       	push   $0x801076f8
...
80101731:	e8 4a 33 00 00       	call   80104a80 <memmove>
  log_write(bp);
...
8010175f:	e8 bc 31 00 00       	call   80104920 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 4c 31 00 00       	call   801048c0 <release>
}
...
801017a2:	e8 b9 2e 00 00       	call   80104660 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 63 32 00 00       	call   80104a80 <memmove>
    brelse(bp);
...
8010183d:	68 10 77 10 80       	push   $0x80107710
80101842:	e8 39 eb ff ff       	call   80100380 <panic>
    panic("ilock");
80101847:	83 ec 0c             	sub    $0xc,%esp
8010184a:	68 0a 77 10 80       	push   $0x8010770a
...
80101873:	e8 88 2e 00 00       	call   80104700 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 2c 2e 00 00       	jmp    801046c0 <releasesleep>
    panic("iunlock");
80101894:	83 ec 0c             	sub    $0xc,%esp
80101897:	68 1f 77 10 80       	push   $0x8010771f
...
801018c0:	e8 9b 2d 00 00       	call   80104660 <acquiresleep>
...
801018da:	e8 e1 2d 00 00       	call   801046c0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 35 30 00 00       	call   80104920 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 bb 2f 00 00       	jmp    801048c0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 0b 30 00 00       	call   80104920 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 9c 2f 00 00       	call   801048c0 <release>
    if(r == 1){
...
80101a23:	e8 d8 2c 00 00       	call   80104700 <holdingsleep>
...
80101a3a:	e8 81 2c 00 00       	call   801046c0 <releasesleep>
  iput(ip);
...
80101a53:	68 1f 77 10 80       	push   $0x8010771f
...
80101b37:	e8 44 2f 00 00       	call   80104a80 <memmove>
    brelse(bp);
...
80101c33:	e8 48 2e 00 00       	call   80104a80 <memmove>
    log_write(bp);
...
80101cce:	e8 1d 2e 00 00       	call   80104af0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 be 2d 00 00       	call   80104af0 <strncmp>
      continue;
...
80101d72:	68 39 77 10 80       	push   $0x80107739
80101d77:	e8 04 e6 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101d7c:	83 ec 0c             	sub    $0xc,%esp
80101d7f:	68 27 77 10 80       	push   $0x80107727
...
80101dba:	e8 61 2b 00 00       	call   80104920 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 f1 2a 00 00       	call   801048c0 <release>
...
80101e27:	e8 54 2c 00 00       	call   80104a80 <memmove>
...
80101e8c:	e8 6f 28 00 00       	call   80104700 <holdingsleep>
...
80101eae:	e8 0d 28 00 00       	call   801046c0 <releasesleep>
  iput(ip);
...
80101edb:	e8 a0 2b 00 00       	call   80104a80 <memmove>
    name[len] = 0;
...
80101f2b:	e8 d0 27 00 00       	call   80104700 <holdingsleep>
...
80101f4a:	e8 71 27 00 00       	call   801046c0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 8e 27 00 00       	call   80104700 <holdingsleep>
...
80101f90:	e8 6b 27 00 00       	call   80104700 <holdingsleep>
...
80101fa7:	e8 14 27 00 00       	call   801046c0 <releasesleep>
}
...
80101fcf:	68 1f 77 10 80       	push   $0x8010771f
...
8010203d:	e8 fe 2a 00 00       	call   80104b40 <strncpy>
...
8010207b:	68 48 77 10 80       	push   $0x80107748
80102080:	e8 fb e2 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102085:	83 ec 0c             	sub    $0xc,%esp
80102088:	68 4e 7d 10 80       	push   $0x80107d4e
...
8010219b:	68 b4 77 10 80       	push   $0x801077b4
801021a0:	e8 db e1 ff ff       	call   80100380 <panic>
    panic("idestart");
801021a5:	83 ec 0c             	sub    $0xc,%esp
801021a8:	68 ab 77 10 80       	push   $0x801077ab
...
801021c6:	68 c6 77 10 80       	push   $0x801077c6
801021cb:	68 00 16 11 80       	push   $0x80111600
801021d0:	e8 7b 25 00 00       	call   80104750 <initlock>
...
8010224e:	e8 cd 26 00 00       	call   80104920 <acquire>
...
801022cb:	e8 f0 25 00 00       	call   801048c0 <release>
...
801022ee:	e8 0d 24 00 00       	call   80104700 <holdingsleep>
...
80102328:	e8 f3 25 00 00       	call   80104920 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 35 25 00 00       	jmp    801048c0 <release>
...
801023aa:	68 f5 77 10 80       	push   $0x801077f5
801023af:	e8 cc df ff ff       	call   80100380 <panic>
    panic("iderw: nothing to do");
801023b4:	83 ec 0c             	sub    $0xc,%esp
801023b7:	68 e0 77 10 80       	push   $0x801077e0
801023bc:	e8 bf df ff ff       	call   80100380 <panic>
    panic("iderw: buf not locked");
801023c1:	83 ec 0c             	sub    $0xc,%esp
801023c4:	68 ca 77 10 80       	push   $0x801077ca
...
8010241a:	68 14 78 10 80       	push   $0x80107814
...
801024f2:	e8 e9 24 00 00       	call   801049e0 <memset>
...
80102528:	e8 f3 23 00 00       	call   80104920 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 78 23 00 00       	jmp    801048c0 <release>
    panic("kfree");
80102548:	83 ec 0c             	sub    $0xc,%esp
8010254b:	68 46 78 10 80       	push   $0x80107846
...
8010261b:	68 4c 78 10 80       	push   $0x8010784c
80102620:	68 40 16 11 80       	push   $0x80111640
80102625:	e8 26 21 00 00       	call   80104750 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 68 22 00 00       	call   80104920 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 da 21 00 00       	call   801048c0 <release>
  return (char*)r;
...
8010272b:	0f b6 91 80 79 10 80 	movzbl -0x7fef8680(%ecx),%edx
  shift ^= togglecode[data];
80102732:	0f b6 81 80 78 10 80 	movzbl -0x7fef8780(%ecx),%eax
  shift |= shiftcode[data];
...
80102748:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010274b:	8b 04 85 60 78 10 80 	mov    -0x7fef87a0(,%eax,4),%eax
...
80102785:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102788:	0f b6 81 80 79 10 80 	movzbl -0x7fef8680(%ecx),%eax
...
80102af7:	e8 34 1f 00 00       	call   80104a30 <memcmp>
...
80102c24:	e8 57 1e 00 00       	call   80104a80 <memmove>
...
80102cca:	68 80 7a 10 80       	push   $0x80107a80
80102ccf:	68 a0 16 11 80       	push   $0x801116a0
80102cd4:	e8 77 1a 00 00       	call   80104750 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 b0 1b 00 00       	call   80104920 <acquire>
...
80102dbc:	e8 ff 1a 00 00       	call   801048c0 <release>
      break;
    }
  }
}
...
80102dde:	e8 3d 1b 00 00       	call   80104920 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 9f 1a 00 00       	call   801048c0 <release>
}
...
80102e36:	e8 e5 1a 00 00       	call   80104920 <acquire>
    wakeup(&log);
...
80102e58:	e8 63 1a 00 00       	call   801048c0 <release>
...
80102eb4:	e8 c7 1b 00 00       	call   80104a80 <memmove>
...
80102f14:	e8 a7 19 00 00       	call   801048c0 <release>
...
80102f27:	68 84 7a 10 80       	push   $0x80107a84
...
80102f76:	e8 a5 19 00 00       	call   80104920 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 06 19 00 00       	jmp    801048c0 <release>
...
80102fe1:	68 93 7a 10 80       	push   $0x80107a93
80102fe6:	e8 95 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102feb:	83 ec 0c             	sub    $0xc,%esp
80102fee:	68 a9 7a 10 80       	push   $0x80107aa9
...
80103018:	68 c4 7a 10 80       	push   $0x80107ac4
8010301d:	e8 7e d6 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80103022:	e8 09 2d 00 00       	call   80105d30 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 d5 3d 00 00       	call   80106e20 <switchkvm>
  seginit();
8010304b:	e8 40 3d 00 00       	call   80106d90 <seginit>
  lapicinit();
...
80103081:	e8 8a 42 00 00       	call   80107310 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 fb 3c 00 00       	call   80106d90 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 77 2f 00 00       	call   80106020 <uartinit>
  pinit();         // process table
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 fd 2b 00 00       	call   80105cb0 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 a7 19 00 00       	call   80104a80 <memmove>
...
801031be:	68 d8 7a 10 80       	push   $0x80107ad8
...
80103276:	68 dd 7a 10 80       	push   $0x80107add
8010327b:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 ac 17 00 00       	call   80104a30 <memcmp>
...
80103393:	68 e2 7a 10 80       	push   $0x80107ae2
...
801033c2:	68 d8 7a 10 80       	push   $0x80107ad8
801033c7:	53                   	push   %ebx
801033c8:	e8 63 16 00 00       	call   80104a30 <memcmp>
...
801033f8:	68 fc 7a 10 80       	push   $0x80107afc
...
801034a0:	00 00 00 
  initlock(&p->lock, "pipe");
801034a3:	68 1b 7b 10 80       	push   $0x80107b1b
801034a8:	50                   	push   %eax
801034a9:	e8 a2 12 00 00       	call   80104750 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 dc 13 00 00       	call   80104920 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 37 13 00 00       	jmp    801048c0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 27 13 00 00       	call   801048c0 <release>
    kfree((char*)p);
...
801035dd:	e8 3e 13 00 00       	call   80104920 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 4f 12 00 00       	call   801048c0 <release>
        return -1;
...
801036c2:	e8 f9 11 00 00       	call   801048c0 <release>
  return n;
...
801036e6:	e8 35 12 00 00       	call   80104920 <acquire>
...
8010377e:	e8 3d 11 00 00       	call   801048c0 <release>
  return i;
...
80103799:	e8 22 11 00 00       	call   801048c0 <release>
      return -1;
...
801037b4:	bb 88 1d 11 80       	mov    $0x80111d88,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 20 1d 11 80       	push   $0x80111d20
801037c1:	e8 5a 11 00 00       	call   80104920 <acquire>
...
801037d3:	81 fb 88 3d 11 80    	cmp    $0x80113d88,%ebx
...
801037fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103802:	e8 b9 10 00 00       	call   801048c0 <release>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 9d 5c 10 80 	movl   $0x80105c9d,0x14(%eax)
  p->context = (struct context*)sp;
...
80103836:	e8 a5 11 00 00       	call   801049e0 <memset>
...
8010385a:	e8 61 10 00 00       	call   801048c0 <release>
}
...
801038d6:	68 20 7b 10 80       	push   $0x80107b20
801038db:	68 20 1d 11 80       	push   $0x80111d20
801038e0:	e8 6b 0e 00 00       	call   80104750 <initlock>
  initlock(&ptable.guard, "guard_lock");
801038e5:	58                   	pop    %eax
801038e6:	5a                   	pop    %edx
801038e7:	68 27 7b 10 80       	push   $0x80107b27
801038ec:	68 54 1d 11 80       	push   $0x80111d54
801038f1:	e8 5a 0e 00 00       	call   80104750 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 44 0e 00 00       	call   801047d0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 84 0e 00 00       	call   80104820 <popcli>
}
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 88 3d 11 80       	mov    %eax,0x80113d88
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 c8 38 00 00       	call   80107290 <setupkvm>
...
801039e1:	e8 5a 35 00 00       	call   80106f40 <inituvm>
...
801039f6:	e8 e5 0f 00 00       	call   801049e0 <memset>
...
80103a4f:	68 5b 7b 10 80       	push   $0x80107b5b
80103a54:	50                   	push   %eax
80103a55:	e8 46 11 00 00       	call   80104ba0 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 64 7b 10 80 	movl   $0x80107b64,(%esp)
...
80103a93:	68 42 7b 10 80       	push   $0x80107b42
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 23 0d 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 63 0d 00 00       	call   80104820 <popcli>
  sz = curproc->sz;
...
80103acb:	e8 60 33 00 00       	call   80106e30 <switchuvm>
  return 0;
...
80103aea:	e8 c1 35 00 00       	call   801070b0 <allocuvm>
...
80103b0a:	e8 d1 36 00 00       	call   801071e0 <deallocuvm>
...
80103b26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b29:	e8 a2 0c 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103b2e:	e8 cd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b39:	e8 e2 0c 00 00       	call   80104820 <popcli>
  if((np = allocproc()) == 0){
...
80103b58:	e8 23 38 00 00       	call   80107380 <copyuvm>
...
80103c61:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c64:	bb 88 1d 11 80       	mov    $0x80111d88,%ebx
    acquire(&ptable.lock);
80103c69:	68 20 1d 11 80       	push   $0x80111d20
80103c6e:	e8 ad 0c 00 00       	call   80104920 <acquire>
...
80103c90:	e8 9b 31 00 00       	call   80106e30 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 54 0f 00 00       	call   80104bfb <swtch>
      switchkvm();
80103ca7:	e8 74 31 00 00       	call   80106e20 <switchkvm>
      c->proc = 0;
...
80103d43:	e8 b3 0e 00 00       	call   80104bfb <swtch>
  mycpu()->intena = intena;
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 88 3d 11 80    	cmp    %eax,0x80113d88
...
80103e0a:	e8 11 0b 00 00       	call   80104920 <acquire>
...
80103e3f:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
80103e44:	75 e4                	jne    80103e2a <exit+0x8a>
      p->parent = initproc;
80103e46:	8b 0d 88 3d 11 80    	mov    0x80113d88,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e4c:	ba 88 1d 11 80       	mov    $0x80111d88,%edx
80103e51:	eb 10                	jmp    80103e63 <exit+0xc3>
80103e53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e57:	90                   	nop
80103e58:	83 ea 80             	sub    $0xffffff80,%edx
80103e5b:	81 fa 88 3d 11 80    	cmp    $0x80113d88,%edx
...
80103e6f:	75 e7                	jne    80103e58 <exit+0xb8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e71:	b8 88 1d 11 80       	mov    $0x80111d88,%eax
...
80103e83:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
...
80103ead:	68 b3 7b 10 80       	push   $0x80107bb3
80103eb2:	e8 c9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 a6 7b 10 80       	push   $0x80107ba6
...
80103f21:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f26:	81 fb 88 3d 11 80    	cmp    $0x80113d88,%ebx
...
80103f3b:	0f 85 95 00 00 00    	jne    80103fd6 <wait+0x106>
  pushcli();
80103f41:	e8 8a 08 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103f46:	e8 b5 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f51:	e8 ca 08 00 00       	call   80104820 <popcli>
  if(p == 0)
...
80103f99:	e8 72 32 00 00       	call   80107210 <freevm>
        p->pid = 0;
...
80103fc5:	e8 f6 08 00 00       	call   801048c0 <release>
        return pid;
...
8010400c:	e8 0f 09 00 00       	call   80104920 <acquire>
  pushcli();
80104011:	e8 ba 07 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104016:	e8 e5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104021:	e8 fa 07 00 00       	call   80104820 <popcli>
...
80104039:	e8 82 08 00 00       	call   801048c0 <release>
}
...
8010405c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010405f:	e8 6c 07 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104064:	e8 97 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104069:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010406f:	e8 ac 07 00 00       	call   80104820 <popcli>
  if(p == 0)
...
80104090:	e8 8b 08 00 00       	call   80104920 <acquire>
    release(lk);
80104095:	89 34 24             	mov    %esi,(%esp)
80104098:	e8 23 08 00 00       	call   801048c0 <release>
  p->chan = chan;
...
801040ba:	e8 01 08 00 00       	call   801048c0 <release>
    acquire(lk);
...
801040cb:	5d                   	pop    %ebp
    acquire(lk);
801040cc:	e9 4f 08 00 00       	jmp    80104920 <acquire>
...
801040f9:	68 c5 7b 10 80       	push   $0x80107bc5
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 bf 7b 10 80       	push   $0x80107bbf
...
8010411f:	e8 fc 07 00 00       	call   80104920 <acquire>
80104124:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104127:	b8 88 1d 11 80       	mov    $0x80111d88,%eax
8010412c:	eb 0c                	jmp    8010413a <wakeup+0x2a>
8010412e:	66 90                	xchg   %ax,%ax
80104130:	83 e8 80             	sub    $0xffffff80,%eax
80104133:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
...
8010414f:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
...
80104160:	c9                   	leave  
  release(&ptable.lock);
80104161:	e9 5a 07 00 00       	jmp    801048c0 <release>
...
8010417f:	e8 9c 07 00 00       	call   80104920 <acquire>
80104184:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104187:	b8 88 1d 11 80       	mov    $0x80111d88,%eax
8010418c:	eb 0c                	jmp    8010419a <kill+0x2a>
8010418e:	66 90                	xchg   %ax,%ax
80104190:	83 e8 80             	sub    $0xffffff80,%eax
80104193:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
...
801041bb:	e8 00 07 00 00       	call   801048c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041d8:	e8 e3 06 00 00       	call   801048c0 <release>
}
...
801041f9:	bb f4 1d 11 80       	mov    $0x80111df4,%ebx
...
8010421b:	81 fb f4 3d 11 80    	cmp    $0x80113df4,%ebx
...
8010422c:	74 ea                	je     80104218 <procdump+0x28>
      state = "???";
8010422e:	ba d6 7b 10 80       	mov    $0x80107bd6,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104233:	83 f8 05             	cmp    $0x5,%eax
80104236:	77 11                	ja     80104249 <procdump+0x59>
80104238:	8b 14 85 38 7c 10 80 	mov    -0x7fef83c8(,%eax,4),%edx
      state = "???";
8010423f:	b8 d6 7b 10 80       	mov    $0x80107bd6,%eax
...
8010424e:	68 da 7b 10 80       	push   $0x80107bda
...
80104275:	e8 f6 04 00 00       	call   80104770 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010428d:	68 21 76 10 80       	push   $0x80107621
...
801042b6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801042b9:	e8 12 05 00 00       	call   801047d0 <pushcli>
  c = mycpu();
801042be:	e8 3d f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801042c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042c9:	e8 52 05 00 00       	call   80104820 <popcli>
  int tid;
  struct proc *np;
  struct proc *curproc = myproc();
...
801042d5:	0f 84 f0 00 00 00    	je     801043cb <clone+0x11b>
...
80104333:	31 f6                	xor    %esi,%esi
  np->tf->esp = (uint)stack + stack_offset; 
80104335:	8b 4a 18             	mov    0x18(%edx),%ecx
80104338:	01 f8                	add    %edi,%eax
  for(int i = 0; i < NOFILE; i++)
8010433a:	89 d7                	mov    %edx,%edi
  np->tf->esp = (uint)stack + stack_offset; 
8010433c:	89 41 44             	mov    %eax,0x44(%ecx)
  np->tf->eax = 0;
8010433f:	8b 42 18             	mov    0x18(%edx),%eax
...
80104373:	ff 73 68             	pushl  0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80104376:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80104379:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010437c:	e8 cf d3 ff ff       	call   80101750 <idup>
80104381:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80104384:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80104387:	89 42 68             	mov    %eax,0x68(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
8010438a:	8d 42 6c             	lea    0x6c(%edx),%eax
8010438d:	6a 10                	push   $0x10
8010438f:	53                   	push   %ebx
80104390:	50                   	push   %eax
80104391:	e8 0a 08 00 00       	call   80104ba0 <safestrcpy>

  tid = np->pid;
80104396:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104399:	8b 5a 10             	mov    0x10(%edx),%ebx

  acquire(&ptable.lock);
8010439c:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043a3:	e8 78 05 00 00       	call   80104920 <acquire>
  np->state = RUNNABLE;
801043a8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801043ab:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  release(&ptable.lock);
801043b2:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043b9:	e8 02 05 00 00       	call   801048c0 <release>
...
801043d0:	eb ef                	jmp    801043c1 <clone+0x111>
...
801043e4:	53                   	push   %ebx
  pushcli();
801043e5:	e8 e6 03 00 00       	call   801047d0 <pushcli>
  c = mycpu();
801043ea:	e8 11 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801043ef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043f5:	e8 26 04 00 00       	call   80104820 <popcli>
  struct proc *p;
  int havekids, tid;
  struct proc *curproc = myproc();
...
80104402:	e8 19 05 00 00       	call   80104920 <acquire>
...
8010440a:	31 d2                	xor    %edx,%edx
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010440c:	b8 88 1d 11 80       	mov    $0x80111d88,%eax
80104411:	eb 0f                	jmp    80104422 <join+0x42>
80104413:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104417:	90                   	nop
80104418:	83 e8 80             	sub    $0xffffff80,%eax
8010441b:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
80104420:	74 1a                	je     8010443c <join+0x5c>
      // Finding the child process
      if (p->parent != curproc) {
80104422:	39 58 14             	cmp    %ebx,0x14(%eax)
80104425:	75 f1                	jne    80104418 <join+0x38>
        continue;
      }
      // Found a child process
      havekids = 1;
      if (p->state == ZOMBIE) {
80104427:	83 78 0c 05          	cmpl   $0x5,0xc(%eax)
8010442b:	74 53                	je     80104480 <join+0xa0>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010442d:	83 e8 80             	sub    $0xffffff80,%eax
      havekids = 1;
80104430:	ba 01 00 00 00       	mov    $0x1,%edx
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104435:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
8010443a:	75 e6                	jne    80104422 <join+0x42>
        return tid;
      }
    }
...
8010443e:	0f 84 7f 00 00 00    	je     801044c3 <join+0xe3>
80104444:	8b 43 24             	mov    0x24(%ebx),%eax
80104447:	85 c0                	test   %eax,%eax
80104449:	75 78                	jne    801044c3 <join+0xe3>
  pushcli();
8010444b:	e8 80 03 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104450:	e8 ab f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104455:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
8010445b:	e8 c0 03 00 00       	call   80104820 <popcli>
  if(p == 0)
80104460:	85 f6                	test   %esi,%esi
80104462:	74 76                	je     801044da <join+0xfa>
  p->chan = chan;
80104464:	89 5e 20             	mov    %ebx,0x20(%esi)
  p->state = SLEEPING;
80104467:	c7 46 0c 02 00 00 00 	movl   $0x2,0xc(%esi)
  sched();
8010446e:	e8 6d f8 ff ff       	call   80103ce0 <sched>
  p->chan = 0;
80104473:	c7 46 20 00 00 00 00 	movl   $0x0,0x20(%esi)
}
8010447a:	eb 8e                	jmp    8010440a <join+0x2a>
8010447c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        release(&ptable.lock);
80104480:	83 ec 0c             	sub    $0xc,%esp
        tid = p->pid;
80104483:	8b 58 10             	mov    0x10(%eax),%ebx
        p->name[0] = 0;
80104486:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->kstack = 0;
8010448a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        p->pid = 0;
80104491:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104498:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->killed = 0;
8010449f:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        p->state = UNUSED;
801044a6:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        release(&ptable.lock);
801044ad:	68 20 1d 11 80       	push   $0x80111d20
801044b2:	e8 09 04 00 00       	call   801048c0 <release>
        return tid;
...
801044ba:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801044c6:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
      release(&ptable.lock);
801044cb:	68 20 1d 11 80       	push   $0x80111d20
801044d0:	e8 eb 03 00 00       	call   801048c0 <release>
      return -1;
801044d5:	83 c4 10             	add    $0x10,%esp
801044d8:	eb e0                	jmp    801044ba <join+0xda>
    panic("sleep");
801044da:	83 ec 0c             	sub    $0xc,%esp
801044dd:	68 bf 7b 10 80       	push   $0x80107bbf
801044e2:	e8 99 be ff ff       	call   80100380 <panic>
...
801044fa:	eb 21                	jmp    8010451d <lock+0x2d>
...
80104503:	68 54 1d 11 80       	push   $0x80111d54
80104508:	53                   	push   %ebx
80104509:	e8 42 fb ff ff       	call   80104050 <sleep>
    release(&ptable.guard);
8010450e:	c7 04 24 54 1d 11 80 	movl   $0x80111d54,(%esp)
80104515:	e8 a6 03 00 00       	call   801048c0 <release>
    acquire(&ptable.guard);
8010451a:	83 c4 10             	add    $0x10,%esp
8010451d:	83 ec 0c             	sub    $0xc,%esp
80104520:	68 54 1d 11 80       	push   $0x80111d54
80104525:	e8 f6 03 00 00       	call   80104920 <acquire>
    if (*lk == 0) {
8010452a:	8b 03                	mov    (%ebx),%eax
8010452c:	83 c4 10             	add    $0x10,%esp
8010452f:	85 c0                	test   %eax,%eax
80104531:	75 cd                	jne    80104500 <lock+0x10>
  acquire(&ptable.lock);
80104533:	83 ec 0c             	sub    $0xc,%esp
      *lk = 1;
80104536:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  acquire(&ptable.lock);
8010453c:	68 20 1d 11 80       	push   $0x80111d20
80104541:	e8 da 03 00 00       	call   80104920 <acquire>
80104546:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104549:	b8 88 1d 11 80       	mov    $0x80111d88,%eax
8010454e:	eb 0a                	jmp    8010455a <lock+0x6a>
80104550:	83 e8 80             	sub    $0xffffff80,%eax
80104553:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
80104558:	74 1c                	je     80104576 <lock+0x86>
    if(p->state == SLEEPING && p->chan == chan)
8010455a:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
8010455e:	75 f0                	jne    80104550 <lock+0x60>
80104560:	3b 58 20             	cmp    0x20(%eax),%ebx
80104563:	75 eb                	jne    80104550 <lock+0x60>
      p->state = RUNNABLE;
80104565:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010456c:	83 e8 80             	sub    $0xffffff80,%eax
8010456f:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
80104574:	75 e4                	jne    8010455a <lock+0x6a>
  release(&ptable.lock);
80104576:	83 ec 0c             	sub    $0xc,%esp
80104579:	68 20 1d 11 80       	push   $0x80111d20
8010457e:	e8 3d 03 00 00       	call   801048c0 <release>
      release(&ptable.guard);
80104583:	c7 04 24 54 1d 11 80 	movl   $0x80111d54,(%esp)
8010458a:	e8 31 03 00 00       	call   801048c0 <release>
  }
}
...
801045a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.guard);
801045aa:	68 54 1d 11 80       	push   $0x80111d54
801045af:	e8 6c 03 00 00       	call   80104920 <acquire>
  *lk = 0;
801045b4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  acquire(&ptable.lock);
801045ba:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801045c1:	e8 5a 03 00 00       	call   80104920 <acquire>
801045c6:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801045c9:	b8 88 1d 11 80       	mov    $0x80111d88,%eax
801045ce:	eb 0a                	jmp    801045da <unlock+0x3a>
801045d0:	83 e8 80             	sub    $0xffffff80,%eax
801045d3:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
801045d8:	74 1c                	je     801045f6 <unlock+0x56>
    if(p->state == SLEEPING && p->chan == chan)
801045da:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801045de:	75 f0                	jne    801045d0 <unlock+0x30>
801045e0:	3b 58 20             	cmp    0x20(%eax),%ebx
801045e3:	75 eb                	jne    801045d0 <unlock+0x30>
      p->state = RUNNABLE;
801045e5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801045ec:	83 e8 80             	sub    $0xffffff80,%eax
801045ef:	3d 88 3d 11 80       	cmp    $0x80113d88,%eax
801045f4:	75 e4                	jne    801045da <unlock+0x3a>
  release(&ptable.lock);
801045f6:	83 ec 0c             	sub    $0xc,%esp
801045f9:	68 20 1d 11 80       	push   $0x80111d20
801045fe:	e8 bd 02 00 00       	call   801048c0 <release>
  wakeup(lk);
  release(&ptable.guard);
80104603:	c7 04 24 54 1d 11 80 	movl   $0x80111d54,(%esp)
8010460a:	e8 b1 02 00 00       	call   801048c0 <release>
  return 0;
}
...
8010462a:	68 50 7c 10 80       	push   $0x80107c50
...
80104685:	e8 c6 f9 ff ff       	call   80104050 <sleep>
  while (lk->locked) {
...
80104693:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104699:	e8 e2 f2 ff ff       	call   80103980 <myproc>
...
801046e4:	e8 27 fa ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
8010473b:	e8 40 f2 ff ff       	call   80103980 <myproc>
80104740:	39 58 10             	cmp    %ebx,0x10(%eax)
...
801047fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104800:	e8 fb f0 ff ff       	call   80103900 <mycpu>
...
8010484c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104850:	e8 ab f0 ff ff       	call   80103900 <mycpu>
...
80104865:	68 5b 7c 10 80       	push   $0x80107c5b
8010486a:	e8 11 bb ff ff       	call   80100380 <panic>
    panic("popcli");
8010486f:	83 ec 0c             	sub    $0xc,%esp
80104872:	68 72 7c 10 80       	push   $0x80107c72
...
801048a3:	e8 58 f0 ff ff       	call   80103900 <mycpu>
...
801048db:	68 79 7c 10 80       	push   $0x80107c79
801048e0:	e8 9b ba ff ff       	call   80100380 <panic>
801048e5:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801048e8:	8b 73 08             	mov    0x8(%ebx),%esi
801048eb:	e8 10 f0 ff ff       	call   80103900 <mycpu>
...
8010495c:	e8 9f ef ff ff       	call   80103900 <mycpu>
...
801049bb:	e8 40 ef ff ff       	call   80103900 <mycpu>
...
801049d0:	68 81 7c 10 80       	push   $0x80107c81
801049d5:	e8 a6 b9 ff ff       	call   80100380 <panic>
...
80104c17:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104c1a:	e8 61 ed ff ff       	call   80103980 <myproc>
...
80104cf6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104cf9:	e8 82 ec ff ff       	call   80103980 <myproc>
80104cfe:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104d00:	e8 7b ec ff ff       	call   80103980 <myproc>
...
80104d0e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d11:	e8 6a ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d64:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104d65:	e8 16 ec ff ff       	call   80103980 <myproc>
...
80104d73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d76:	e8 05 ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d8b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104d8e:	e8 ed eb ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104de4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104de7:	e8 94 eb ff ff       	call   80103980 <myproc>
...
80104df7:	83 fa 18             	cmp    $0x18,%edx
80104dfa:	77 24                	ja     80104e20 <syscall+0x40>
80104dfc:	8b 14 85 c0 7c 10 80 	mov    -0x7fef8340(,%eax,4),%edx
...
80104e25:	ff 73 10             	pushl  0x10(%ebx)
80104e28:	68 89 7c 10 80       	push   $0x80107c89
80104e2d:	e8 6e b8 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80104e67:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104e6a:	e8 51 d2 ff ff       	call   801020c0 <nameiparent>
...
80104e8c:	e8 4f ce ff ff       	call   80101ce0 <dirlookup>
...
80104e9e:	e8 6d cb ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104ea3:	89 34 24             	mov    %esi,(%esp)
80104ea6:	e8 d5 c8 ff ff       	call   80101780 <ilock>
...
80104ed4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104ed6:	e8 35 cb ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104efa:	e8 11 c7 ff ff       	call   80101610 <ialloc>
...
80104f10:	e8 6b c8 ff ff       	call   80101780 <ilock>
  ip->major = major;
...
80104f31:	e8 9a c7 ff ff       	call   801016d0 <iupdate>
...
80104f43:	ff 76 04             	pushl  0x4(%esi)
80104f46:	57                   	push   %edi
80104f47:	53                   	push   %ebx
80104f48:	e8 93 d0 ff ff       	call   80101fe0 <dirlink>
...
80104f58:	e8 b3 ca ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104f79:	e8 52 c7 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104f7e:	83 c4 0c             	add    $0xc,%esp
80104f81:	ff 76 04             	pushl  0x4(%esi)
80104f84:	68 44 7d 10 80       	push   $0x80107d44
80104f89:	56                   	push   %esi
80104f8a:	e8 51 d0 ff ff       	call   80101fe0 <dirlink>
...
80104f9c:	68 43 7d 10 80       	push   $0x80107d43
80104fa1:	56                   	push   %esi
80104fa2:	e8 39 d0 ff ff       	call   80101fe0 <dirlink>
...
80104fb1:	68 37 7d 10 80       	push   $0x80107d37
...
80104fcf:	68 46 7d 10 80       	push   $0x80107d46
80104fd4:	e8 a7 b3 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104fd9:	83 ec 0c             	sub    $0xc,%esp
80104fdc:	68 28 7d 10 80       	push   $0x80107d28
...
80105010:	e8 6b e9 ff ff       	call   80103980 <myproc>
...
80105050:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105053:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80105057:	56                   	push   %esi
80105058:	e8 43 be ff ff       	call   80100ea0 <filedup>
  return fd;
...
801050cd:	ff 75 f0             	pushl  -0x10(%ebp)
801050d0:	ff 75 f4             	pushl  -0xc(%ebp)
801050d3:	56                   	push   %esi
801050d4:	e8 47 bf ff ff       	call   80101020 <fileread>
...
8010514d:	ff 75 f0             	pushl  -0x10(%ebp)
80105150:	ff 75 f4             	pushl  -0xc(%ebp)
80105153:	56                   	push   %esi
80105154:	e8 57 bf ff ff       	call   801010b0 <filewrite>
...
8010519b:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
8010519f:	85 f6                	test   %esi,%esi
801051a1:	74 25                	je     801051c8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801051a3:	e8 d8 e7 ff ff       	call   80103980 <myproc>
  fileclose(f);
801051a8:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
801051ab:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
801051b2:	00 
  fileclose(f);
801051b3:	56                   	push   %esi
801051b4:	e8 37 bd ff ff       	call   80100ef0 <fileclose>
  return 0;
...
8010521b:	e8 b0 bd ff ff       	call   80100fd0 <filestat>
...
80105272:	0f 88 e2 00 00 00    	js     8010535a <sys_link+0x11a>
  begin_op();
80105278:	e8 e3 da ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
8010527d:	83 ec 0c             	sub    $0xc,%esp
80105280:	ff 75 d4             	pushl  -0x2c(%ebp)
80105283:	e8 18 ce ff ff       	call   801020a0 <namei>
...
80105299:	e8 e2 c4 ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
...
801052b8:	e8 13 c4 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
801052bd:	89 1c 24             	mov    %ebx,(%esp)
801052c0:	e8 9b c5 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801052c5:	58                   	pop    %eax
801052c6:	5a                   	pop    %edx
801052c7:	57                   	push   %edi
801052c8:	ff 75 d0             	pushl  -0x30(%ebp)
801052cb:	e8 f0 cd ff ff       	call   801020c0 <nameiparent>
...
801052f3:	e8 e8 cc ff ff       	call   80101fe0 <dirlink>
...
80105303:	e8 08 c7 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105308:	89 1c 24             	mov    %ebx,(%esp)
8010530b:	e8 a0 c5 ff ff       	call   801018b0 <iput>
  end_op();
80105310:	e8 bb da ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105338:	e8 43 c4 ff ff       	call   80101780 <ilock>
  ip->nlink--;
8010533d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105342:	89 1c 24             	mov    %ebx,(%esp)
80105345:	e8 86 c3 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010534a:	89 1c 24             	mov    %ebx,(%esp)
8010534d:	e8 be c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105352:	e8 79 da ff ff       	call   80102dd0 <end_op>
  return -1;
...
801053d8:	e8 a3 c3 ff ff       	call   80101780 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801053dd:	58                   	pop    %eax
801053de:	5a                   	pop    %edx
801053df:	68 44 7d 10 80       	push   $0x80107d44
801053e4:	53                   	push   %ebx
801053e5:	e8 d6 c8 ff ff       	call   80101cc0 <namecmp>
...
801053f8:	68 43 7d 10 80       	push   $0x80107d43
801053fd:	53                   	push   %ebx
801053fe:	e8 bd c8 ff ff       	call   80101cc0 <namecmp>
...
80105417:	e8 c4 c8 ff ff       	call   80101ce0 <dirlookup>
...
8010542d:	e8 4e c3 ff ff       	call   80101780 <ilock>
  if(ip->nlink < 1)
...
80105460:	e8 2b c7 ff ff       	call   80101b90 <writei>
...
8010548f:	e8 3c c2 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105494:	89 1c 24             	mov    %ebx,(%esp)
80105497:	e8 74 c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010549c:	e8 2f d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801054cd:	e8 be c5 ff ff       	call   80101a90 <readi>
...
801054e5:	e8 26 c5 ff ff       	call   80101a10 <iunlockput>
    goto bad;
801054ea:	83 c4 10             	add    $0x10,%esp
801054ed:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
801054f0:	83 ec 0c             	sub    $0xc,%esp
801054f3:	ff 75 b4             	pushl  -0x4c(%ebp)
801054f6:	e8 15 c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
801054fb:	e8 d0 d8 ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105545:	68 68 7d 10 80       	push   $0x80107d68
8010554a:	e8 31 ae ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010554f:	83 ec 0c             	sub    $0xc,%esp
80105552:	68 7a 7d 10 80       	push   $0x80107d7a
80105557:	e8 24 ae ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010555c:	83 ec 0c             	sub    $0xc,%esp
8010555f:	68 56 7d 10 80       	push   $0x80107d56
...
801055b2:	ff 75 e0             	pushl  -0x20(%ebp)
...
8010591f:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
...
80105a4c:	e8 4f f2 ff ff       	call   80104ca0 <argint>
...
80105a9d:	e8 fe f1 ff ff       	call   80104ca0 <argint>
...
80105aed:	e8 ae f1 ff ff       	call   80104ca0 <argint>
...
80105b00:	68 c0 3d 11 80       	push   $0x80113dc0
80105b05:	e8 16 ee ff ff       	call   80104920 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105b0a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105b0d:	8b 1d a0 3d 11 80    	mov    0x80113da0,%ebx
  while(ticks - ticks0 < n){
...
80105b23:	68 c0 3d 11 80       	push   $0x80113dc0
80105b28:	68 a0 3d 11 80       	push   $0x80113da0
80105b2d:	e8 1e e5 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
80105b32:	a1 a0 3d 11 80       	mov    0x80113da0,%eax
...
80105b50:	68 c0 3d 11 80       	push   $0x80113dc0
80105b55:	e8 66 ed ff ff       	call   801048c0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105b73:	68 c0 3d 11 80       	push   $0x80113dc0
80105b78:	e8 43 ed ff ff       	call   801048c0 <release>
  return 0;
...
80105b94:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b97:	68 c0 3d 11 80       	push   $0x80113dc0
80105b9c:	e8 7f ed ff ff       	call   80104920 <acquire>
  xticks = ticks;
80105ba1:	8b 1d a0 3d 11 80    	mov    0x80113da0,%ebx
  release(&tickslock);
80105ba7:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80105bae:	e8 0d ed ff ff       	call   801048c0 <release>
  return xticks;
}
...
80105bce:	e8 1d f1 ff ff       	call   80104cf0 <argptr>
80105bd3:	83 c4 10             	add    $0x10,%esp
80105bd6:	85 c0                	test   %eax,%eax
80105bd8:	78 16                	js     80105bf0 <sys_clone+0x30>
    return -1;
  }
  return clone(stack);
80105bda:	83 ec 0c             	sub    $0xc,%esp
80105bdd:	ff 75 f4             	pushl  -0xc(%ebp)
80105be0:	e8 cb e6 ff ff       	call   801042b0 <clone>
...
80105c0e:	e8 dd f0 ff ff       	call   80104cf0 <argptr>
80105c13:	83 c4 10             	add    $0x10,%esp
80105c16:	85 c0                	test   %eax,%eax
80105c18:	78 16                	js     80105c30 <sys_lock+0x30>
    return -1;
  }
...
80105c20:	e8 cb e8 ff ff       	call   801044f0 <lock>
...
80105c4e:	e8 9d f0 ff ff       	call   80104cf0 <argptr>
80105c53:	83 c4 10             	add    $0x10,%esp
80105c56:	85 c0                	test   %eax,%eax
80105c58:	78 16                	js     80105c70 <sys_unlock+0x30>
    return -1;
  }
...
80105c60:	e8 3b e9 ff ff       	call   801045a0 <unlock>
...
{
  return join();
80105c80:	e9 5b e7 ff ff       	jmp    801043e0 <join>
...
80105c86:	06                   	push   %es
  pushl %fs
80105c87:	0f a0                	push   %fs
  pushl %gs
80105c89:	0f a8                	push   %gs
  pushal
80105c8b:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c8c:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c90:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c92:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c94:	54                   	push   %esp
  call trap
80105c95:	e8 c6 00 00 00       	call   80105d60 <trap>
  addl $4, %esp
80105c9a:	83 c4 04             	add    $0x4,%esp
...
80105c9d:	61                   	popa   
  popl %gs
80105c9e:	0f a9                	pop    %gs
  popl %fs
80105ca0:	0f a1                	pop    %fs
  popl %es
80105ca2:	07                   	pop    %es
  popl %ds
80105ca3:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105ca4:	83 c4 08             	add    $0x8,%esp
  iret
80105ca7:	cf                   	iret   
...
80105cc7:	c7 04 c5 02 3e 11 80 	movl   $0x8e000008,-0x7feec1fe(,%eax,8)
80105cce:	08 00 00 8e 
80105cd2:	66 89 14 c5 00 3e 11 	mov    %dx,-0x7feec200(,%eax,8)
80105cd9:	80 
80105cda:	c1 ea 10             	shr    $0x10,%edx
80105cdd:	66 89 14 c5 06 3e 11 	mov    %dx,-0x7feec1fa(,%eax,8)
80105ce4:	80 
  for(i = 0; i < 256; i++)
...
80105cef:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105cf2:	a1 08 a1 10 80       	mov    0x8010a108,%eax
80105cf7:	c7 05 02 40 11 80 08 	movl   $0xef000008,0x80114002
80105cfe:	00 00 ef 
  initlock(&tickslock, "time");
80105d01:	68 89 7d 10 80       	push   $0x80107d89
80105d06:	68 c0 3d 11 80       	push   $0x80113dc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d0b:	66 a3 00 40 11 80    	mov    %ax,0x80114000
80105d11:	c1 e8 10             	shr    $0x10,%eax
80105d14:	66 a3 06 40 11 80    	mov    %ax,0x80114006
  initlock(&tickslock, "time");
80105d1a:	e8 31 ea ff ff       	call   80104750 <initlock>
}
80105d1f:	83 c4 10             	add    $0x10,%esp
80105d22:	c9                   	leave  
80105d23:	c3                   	ret    
80105d24:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105d3b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d3f:	b8 00 3e 11 80       	mov    $0x80113e00,%eax
...
80105d69:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105d6c:	8b 43 30             	mov    0x30(%ebx),%eax
80105d6f:	83 f8 40             	cmp    $0x40,%eax
80105d72:	0f 84 68 01 00 00    	je     80105ee0 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105d7e:	0f 87 8c 00 00 00    	ja     80105e10 <trap+0xb0>
80105d84:	ff 24 85 30 7e 10 80 	jmp    *-0x7fef81d0(,%eax,4)
...
80105d90:	e8 ab c4 ff ff       	call   80102240 <ideintr>
    lapiceoi();
80105d95:	e8 76 cb ff ff       	call   80102910 <lapiceoi>
  }
...
80105dc7:	74 0f                	je     80105dd8 <trap+0x78>
80105dc9:	e8 b2 db ff ff       	call   80103980 <myproc>
80105dce:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105dd2:	0f 84 b8 00 00 00    	je     80105e90 <trap+0x130>
...
80105e15:	8b 7b 38             	mov    0x38(%ebx),%edi
80105e18:	85 c0                	test   %eax,%eax
80105e1a:	0f 84 a2 01 00 00    	je     80105fc2 <trap+0x262>
80105e20:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105e24:	0f 84 98 01 00 00    	je     80105fc2 <trap+0x262>
...
80105e2a:	0f 20 d1             	mov    %cr2,%ecx
80105e2d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105e30:	e8 2b db ff ff       	call   80103960 <cpuid>
80105e35:	8b 73 30             	mov    0x30(%ebx),%esi
80105e38:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105e3b:	8b 43 34             	mov    0x34(%ebx),%eax
...
80105e55:	57                   	push   %edi
80105e56:	52                   	push   %edx
80105e57:	ff 75 e4             	pushl  -0x1c(%ebp)
80105e5a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105e5b:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105e5e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105e61:	56                   	push   %esi
80105e62:	ff 70 10             	pushl  0x10(%eax)
80105e65:	68 ec 7d 10 80       	push   $0x80107dec
80105e6a:	e8 31 a8 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
...
80105e77:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e7e:	e8 fd da ff ff       	call   80103980 <myproc>
80105e83:	85 c0                	test   %eax,%eax
80105e85:	0f 85 18 ff ff ff    	jne    80105da3 <trap+0x43>
80105e8b:	e9 30 ff ff ff       	jmp    80105dc0 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80105e90:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105e94:	0f 85 3e ff ff ff    	jne    80105dd8 <trap+0x78>
    yield();
80105e9a:	e8 61 e1 ff ff       	call   80104000 <yield>
80105e9f:	e9 34 ff ff ff       	jmp    80105dd8 <trap+0x78>
...
80105eaf:	e8 ac da ff ff       	call   80103960 <cpuid>
80105eb4:	57                   	push   %edi
80105eb5:	56                   	push   %esi
80105eb6:	50                   	push   %eax
80105eb7:	68 94 7d 10 80       	push   $0x80107d94
80105ebc:	e8 df a7 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105ec1:	e8 4a ca ff ff       	call   80102910 <lapiceoi>
    break;
80105ec6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ec9:	e8 b2 da ff ff       	call   80103980 <myproc>
80105ece:	85 c0                	test   %eax,%eax
80105ed0:	0f 85 cd fe ff ff    	jne    80105da3 <trap+0x43>
80105ed6:	e9 e5 fe ff ff       	jmp    80105dc0 <trap+0x60>
80105edb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105edf:	90                   	nop
    if(myproc()->killed)
80105ee0:	e8 9b da ff ff       	call   80103980 <myproc>
80105ee5:	8b 70 24             	mov    0x24(%eax),%esi
80105ee8:	85 f6                	test   %esi,%esi
80105eea:	0f 85 c8 00 00 00    	jne    80105fb8 <trap+0x258>
    myproc()->tf = tf;
80105ef0:	e8 8b da ff ff       	call   80103980 <myproc>
80105ef5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ef8:	e8 e3 ee ff ff       	call   80104de0 <syscall>
    if(myproc()->killed)
80105efd:	e8 7e da ff ff       	call   80103980 <myproc>
80105f02:	8b 48 24             	mov    0x24(%eax),%ecx
80105f05:	85 c9                	test   %ecx,%ecx
80105f07:	0f 84 f1 fe ff ff    	je     80105dfe <trap+0x9e>
}
80105f0d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105f10:	5b                   	pop    %ebx
80105f11:	5e                   	pop    %esi
80105f12:	5f                   	pop    %edi
80105f13:	5d                   	pop    %ebp
      exit();
80105f14:	e9 87 de ff ff       	jmp    80103da0 <exit>
80105f19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105f20:	e8 3b 02 00 00       	call   80106160 <uartintr>
    lapiceoi();
80105f25:	e8 e6 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f2a:	e8 51 da ff ff       	call   80103980 <myproc>
80105f2f:	85 c0                	test   %eax,%eax
80105f31:	0f 85 6c fe ff ff    	jne    80105da3 <trap+0x43>
80105f37:	e9 84 fe ff ff       	jmp    80105dc0 <trap+0x60>
80105f3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105f40:	e8 8b c8 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105f45:	e8 c6 c9 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f4a:	e8 31 da ff ff       	call   80103980 <myproc>
80105f4f:	85 c0                	test   %eax,%eax
80105f51:	0f 85 4c fe ff ff    	jne    80105da3 <trap+0x43>
80105f57:	e9 64 fe ff ff       	jmp    80105dc0 <trap+0x60>
80105f5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105f60:	e8 fb d9 ff ff       	call   80103960 <cpuid>
80105f65:	85 c0                	test   %eax,%eax
80105f67:	0f 85 28 fe ff ff    	jne    80105d95 <trap+0x35>
      acquire(&tickslock);
80105f6d:	83 ec 0c             	sub    $0xc,%esp
80105f70:	68 c0 3d 11 80       	push   $0x80113dc0
80105f75:	e8 a6 e9 ff ff       	call   80104920 <acquire>
      wakeup(&ticks);
80105f7a:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
      ticks++;
80105f81:	83 05 a0 3d 11 80 01 	addl   $0x1,0x80113da0
      wakeup(&ticks);
80105f88:	e8 83 e1 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105f8d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80105f94:	e8 27 e9 ff ff       	call   801048c0 <release>
80105f99:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105f9c:	e9 f4 fd ff ff       	jmp    80105d95 <trap+0x35>
80105fa1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105fa8:	e8 f3 dd ff ff       	call   80103da0 <exit>
80105fad:	e9 0e fe ff ff       	jmp    80105dc0 <trap+0x60>
80105fb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105fb8:	e8 e3 dd ff ff       	call   80103da0 <exit>
80105fbd:	e9 2e ff ff ff       	jmp    80105ef0 <trap+0x190>
80105fc2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105fc5:	e8 96 d9 ff ff       	call   80103960 <cpuid>
80105fca:	83 ec 0c             	sub    $0xc,%esp
80105fcd:	56                   	push   %esi
80105fce:	57                   	push   %edi
80105fcf:	50                   	push   %eax
80105fd0:	ff 73 30             	pushl  0x30(%ebx)
80105fd3:	68 b8 7d 10 80       	push   $0x80107db8
80105fd8:	e8 c3 a6 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105fdd:	83 c4 14             	add    $0x14,%esp
80105fe0:	68 8e 7d 10 80       	push   $0x80107d8e
80105fe5:	e8 96 a3 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80105ff0:	a1 00 46 11 80       	mov    0x80114600,%eax
...
80106077:	74 78                	je     801060f1 <uartinit+0xd1>
  uart = 1;
80106079:	c7 05 00 46 11 80 01 	movl   $0x1,0x80114600
80106080:	00 00 00 
...
8010608c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010608f:	bf b0 7e 10 80       	mov    $0x80107eb0,%edi
80106094:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106099:	6a 00                	push   $0x0
8010609b:	6a 04                	push   $0x4
8010609d:	e8 de c3 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801060a2:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
801060a6:	83 c4 10             	add    $0x10,%esp
801060a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
801060b0:	a1 00 46 11 80       	mov    0x80114600,%eax
801060b5:	bb 80 00 00 00       	mov    $0x80,%ebx
801060ba:	85 c0                	test   %eax,%eax
801060bc:	75 14                	jne    801060d2 <uartinit+0xb2>
801060be:	eb 23                	jmp    801060e3 <uartinit+0xc3>
    microdelay(10);
...
801060d0:	74 07                	je     801060d9 <uartinit+0xb9>
801060d2:	89 f2                	mov    %esi,%edx
801060d4:	ec                   	in     (%dx),%al
801060d5:	a8 20                	test   $0x20,%al
801060d7:	74 e7                	je     801060c0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801060d9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801060dd:	ba f8 03 00 00       	mov    $0x3f8,%edx
801060e2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
801060e3:	0f b6 47 01          	movzbl 0x1(%edi),%eax
801060e7:	83 c7 01             	add    $0x1,%edi
801060ea:	88 45 e7             	mov    %al,-0x19(%ebp)
801060ed:	84 c0                	test   %al,%al
801060ef:	75 bf                	jne    801060b0 <uartinit+0x90>
}
...
80106100 <uartputc>:
  if(!uart)
80106100:	a1 00 46 11 80       	mov    0x80114600,%eax
...
8010616b:	e8 10 a7 ff ff       	call   80100880 <consoleintr>
}
...
80106177:	6a 00                	push   $0x0
  jmp alltraps
80106179:	e9 07 fb ff ff       	jmp    80105c85 <alltraps>
...
80106180:	6a 01                	push   $0x1
  jmp alltraps
80106182:	e9 fe fa ff ff       	jmp    80105c85 <alltraps>
...
80106189:	6a 02                	push   $0x2
  jmp alltraps
8010618b:	e9 f5 fa ff ff       	jmp    80105c85 <alltraps>
...
80106192:	6a 03                	push   $0x3
  jmp alltraps
80106194:	e9 ec fa ff ff       	jmp    80105c85 <alltraps>
...
8010619b:	6a 04                	push   $0x4
  jmp alltraps
8010619d:	e9 e3 fa ff ff       	jmp    80105c85 <alltraps>
...
801061a4:	6a 05                	push   $0x5
  jmp alltraps
801061a6:	e9 da fa ff ff       	jmp    80105c85 <alltraps>
...
801061ad:	6a 06                	push   $0x6
  jmp alltraps
801061af:	e9 d1 fa ff ff       	jmp    80105c85 <alltraps>
...
801061b6:	6a 07                	push   $0x7
  jmp alltraps
801061b8:	e9 c8 fa ff ff       	jmp    80105c85 <alltraps>
...
801061bd:	6a 08                	push   $0x8
  jmp alltraps
801061bf:	e9 c1 fa ff ff       	jmp    80105c85 <alltraps>
...
801061c6:	6a 09                	push   $0x9
  jmp alltraps
801061c8:	e9 b8 fa ff ff       	jmp    80105c85 <alltraps>
...
801061cd:	6a 0a                	push   $0xa
  jmp alltraps
801061cf:	e9 b1 fa ff ff       	jmp    80105c85 <alltraps>
...
801061d4:	6a 0b                	push   $0xb
  jmp alltraps
801061d6:	e9 aa fa ff ff       	jmp    80105c85 <alltraps>
...
801061db:	6a 0c                	push   $0xc
  jmp alltraps
801061dd:	e9 a3 fa ff ff       	jmp    80105c85 <alltraps>
...
801061e2:	6a 0d                	push   $0xd
  jmp alltraps
801061e4:	e9 9c fa ff ff       	jmp    80105c85 <alltraps>
...
801061e9:	6a 0e                	push   $0xe
  jmp alltraps
801061eb:	e9 95 fa ff ff       	jmp    80105c85 <alltraps>
...
801061f2:	6a 0f                	push   $0xf
  jmp alltraps
801061f4:	e9 8c fa ff ff       	jmp    80105c85 <alltraps>
...
801061fb:	6a 10                	push   $0x10
  jmp alltraps
801061fd:	e9 83 fa ff ff       	jmp    80105c85 <alltraps>
...
80106202:	6a 11                	push   $0x11
  jmp alltraps
80106204:	e9 7c fa ff ff       	jmp    80105c85 <alltraps>
...
8010620b:	6a 12                	push   $0x12
  jmp alltraps
8010620d:	e9 73 fa ff ff       	jmp    80105c85 <alltraps>
...
80106214:	6a 13                	push   $0x13
  jmp alltraps
80106216:	e9 6a fa ff ff       	jmp    80105c85 <alltraps>
...
8010621d:	6a 14                	push   $0x14
  jmp alltraps
8010621f:	e9 61 fa ff ff       	jmp    80105c85 <alltraps>
...
80106226:	6a 15                	push   $0x15
  jmp alltraps
80106228:	e9 58 fa ff ff       	jmp    80105c85 <alltraps>
...
8010622f:	6a 16                	push   $0x16
  jmp alltraps
80106231:	e9 4f fa ff ff       	jmp    80105c85 <alltraps>
...
80106238:	6a 17                	push   $0x17
  jmp alltraps
8010623a:	e9 46 fa ff ff       	jmp    80105c85 <alltraps>
...
80106241:	6a 18                	push   $0x18
  jmp alltraps
80106243:	e9 3d fa ff ff       	jmp    80105c85 <alltraps>
...
8010624a:	6a 19                	push   $0x19
  jmp alltraps
8010624c:	e9 34 fa ff ff       	jmp    80105c85 <alltraps>
...
80106253:	6a 1a                	push   $0x1a
  jmp alltraps
80106255:	e9 2b fa ff ff       	jmp    80105c85 <alltraps>
...
8010625c:	6a 1b                	push   $0x1b
  jmp alltraps
8010625e:	e9 22 fa ff ff       	jmp    80105c85 <alltraps>
...
80106265:	6a 1c                	push   $0x1c
  jmp alltraps
80106267:	e9 19 fa ff ff       	jmp    80105c85 <alltraps>
...
8010626e:	6a 1d                	push   $0x1d
  jmp alltraps
80106270:	e9 10 fa ff ff       	jmp    80105c85 <alltraps>
...
80106277:	6a 1e                	push   $0x1e
  jmp alltraps
80106279:	e9 07 fa ff ff       	jmp    80105c85 <alltraps>
...
80106280:	6a 1f                	push   $0x1f
  jmp alltraps
80106282:	e9 fe f9 ff ff       	jmp    80105c85 <alltraps>
...
80106289:	6a 20                	push   $0x20
  jmp alltraps
8010628b:	e9 f5 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106292:	6a 21                	push   $0x21
  jmp alltraps
80106294:	e9 ec f9 ff ff       	jmp    80105c85 <alltraps>
...
8010629b:	6a 22                	push   $0x22
  jmp alltraps
8010629d:	e9 e3 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062a4:	6a 23                	push   $0x23
  jmp alltraps
801062a6:	e9 da f9 ff ff       	jmp    80105c85 <alltraps>
...
801062ad:	6a 24                	push   $0x24
  jmp alltraps
801062af:	e9 d1 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062b6:	6a 25                	push   $0x25
  jmp alltraps
801062b8:	e9 c8 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062bf:	6a 26                	push   $0x26
  jmp alltraps
801062c1:	e9 bf f9 ff ff       	jmp    80105c85 <alltraps>
...
801062c8:	6a 27                	push   $0x27
  jmp alltraps
801062ca:	e9 b6 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062d1:	6a 28                	push   $0x28
  jmp alltraps
801062d3:	e9 ad f9 ff ff       	jmp    80105c85 <alltraps>
...
801062da:	6a 29                	push   $0x29
  jmp alltraps
801062dc:	e9 a4 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062e3:	6a 2a                	push   $0x2a
  jmp alltraps
801062e5:	e9 9b f9 ff ff       	jmp    80105c85 <alltraps>
...
801062ec:	6a 2b                	push   $0x2b
  jmp alltraps
801062ee:	e9 92 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062f5:	6a 2c                	push   $0x2c
  jmp alltraps
801062f7:	e9 89 f9 ff ff       	jmp    80105c85 <alltraps>
...
801062fe:	6a 2d                	push   $0x2d
  jmp alltraps
80106300:	e9 80 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106307:	6a 2e                	push   $0x2e
  jmp alltraps
80106309:	e9 77 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106310:	6a 2f                	push   $0x2f
  jmp alltraps
80106312:	e9 6e f9 ff ff       	jmp    80105c85 <alltraps>
...
80106319:	6a 30                	push   $0x30
  jmp alltraps
8010631b:	e9 65 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106322:	6a 31                	push   $0x31
  jmp alltraps
80106324:	e9 5c f9 ff ff       	jmp    80105c85 <alltraps>
...
8010632b:	6a 32                	push   $0x32
  jmp alltraps
8010632d:	e9 53 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106334:	6a 33                	push   $0x33
  jmp alltraps
80106336:	e9 4a f9 ff ff       	jmp    80105c85 <alltraps>
...
8010633d:	6a 34                	push   $0x34
  jmp alltraps
8010633f:	e9 41 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106346:	6a 35                	push   $0x35
  jmp alltraps
80106348:	e9 38 f9 ff ff       	jmp    80105c85 <alltraps>
...
8010634f:	6a 36                	push   $0x36
  jmp alltraps
80106351:	e9 2f f9 ff ff       	jmp    80105c85 <alltraps>
...
80106358:	6a 37                	push   $0x37
  jmp alltraps
8010635a:	e9 26 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106361:	6a 38                	push   $0x38
  jmp alltraps
80106363:	e9 1d f9 ff ff       	jmp    80105c85 <alltraps>
...
8010636a:	6a 39                	push   $0x39
  jmp alltraps
8010636c:	e9 14 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106373:	6a 3a                	push   $0x3a
  jmp alltraps
80106375:	e9 0b f9 ff ff       	jmp    80105c85 <alltraps>
...
8010637c:	6a 3b                	push   $0x3b
  jmp alltraps
8010637e:	e9 02 f9 ff ff       	jmp    80105c85 <alltraps>
...
80106385:	6a 3c                	push   $0x3c
  jmp alltraps
80106387:	e9 f9 f8 ff ff       	jmp    80105c85 <alltraps>
...
8010638e:	6a 3d                	push   $0x3d
  jmp alltraps
80106390:	e9 f0 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106397:	6a 3e                	push   $0x3e
  jmp alltraps
80106399:	e9 e7 f8 ff ff       	jmp    80105c85 <alltraps>
...
801063a0:	6a 3f                	push   $0x3f
  jmp alltraps
801063a2:	e9 de f8 ff ff       	jmp    80105c85 <alltraps>
...
801063a9:	6a 40                	push   $0x40
  jmp alltraps
801063ab:	e9 d5 f8 ff ff       	jmp    80105c85 <alltraps>
...
801063b2:	6a 41                	push   $0x41
  jmp alltraps
801063b4:	e9 cc f8 ff ff       	jmp    80105c85 <alltraps>
...
801063bb:	6a 42                	push   $0x42
  jmp alltraps
801063bd:	e9 c3 f8 ff ff       	jmp    80105c85 <alltraps>
...
801063c4:	6a 43                	push   $0x43
  jmp alltraps
801063c6:	e9 ba f8 ff ff       	jmp    80105c85 <alltraps>
...
801063cd:	6a 44                	push   $0x44
  jmp alltraps
801063cf:	e9 b1 f8 ff ff       	jmp    80105c85 <alltraps>
...
801063d6:	6a 45                	push   $0x45
  jmp alltraps
801063d8:	e9 a8 f8 ff ff       	jmp    80105c85 <alltraps>
...
801063df:	6a 46                	push   $0x46
  jmp alltraps
801063e1:	e9 9f f8 ff ff       	jmp    80105c85 <alltraps>
...
801063e8:	6a 47                	push   $0x47
  jmp alltraps
801063ea:	e9 96 f8 ff ff       	jmp    80105c85 <alltraps>
...
801063f1:	6a 48                	push   $0x48
  jmp alltraps
801063f3:	e9 8d f8 ff ff       	jmp    80105c85 <alltraps>
...
801063fa:	6a 49                	push   $0x49
  jmp alltraps
801063fc:	e9 84 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106403:	6a 4a                	push   $0x4a
  jmp alltraps
80106405:	e9 7b f8 ff ff       	jmp    80105c85 <alltraps>
...
8010640c:	6a 4b                	push   $0x4b
  jmp alltraps
8010640e:	e9 72 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106415:	6a 4c                	push   $0x4c
  jmp alltraps
80106417:	e9 69 f8 ff ff       	jmp    80105c85 <alltraps>
...
8010641e:	6a 4d                	push   $0x4d
  jmp alltraps
80106420:	e9 60 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106427:	6a 4e                	push   $0x4e
  jmp alltraps
80106429:	e9 57 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106430:	6a 4f                	push   $0x4f
  jmp alltraps
80106432:	e9 4e f8 ff ff       	jmp    80105c85 <alltraps>
...
80106439:	6a 50                	push   $0x50
  jmp alltraps
8010643b:	e9 45 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106442:	6a 51                	push   $0x51
  jmp alltraps
80106444:	e9 3c f8 ff ff       	jmp    80105c85 <alltraps>
...
8010644b:	6a 52                	push   $0x52
  jmp alltraps
8010644d:	e9 33 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106454:	6a 53                	push   $0x53
  jmp alltraps
80106456:	e9 2a f8 ff ff       	jmp    80105c85 <alltraps>
...
8010645d:	6a 54                	push   $0x54
  jmp alltraps
8010645f:	e9 21 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106466:	6a 55                	push   $0x55
  jmp alltraps
80106468:	e9 18 f8 ff ff       	jmp    80105c85 <alltraps>
...
8010646f:	6a 56                	push   $0x56
  jmp alltraps
80106471:	e9 0f f8 ff ff       	jmp    80105c85 <alltraps>
...
80106478:	6a 57                	push   $0x57
  jmp alltraps
8010647a:	e9 06 f8 ff ff       	jmp    80105c85 <alltraps>
...
80106481:	6a 58                	push   $0x58
  jmp alltraps
80106483:	e9 fd f7 ff ff       	jmp    80105c85 <alltraps>
...
8010648a:	6a 59                	push   $0x59
  jmp alltraps
8010648c:	e9 f4 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106493:	6a 5a                	push   $0x5a
  jmp alltraps
80106495:	e9 eb f7 ff ff       	jmp    80105c85 <alltraps>
...
8010649c:	6a 5b                	push   $0x5b
  jmp alltraps
8010649e:	e9 e2 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064a5:	6a 5c                	push   $0x5c
  jmp alltraps
801064a7:	e9 d9 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064ae:	6a 5d                	push   $0x5d
  jmp alltraps
801064b0:	e9 d0 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064b7:	6a 5e                	push   $0x5e
  jmp alltraps
801064b9:	e9 c7 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064c0:	6a 5f                	push   $0x5f
  jmp alltraps
801064c2:	e9 be f7 ff ff       	jmp    80105c85 <alltraps>
...
801064c9:	6a 60                	push   $0x60
  jmp alltraps
801064cb:	e9 b5 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064d2:	6a 61                	push   $0x61
  jmp alltraps
801064d4:	e9 ac f7 ff ff       	jmp    80105c85 <alltraps>
...
801064db:	6a 62                	push   $0x62
  jmp alltraps
801064dd:	e9 a3 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064e4:	6a 63                	push   $0x63
  jmp alltraps
801064e6:	e9 9a f7 ff ff       	jmp    80105c85 <alltraps>
...
801064ed:	6a 64                	push   $0x64
  jmp alltraps
801064ef:	e9 91 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064f6:	6a 65                	push   $0x65
  jmp alltraps
801064f8:	e9 88 f7 ff ff       	jmp    80105c85 <alltraps>
...
801064ff:	6a 66                	push   $0x66
  jmp alltraps
80106501:	e9 7f f7 ff ff       	jmp    80105c85 <alltraps>
...
80106508:	6a 67                	push   $0x67
  jmp alltraps
8010650a:	e9 76 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106511:	6a 68                	push   $0x68
  jmp alltraps
80106513:	e9 6d f7 ff ff       	jmp    80105c85 <alltraps>
...
8010651a:	6a 69                	push   $0x69
  jmp alltraps
8010651c:	e9 64 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106523:	6a 6a                	push   $0x6a
  jmp alltraps
80106525:	e9 5b f7 ff ff       	jmp    80105c85 <alltraps>
...
8010652c:	6a 6b                	push   $0x6b
  jmp alltraps
8010652e:	e9 52 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106535:	6a 6c                	push   $0x6c
  jmp alltraps
80106537:	e9 49 f7 ff ff       	jmp    80105c85 <alltraps>
...
8010653e:	6a 6d                	push   $0x6d
  jmp alltraps
80106540:	e9 40 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106547:	6a 6e                	push   $0x6e
  jmp alltraps
80106549:	e9 37 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106550:	6a 6f                	push   $0x6f
  jmp alltraps
80106552:	e9 2e f7 ff ff       	jmp    80105c85 <alltraps>
...
80106559:	6a 70                	push   $0x70
  jmp alltraps
8010655b:	e9 25 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106562:	6a 71                	push   $0x71
  jmp alltraps
80106564:	e9 1c f7 ff ff       	jmp    80105c85 <alltraps>
...
8010656b:	6a 72                	push   $0x72
  jmp alltraps
8010656d:	e9 13 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106574:	6a 73                	push   $0x73
  jmp alltraps
80106576:	e9 0a f7 ff ff       	jmp    80105c85 <alltraps>
...
8010657d:	6a 74                	push   $0x74
  jmp alltraps
8010657f:	e9 01 f7 ff ff       	jmp    80105c85 <alltraps>
...
80106586:	6a 75                	push   $0x75
  jmp alltraps
80106588:	e9 f8 f6 ff ff       	jmp    80105c85 <alltraps>
...
8010658f:	6a 76                	push   $0x76
  jmp alltraps
80106591:	e9 ef f6 ff ff       	jmp    80105c85 <alltraps>
...
80106598:	6a 77                	push   $0x77
  jmp alltraps
8010659a:	e9 e6 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065a1:	6a 78                	push   $0x78
  jmp alltraps
801065a3:	e9 dd f6 ff ff       	jmp    80105c85 <alltraps>
...
801065aa:	6a 79                	push   $0x79
  jmp alltraps
801065ac:	e9 d4 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065b3:	6a 7a                	push   $0x7a
  jmp alltraps
801065b5:	e9 cb f6 ff ff       	jmp    80105c85 <alltraps>
...
801065bc:	6a 7b                	push   $0x7b
  jmp alltraps
801065be:	e9 c2 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065c5:	6a 7c                	push   $0x7c
  jmp alltraps
801065c7:	e9 b9 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065ce:	6a 7d                	push   $0x7d
  jmp alltraps
801065d0:	e9 b0 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065d7:	6a 7e                	push   $0x7e
  jmp alltraps
801065d9:	e9 a7 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065e0:	6a 7f                	push   $0x7f
  jmp alltraps
801065e2:	e9 9e f6 ff ff       	jmp    80105c85 <alltraps>
...
801065e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801065ee:	e9 92 f6 ff ff       	jmp    80105c85 <alltraps>
...
801065f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801065fa:	e9 86 f6 ff ff       	jmp    80105c85 <alltraps>
...
80106601:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106606:	e9 7a f6 ff ff       	jmp    80105c85 <alltraps>
...
8010660d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106612:	e9 6e f6 ff ff       	jmp    80105c85 <alltraps>
...
80106619:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010661e:	e9 62 f6 ff ff       	jmp    80105c85 <alltraps>
...
80106625:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010662a:	e9 56 f6 ff ff       	jmp    80105c85 <alltraps>
...
80106631:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106636:	e9 4a f6 ff ff       	jmp    80105c85 <alltraps>
...
8010663d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106642:	e9 3e f6 ff ff       	jmp    80105c85 <alltraps>
...
80106649:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010664e:	e9 32 f6 ff ff       	jmp    80105c85 <alltraps>
...
80106655:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010665a:	e9 26 f6 ff ff       	jmp    80105c85 <alltraps>
...
80106661:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106666:	e9 1a f6 ff ff       	jmp    80105c85 <alltraps>
...
8010666d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106672:	e9 0e f6 ff ff       	jmp    80105c85 <alltraps>
...
80106679:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010667e:	e9 02 f6 ff ff       	jmp    80105c85 <alltraps>
...
80106685:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010668a:	e9 f6 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106691:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106696:	e9 ea f5 ff ff       	jmp    80105c85 <alltraps>
...
8010669d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801066a2:	e9 de f5 ff ff       	jmp    80105c85 <alltraps>
...
801066a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801066ae:	e9 d2 f5 ff ff       	jmp    80105c85 <alltraps>
...
801066b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801066ba:	e9 c6 f5 ff ff       	jmp    80105c85 <alltraps>
...
801066c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801066c6:	e9 ba f5 ff ff       	jmp    80105c85 <alltraps>
...
801066cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801066d2:	e9 ae f5 ff ff       	jmp    80105c85 <alltraps>
...
801066d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801066de:	e9 a2 f5 ff ff       	jmp    80105c85 <alltraps>
...
801066e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801066ea:	e9 96 f5 ff ff       	jmp    80105c85 <alltraps>
...
801066f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801066f6:	e9 8a f5 ff ff       	jmp    80105c85 <alltraps>
...
801066fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106702:	e9 7e f5 ff ff       	jmp    80105c85 <alltraps>
...
80106709:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010670e:	e9 72 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106715:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010671a:	e9 66 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106721:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106726:	e9 5a f5 ff ff       	jmp    80105c85 <alltraps>
...
8010672d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106732:	e9 4e f5 ff ff       	jmp    80105c85 <alltraps>
...
80106739:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010673e:	e9 42 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106745:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010674a:	e9 36 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106751:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106756:	e9 2a f5 ff ff       	jmp    80105c85 <alltraps>
...
8010675d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106762:	e9 1e f5 ff ff       	jmp    80105c85 <alltraps>
...
80106769:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010676e:	e9 12 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106775:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010677a:	e9 06 f5 ff ff       	jmp    80105c85 <alltraps>
...
80106781:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106786:	e9 fa f4 ff ff       	jmp    80105c85 <alltraps>
...
8010678d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106792:	e9 ee f4 ff ff       	jmp    80105c85 <alltraps>
...
80106799:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010679e:	e9 e2 f4 ff ff       	jmp    80105c85 <alltraps>
...
801067a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801067aa:	e9 d6 f4 ff ff       	jmp    80105c85 <alltraps>
...
801067b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801067b6:	e9 ca f4 ff ff       	jmp    80105c85 <alltraps>
...
801067bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801067c2:	e9 be f4 ff ff       	jmp    80105c85 <alltraps>
...
801067c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801067ce:	e9 b2 f4 ff ff       	jmp    80105c85 <alltraps>
...
801067d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801067da:	e9 a6 f4 ff ff       	jmp    80105c85 <alltraps>
...
801067e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801067e6:	e9 9a f4 ff ff       	jmp    80105c85 <alltraps>
...
801067ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801067f2:	e9 8e f4 ff ff       	jmp    80105c85 <alltraps>
...
801067f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801067fe:	e9 82 f4 ff ff       	jmp    80105c85 <alltraps>
...
80106805:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010680a:	e9 76 f4 ff ff       	jmp    80105c85 <alltraps>
...
80106811:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106816:	e9 6a f4 ff ff       	jmp    80105c85 <alltraps>
...
8010681d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106822:	e9 5e f4 ff ff       	jmp    80105c85 <alltraps>
...
80106829:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010682e:	e9 52 f4 ff ff       	jmp    80105c85 <alltraps>
...
80106835:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010683a:	e9 46 f4 ff ff       	jmp    80105c85 <alltraps>
...
80106841:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106846:	e9 3a f4 ff ff       	jmp    80105c85 <alltraps>
...
8010684d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106852:	e9 2e f4 ff ff       	jmp    80105c85 <alltraps>
...
80106859:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010685e:	e9 22 f4 ff ff       	jmp    80105c85 <alltraps>
...
80106865:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010686a:	e9 16 f4 ff ff       	jmp    80105c85 <alltraps>
...
80106871:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106876:	e9 0a f4 ff ff       	jmp    80105c85 <alltraps>
...
8010687d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106882:	e9 fe f3 ff ff       	jmp    80105c85 <alltraps>
...
80106889:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010688e:	e9 f2 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106895:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010689a:	e9 e6 f3 ff ff       	jmp    80105c85 <alltraps>
...
801068a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801068a6:	e9 da f3 ff ff       	jmp    80105c85 <alltraps>
...
801068ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801068b2:	e9 ce f3 ff ff       	jmp    80105c85 <alltraps>
...
801068b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801068be:	e9 c2 f3 ff ff       	jmp    80105c85 <alltraps>
...
801068c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801068ca:	e9 b6 f3 ff ff       	jmp    80105c85 <alltraps>
...
801068d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801068d6:	e9 aa f3 ff ff       	jmp    80105c85 <alltraps>
...
801068dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801068e2:	e9 9e f3 ff ff       	jmp    80105c85 <alltraps>
...
801068e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801068ee:	e9 92 f3 ff ff       	jmp    80105c85 <alltraps>
...
801068f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801068fa:	e9 86 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106901:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106906:	e9 7a f3 ff ff       	jmp    80105c85 <alltraps>
...
8010690d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106912:	e9 6e f3 ff ff       	jmp    80105c85 <alltraps>
...
80106919:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010691e:	e9 62 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106925:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010692a:	e9 56 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106931:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106936:	e9 4a f3 ff ff       	jmp    80105c85 <alltraps>
...
8010693d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106942:	e9 3e f3 ff ff       	jmp    80105c85 <alltraps>
...
80106949:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010694e:	e9 32 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106955:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010695a:	e9 26 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106961:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106966:	e9 1a f3 ff ff       	jmp    80105c85 <alltraps>
...
8010696d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106972:	e9 0e f3 ff ff       	jmp    80105c85 <alltraps>
...
80106979:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010697e:	e9 02 f3 ff ff       	jmp    80105c85 <alltraps>
...
80106985:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010698a:	e9 f6 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106991:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106996:	e9 ea f2 ff ff       	jmp    80105c85 <alltraps>
...
8010699d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801069a2:	e9 de f2 ff ff       	jmp    80105c85 <alltraps>
...
801069a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801069ae:	e9 d2 f2 ff ff       	jmp    80105c85 <alltraps>
...
801069b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801069ba:	e9 c6 f2 ff ff       	jmp    80105c85 <alltraps>
...
801069c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801069c6:	e9 ba f2 ff ff       	jmp    80105c85 <alltraps>
...
801069cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801069d2:	e9 ae f2 ff ff       	jmp    80105c85 <alltraps>
...
801069d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801069de:	e9 a2 f2 ff ff       	jmp    80105c85 <alltraps>
...
801069e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801069ea:	e9 96 f2 ff ff       	jmp    80105c85 <alltraps>
...
801069f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801069f6:	e9 8a f2 ff ff       	jmp    80105c85 <alltraps>
...
801069fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106a02:	e9 7e f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a09:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106a0e:	e9 72 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a15:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a1a:	e9 66 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a21:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a26:	e9 5a f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a2d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106a32:	e9 4e f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a39:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106a3e:	e9 42 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a45:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106a4a:	e9 36 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a51:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106a56:	e9 2a f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a5d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a62:	e9 1e f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a69:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a6e:	e9 12 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a75:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a7a:	e9 06 f2 ff ff       	jmp    80105c85 <alltraps>
...
80106a81:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a86:	e9 fa f1 ff ff       	jmp    80105c85 <alltraps>
...
80106a8d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a92:	e9 ee f1 ff ff       	jmp    80105c85 <alltraps>
...
80106a99:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a9e:	e9 e2 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106aa5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106aaa:	e9 d6 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106ab1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106ab6:	e9 ca f1 ff ff       	jmp    80105c85 <alltraps>
...
80106abd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106ac2:	e9 be f1 ff ff       	jmp    80105c85 <alltraps>
...
80106ac9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106ace:	e9 b2 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106ad5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106ada:	e9 a6 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106ae1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106ae6:	e9 9a f1 ff ff       	jmp    80105c85 <alltraps>
...
80106aed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106af2:	e9 8e f1 ff ff       	jmp    80105c85 <alltraps>
...
80106af9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106afe:	e9 82 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b05:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106b0a:	e9 76 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b11:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b16:	e9 6a f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b1d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b22:	e9 5e f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b29:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b2e:	e9 52 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b35:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106b3a:	e9 46 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b41:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106b46:	e9 3a f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b4d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106b52:	e9 2e f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b59:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b5e:	e9 22 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b65:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b6a:	e9 16 f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b71:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b76:	e9 0a f1 ff ff       	jmp    80105c85 <alltraps>
...
80106b7d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b82:	e9 fe f0 ff ff       	jmp    80105c85 <alltraps>
...
80106b89:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b8e:	e9 f2 f0 ff ff       	jmp    80105c85 <alltraps>
...
80106b95:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b9a:	e9 e6 f0 ff ff       	jmp    80105c85 <alltraps>
...
80106ba1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106ba6:	e9 da f0 ff ff       	jmp    80105c85 <alltraps>
...
80106bad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106bb2:	e9 ce f0 ff ff       	jmp    80105c85 <alltraps>
...
80106bb9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106bbe:	e9 c2 f0 ff ff       	jmp    80105c85 <alltraps>
...
80106bc5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106bca:	e9 b6 f0 ff ff       	jmp    80105c85 <alltraps>
...
80106bd1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106bd6:	e9 aa f0 ff ff       	jmp    80105c85 <alltraps>
...
80106bdd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106be2:	e9 9e f0 ff ff       	jmp    80105c85 <alltraps>
...
80106c0a:	73 49                	jae    80106c55 <deallocuvm.part.0+0x65>
80106c0c:	89 c7                	mov    %eax,%edi
80106c0e:	eb 0c                	jmp    80106c1c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106c10:	83 c0 01             	add    $0x1,%eax
80106c13:	c1 e0 16             	shl    $0x16,%eax
80106c16:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106c18:	39 da                	cmp    %ebx,%edx
80106c1a:	76 39                	jbe    80106c55 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
80106c1c:	89 d8                	mov    %ebx,%eax
80106c1e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106c21:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106c24:	f6 c1 01             	test   $0x1,%cl
80106c27:	74 e7                	je     80106c10 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106c29:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c2b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106c31:	c1 ee 0a             	shr    $0xa,%esi
80106c34:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106c3a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106c41:	85 f6                	test   %esi,%esi
80106c43:	74 cb                	je     80106c10 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106c45:	8b 06                	mov    (%esi),%eax
80106c47:	a8 01                	test   $0x1,%al
80106c49:	75 15                	jne    80106c60 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106c4b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c51:	39 da                	cmp    %ebx,%edx
80106c53:	77 c7                	ja     80106c1c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106c55:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106d35:	e8 a6 dc ff ff       	call   801049e0 <memset>
...
80106d7d:	68 b8 7e 10 80       	push   $0x80107eb8
...
80106d93:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106d96:	e8 c5 cb ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106e20:	a1 04 46 11 80       	mov    0x80114604,%eax
...
80106e54:	0f 84 c2 00 00 00    	je     80106f1c <switchuvm+0xec>
  pushcli();
80106e5a:	e8 71 d9 ff ff       	call   801047d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106e5f:	e8 9c ca ff ff       	call   80103900 <mycpu>
80106e64:	89 c3                	mov    %eax,%ebx
80106e66:	e8 95 ca ff ff       	call   80103900 <mycpu>
80106e6b:	89 c7                	mov    %eax,%edi
80106e6d:	e8 8e ca ff ff       	call   80103900 <mycpu>
80106e72:	83 c7 08             	add    $0x8,%edi
80106e75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e78:	e8 83 ca ff ff       	call   80103900 <mycpu>
...
80106ec1:	e8 3a ca ff ff       	call   80103900 <mycpu>
...
80106ee4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ee7:	e8 14 ca ff ff       	call   80103900 <mycpu>
...
80106f5b:	77 4b                	ja     80106fa8 <inituvm+0x68>
  mem = kalloc();
80106f5d:	e8 1e b7 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106f6f:	e8 6c da ff ff       	call   801049e0 <memset>
...
80106fa2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106fa3:	e9 d8 da ff ff       	jmp    80104a80 <memmove>
    panic("inituvm: more than a page");
80106fa8:	83 ec 0c             	sub    $0xc,%esp
80106fab:	68 fd 7e 10 80       	push   $0x80107efd
...
80107010:	68 17 7f 10 80       	push   $0x80107f17
...
8010705e:	e8 2d aa ff ff       	call   80101a90 <readi>
...
80107098:	68 b8 7f 10 80       	push   $0x80107fb8
...
80107129:	76 48                	jbe    80107173 <allocuvm+0xc3>
    mem = kalloc();
8010712b:	e8 50 b5 ff ff       	call   80102680 <kalloc>
...
80107139:	68 35 7f 10 80       	push   $0x80107f35
8010713e:	e8 5d 95 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
8010719b:	68 4d 7f 10 80       	push   $0x80107f4d
801071a0:	e8 fb 94 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
801071c0:	e8 fb b2 ff ff       	call   801024c0 <kfree>
      return 0;
...
8010725e:	e8 5d b2 ff ff       	call   801024c0 <kfree>
...
80107273:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107274:	e9 47 b2 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107279:	83 ec 0c             	sub    $0xc,%esp
8010727c:	68 69 7f 10 80       	push   $0x80107f69
...
80107295:	e8 e6 b3 ff ff       	call   80102680 <kalloc>
...
8010731b:	a3 04 46 11 80       	mov    %eax,0x80114604
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010734c:	68 7a 7f 10 80       	push   $0x80107f7a
...
801073c2:	68 84 7f 10 80       	push   $0x80107f84
...
801073ff:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107405:	e8 76 b2 ff ff       	call   80102680 <kalloc>
...
80107420:	e8 5b d6 ff ff       	call   80104a80 <memmove>
...
8010746c:	e8 4f b0 ff ff       	call   801024c0 <kfree>
      goto bad;
...
80107497:	68 9e 7f 10 80       	push   $0x80107f9e
...
8010754b:	01 c1                	add    %eax,%ecx
8010754d:	53                   	push   %ebx
8010754e:	52                   	push   %edx
8010754f:	51                   	push   %ecx
80107550:	e8 2b d5 ff ff       	call   80104a80 <memmove>
    len -= n;
    buf += n;
