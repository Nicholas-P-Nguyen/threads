...
main(int argc, char* argv[])
{
   ...
   e:	51                   	push   %ecx
    ...
    int tid = fork();
   f:	e8 c1 03 00 00       	call   3d5 <fork>
  ...
  30:	6a 05                	push   $0x5
  32:	e8 36 04 00 00       	call   46d <sleep>
  ...
  46:	6a 1c                	push   $0x1c
  48:	68 78 08 00 00       	push   $0x878
  4d:	68 81 08 00 00       	push   $0x881
  52:	68 8b 08 00 00       	push   $0x88b
  57:	6a 01                	push   $0x1
  59:	e8 f2 04 00 00       	call   550 <printf>
  5e:	83 c4 18             	add    $0x18,%esp
  61:	68 ac 08 00 00       	push   $0x8ac
  66:	6a 01                	push   $0x1
  68:	e8 e3 04 00 00       	call   550 <printf>
  6d:	5b                   	pop    %ebx
  6e:	58                   	pop    %eax
  6f:	68 95 08 00 00       	push   $0x895
  74:	6a 01                	push   $0x1
  76:	e8 d5 04 00 00       	call   550 <printf>
  7b:	e8 5d 03 00 00       	call   3dd <exit>
  ...
  88:	83 05 00 10 00 00 01 	addl   $0x1,0x1000
        sleep(10);
  8f:	6a 0a                	push   $0xa
  91:	e8 d7 03 00 00       	call   46d <sleep>
      for(int i = 0; i < 5; i++) {
  96:	83 c4 10             	add    $0x10,%esp
  99:	83 eb 01             	sub    $0x1,%ebx
  9c:	75 e7                	jne    85 <main+0x85>
      exit();
  9e:	e8 3a 03 00 00       	call   3dd <exit>
                        printf(1, "\n");
...
static void test_passed() {
  ...
  a3:	50                   	push   %eax
  a4:	68 81 08 00 00       	push   $0x881
  a9:	68 97 08 00 00       	push   $0x897
  ae:	6a 01                	push   $0x1
  b0:	e8 9b 04 00 00       	call   550 <printf>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	68 9c 08 00 00       	push   $0x89c
  bd:	68 a8 08 00 00       	push   $0x8a8
  c2:	6a 01                	push   $0x1
  c4:	e8 87 04 00 00       	call   550 <printf>
  c9:	5a                   	pop    %edx
  ca:	59                   	pop    %ecx
  cb:	68 95 08 00 00       	push   $0x895
  d0:	6a 01                	push   $0x1
  d2:	e8 79 04 00 00       	call   550 <printf>
    ...
    wait();
  d7:	e8 09 03 00 00       	call   3e5 <wait>
    exit();
  dc:	e8 fc 02 00 00       	call   3dd <exit>
  e1:	66 90                	xchg   %ax,%ax
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 4d9:	0f b6 92 68 09 00 00 	movzbl 0x968(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c9:	ff 24 85 10 09 00 00 	jmp    *0x910(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba 08 09 00 00       	mov    $0x908,%edx
        while(*s != 0){
