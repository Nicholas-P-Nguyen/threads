...
main(int argc, char* argv[])
{
   ...
   e:	51                   	push   %ecx
    ...
    int tid = fork();
   f:	e8 42 03 00 00       	call   356 <fork>

    if (tid < 0) {
  14:	85 c0                	test   %eax,%eax
  16:	0f 88 82 00 00 00    	js     9e <main+0x9e>
      exit();
    } else if (tid == 0) {
  1c:	74 62                	je     80 <main+0x80>
  1e:	bb 14 00 00 00       	mov    $0x14,%ebx
  23:	eb 08                	jmp    2d <main+0x2d>
  25:	8d 76 00             	lea    0x0(%esi),%esi
      ...
      // parent
      for(int i = 0; i < 20; i++) {
  28:	83 eb 01             	sub    $0x1,%ebx
  2b:	74 76                	je     a3 <main+0xa3>
        sleep(5);
  2d:	83 ec 0c             	sub    $0xc,%esp
  30:	6a 05                	push   $0x5
  32:	e8 b7 03 00 00       	call   3ee <sleep>
        ASSERT(x == 0, "expected `x` not to change since in difference processes");
  37:	a1 00 10 00 00       	mov    0x1000,%eax
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	85 c0                	test   %eax,%eax
  41:	74 e5                	je     28 <main+0x28>
  43:	83 ec 0c             	sub    $0xc,%esp
  46:	6a 1c                	push   $0x1c
  48:	68 f8 07 00 00       	push   $0x7f8
  4d:	68 01 08 00 00       	push   $0x801
  52:	68 0b 08 00 00       	push   $0x80b
  57:	6a 01                	push   $0x1
  59:	e8 72 04 00 00       	call   4d0 <printf>
  5e:	83 c4 18             	add    $0x18,%esp
  61:	68 2c 08 00 00       	push   $0x82c
  66:	6a 01                	push   $0x1
  68:	e8 63 04 00 00       	call   4d0 <printf>
  6d:	5b                   	pop    %ebx
  6e:	58                   	pop    %eax
  6f:	68 15 08 00 00       	push   $0x815
  74:	6a 01                	push   $0x1
  76:	e8 55 04 00 00       	call   4d0 <printf>
  7b:	e8 de 02 00 00       	call   35e <exit>
  80:	bb 05 00 00 00       	mov    $0x5,%ebx
        sleep(10);
  85:	83 ec 0c             	sub    $0xc,%esp
        x++;
  88:	83 05 00 10 00 00 01 	addl   $0x1,0x1000
        sleep(10);
  8f:	6a 0a                	push   $0xa
  91:	e8 58 03 00 00       	call   3ee <sleep>
      for(int i = 0; i < 5; i++) {
  96:	83 c4 10             	add    $0x10,%esp
  99:	83 eb 01             	sub    $0x1,%ebx
  9c:	75 e7                	jne    85 <main+0x85>
      exit();
  9e:	e8 bb 02 00 00       	call   35e <exit>
                        printf(1, "\n");
...
static void test_passed() {
  ...
  a3:	50                   	push   %eax
  a4:	68 01 08 00 00       	push   $0x801
  a9:	68 17 08 00 00       	push   $0x817
  ae:	6a 01                	push   $0x1
  b0:	e8 1b 04 00 00       	call   4d0 <printf>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	68 1c 08 00 00       	push   $0x81c
  bd:	68 28 08 00 00       	push   $0x828
  c2:	6a 01                	push   $0x1
  c4:	e8 07 04 00 00       	call   4d0 <printf>
  c9:	5a                   	pop    %edx
  ca:	59                   	pop    %ecx
  cb:	68 15 08 00 00       	push   $0x815
  d0:	6a 01                	push   $0x1
  d2:	e8 f9 03 00 00       	call   4d0 <printf>
      }
      test_passed();
    }

    wait();
  d7:	e8 8a 02 00 00       	call   366 <wait>
    exit();
  dc:	e8 7d 02 00 00       	call   35e <exit>
  e1:	66 90                	xchg   %ax,%ax
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
 ...
 219:	31 db                	xor    %ebx,%ebx
{
 ...
 225:	57                   	push   %edi
 226:	6a 00                	push   $0x0
 228:	e8 49 01 00 00       	call   376 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 0c 01 00 00       	call   39e <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 0f 01 00 00       	call   3b6 <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 d5 00 00 00       	call   386 <close>
  return r;
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
 ...
 49e:	56                   	push   %esi
 49f:	57                   	push   %edi
 4a0:	e8 d9 fe ff ff       	call   37e <write>
  while(--i >= 0)
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 515:	57                   	push   %edi
 516:	56                   	push   %esi
 517:	e8 62 fe ff ff       	call   37e <write>
 ...
 549:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 56e:	e8 0b fe ff ff       	call   37e <write>
        putc(fd, c);
 ...
 57f:	57                   	push   %edi
 580:	56                   	push   %esi
 581:	e8 f8 fd ff ff       	call   37e <write>
        putc(fd, c);
 ...
 5eb:	57                   	push   %edi
 5ec:	56                   	push   %esi
 5ed:	e8 8c fd ff ff       	call   37e <write>
        while(*s != 0){
 ...
 62c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 62f:	e8 4a fd ff ff       	call   37e <write>
        ap++;
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 65 08 00 00       	mov    $0x865,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 00 60 00 00       	mov    0x6000,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 00 60 00 00    	mov    %edx,0x6000
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 00 60 00 00    	mov    %edx,0x6000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 00 60 00 00    	mov    0x6000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 00 60 00 00    	mov    0x6000,%edi
 ...
 763:	e8 7e fc ff ff       	call   3e6 <sbrk>
  if(p == (char*)-1)
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 00 60 00 00    	mov    0x6000,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 00 60 00 00    	mov    %edx,0x6000
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 00 60 00 00 04 	movl   $0x6004,0x6000
 7c7:	60 00 00 
    base.s.size = 0;
 7ca:	bf 04 60 00 00       	mov    $0x6004,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 04 60 00 00 04 	movl   $0x6004,0x6004
 7d6:	60 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 08 60 00 00 00 	movl   $0x0,0x6008
 7e2:	00 00 00 
    if(p->s.size >= nunits){
