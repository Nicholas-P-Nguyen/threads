...
main(int argc, char* argv[])
{
   ...
   e:	51                   	push   %ecx
    ...
    int tid = fork();
   f:	e8 a1 03 00 00       	call   3b5 <fork>
  ...
  30:	6a 05                	push   $0x5
  32:	e8 16 04 00 00       	call   44d <sleep>
  ...
  46:	6a 1c                	push   $0x1c
  48:	68 58 08 00 00       	push   $0x858
  4d:	68 61 08 00 00       	push   $0x861
  52:	68 6b 08 00 00       	push   $0x86b
  57:	6a 01                	push   $0x1
  59:	e8 d2 04 00 00       	call   530 <printf>
  5e:	83 c4 18             	add    $0x18,%esp
  61:	68 8c 08 00 00       	push   $0x88c
  66:	6a 01                	push   $0x1
  68:	e8 c3 04 00 00       	call   530 <printf>
  6d:	5b                   	pop    %ebx
  6e:	58                   	pop    %eax
  6f:	68 75 08 00 00       	push   $0x875
  74:	6a 01                	push   $0x1
  76:	e8 b5 04 00 00       	call   530 <printf>
  7b:	e8 3d 03 00 00       	call   3bd <exit>
  ...
  88:	83 05 00 10 00 00 01 	addl   $0x1,0x1000
        sleep(10);
  8f:	6a 0a                	push   $0xa
  91:	e8 b7 03 00 00       	call   44d <sleep>
      for(int i = 0; i < 5; i++) {
  96:	83 c4 10             	add    $0x10,%esp
  99:	83 eb 01             	sub    $0x1,%ebx
  9c:	75 e7                	jne    85 <main+0x85>
      exit();
  9e:	e8 1a 03 00 00       	call   3bd <exit>
                        printf(1, "\n");
...
static void test_passed() {
  ...
  a3:	50                   	push   %eax
  a4:	68 61 08 00 00       	push   $0x861
  a9:	68 77 08 00 00       	push   $0x877
  ae:	6a 01                	push   $0x1
  b0:	e8 7b 04 00 00       	call   530 <printf>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	68 7c 08 00 00       	push   $0x87c
  bd:	68 88 08 00 00       	push   $0x888
  c2:	6a 01                	push   $0x1
  c4:	e8 67 04 00 00       	call   530 <printf>
  c9:	5a                   	pop    %edx
  ca:	59                   	pop    %ecx
  cb:	68 75 08 00 00       	push   $0x875
  d0:	6a 01                	push   $0x1
  d2:	e8 59 04 00 00       	call   530 <printf>
      }
      test_passed();
    }

    wait();
  d7:	e8 e9 02 00 00       	call   3c5 <wait>
    exit();
  dc:	e8 dc 02 00 00       	call   3bd <exit>
  e1:	66 90                	xchg   %ax,%ax
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 24 09 00 00 	movzbl 0x924(%edx),%edx
 ...
 539:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a9:	ff 24 85 cc 08 00 00 	jmp    *0x8cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6b7:	90                   	nop
          s = "(null)";
 6b8:	ba c5 08 00 00       	mov    $0x8c5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d1:	a1 00 60 00 00       	mov    0x6000,%eax
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	89 15 00 60 00 00    	mov    %edx,0x6000
}
 718:	5e                   	pop    %esi
 719:	5f                   	pop    %edi
 71a:	5d                   	pop    %ebp
 ...
 749:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74c:	89 15 00 60 00 00    	mov    %edx,0x6000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d 00 60 00 00    	mov    0x6000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 4f                	jae    800 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	8b 3d 00 60 00 00    	mov    0x6000,%edi
 ...
 7da:	e8 f1 fe ff ff       	call   6d0 <free>
  return freep;
 7df:	8b 15 00 60 00 00    	mov    0x6000,%edx
 ...
 80c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 80f:	89 15 00 60 00 00    	mov    %edx,0x6000
}
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 00 60 00 00 04 	movl   $0x6004,0x6000
 827:	60 00 00 
    base.s.size = 0;
 82a:	bf 04 60 00 00       	mov    $0x6004,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 04 60 00 00 04 	movl   $0x6004,0x6004
 836:	60 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 08 60 00 00 00 	movl   $0x0,0x6008
 842:	00 00 00 
    if(p->s.size >= nunits){
