   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 7b 04 00 00       	call   4a0 <printf>
    exit();
  25:	e8 03 03 00 00       	call   32d <exit>
  }
  ...
  32:	e8 56 03 00 00       	call   38d <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 ea 02 00 00       	call   32d <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 f8 07 00 00 	jmp    *0x7f8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba ef 07 00 00       	mov    $0x7ef,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 38 0b 00 00    	mov    %edx,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 3c 0b 00 00       	mov    $0xb3c,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 7b2:	00 00 00 
    if(p->s.size >= nunits){
