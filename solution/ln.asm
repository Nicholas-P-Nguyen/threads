   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 9b 04 00 00       	call   4c0 <printf>
    exit();
  25:	e8 23 03 00 00       	call   34d <exit>
  }
  ...
  32:	e8 76 03 00 00       	call   3ad <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 0a 03 00 00       	call   34d <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  43:	ff 73 08             	pushl  0x8(%ebx)
  46:	ff 73 04             	pushl  0x4(%ebx)
  49:	68 fb 07 00 00       	push   $0x7fb
  4e:	6a 02                	push   $0x2
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 30 08 00 00       	mov    $0x830,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 78 0b 00 00       	mov    0xb78,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 78 0b 00 00    	mov    %edx,0xb78
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 78 0b 00 00    	mov    %edx,0xb78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 78 0b 00 00    	mov    0xb78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 78 0b 00 00    	mov    0xb78,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 78 0b 00 00    	mov    0xb78,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 78 0b 00 00    	mov    %edx,0xb78
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 78 0b 00 00 7c 	movl   $0xb7c,0xb78
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 7c 0b 00 00       	mov    $0xb7c,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 7c 0b 00 00 7c 	movl   $0xb7c,0xb7c
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 80 0b 00 00 00 	movl   $0x0,0xb80
 7d2:	00 00 00 
    if(p->s.size >= nunits){
