   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 1b 04 00 00       	call   440 <printf>
    exit();
  25:	e8 a4 02 00 00       	call   2ce <exit>
  }
  ...
  32:	e8 f7 02 00 00       	call   32e <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 8b 02 00 00       	call   2ce <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 49 01 00 00       	call   2e6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 211:	50                   	push   %eax
 212:	e8 0f 01 00 00       	call   326 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 d5 00 00 00       	call   2f6 <close>
  return r;
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 40e:	56                   	push   %esi
 40f:	57                   	push   %edi
 410:	e8 d9 fe ff ff       	call   2ee <write>
  while(--i >= 0)
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 485:	57                   	push   %edi
 486:	56                   	push   %esi
 487:	e8 62 fe ff ff       	call   2ee <write>
 ...
 4de:	e8 0b fe ff ff       	call   2ee <write>
        putc(fd, c);
 ...
 4ef:	57                   	push   %edi
 4f0:	56                   	push   %esi
 4f1:	e8 f8 fd ff ff       	call   2ee <write>
        putc(fd, c);
 ...
 55b:	57                   	push   %edi
 55c:	56                   	push   %esi
 55d:	e8 8c fd ff ff       	call   2ee <write>
        while(*s != 0){
 ...
 59c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 59f:	e8 4a fd ff ff       	call   2ee <write>
        ap++;
...
free(void *ap)
{
 ...
 5e1:	a1 c4 0a 00 00       	mov    0xac4,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 c4 0a 00 00    	mov    %edx,0xac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 6d3:	e8 7e fc ff ff       	call   356 <sbrk>
  if(p == (char*)-1)
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 c4 0a 00 00 c8 	movl   $0xac8,0xac4
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf c8 0a 00 00       	mov    $0xac8,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 752:	00 00 00 
    if(p->s.size >= nunits){
