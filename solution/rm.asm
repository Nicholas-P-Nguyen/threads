...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 63 03 00 00       	call   39d <unlink>
  ...
  exit();
  4b:	e8 fd 02 00 00       	call   34d <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 4e 04 00 00       	call   4c0 <printf>
    exit();
  72:	e8 d6 02 00 00       	call   34d <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 a8 01 00 00       	call   365 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 6b 01 00 00       	call   38d <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 6e 01 00 00       	call   3a5 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 34 01 00 00       	call   375 <close>
  return r;
...
thread_create(void (*fn)(void *), void *arg)
{
 ...
 2dc:	e8 0f 04 00 00       	call   6f0 <malloc>
  if(stack == 0)
 2e1:	83 c4 10             	add    $0x10,%esp
 2e4:	85 c0                	test   %eax,%eax
 2e6:	74 3b                	je     323 <thread_create+0x53>
 ...
 2ef:	75 1f                	jne    310 <thread_create+0x40>
    free(stack);
    return -1;
  }
 ...
 2f4:	50                   	push   %eax
 2f5:	e8 f3 00 00 00       	call   3ed <clone>
  if(tid < 0){
 2fa:	83 c4 10             	add    $0x10,%esp
 2fd:	85 c0                	test   %eax,%eax
 2ff:	78 0f                	js     310 <thread_create+0x40>
    free(stack);
    return -1;
  }
  
  if(tid == 0){
 301:	74 27                	je     32a <thread_create+0x5a>
    exit();
  }
 ...
 313:	53                   	push   %ebx
 314:	e8 47 03 00 00       	call   660 <free>
    return -1;
 319:	83 c4 10             	add    $0x10,%esp
 31c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 321:	eb e0                	jmp    303 <thread_create+0x33>
    return -1;
 323:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 328:	eb d9                	jmp    303 <thread_create+0x33>
    fn(arg);
 32a:	83 ec 0c             	sub    $0xc,%esp
 32d:	ff 75 0c             	pushl  0xc(%ebp)
 330:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 333:	89 1c 24             	mov    %ebx,(%esp)
 336:	e8 25 03 00 00       	call   660 <free>
    exit();
 33b:	e8 0d 00 00 00       	call   34d <exit>
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 1c 08 00 00 	jmp    *0x81c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 15 08 00 00       	mov    $0x815,%edx
        while(*s != 0){
