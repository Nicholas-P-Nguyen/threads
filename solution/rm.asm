...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 04 03 00 00       	call   33e <unlink>
  ...
  exit();
  4b:	e8 9e 02 00 00       	call   2ee <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 ee 03 00 00       	call   460 <printf>
    exit();
  72:	e8 77 02 00 00       	call   2ee <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 49 01 00 00       	call   306 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 0c 01 00 00       	call   32e <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 0f 01 00 00       	call   346 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 d5 00 00 00       	call   316 <close>
  return r;
...
000003a6 <join>:
SYSCALL(join)
 3a6:	b8 19 00 00 00       	mov    $0x19,%eax
 3ab:	cd 40                	int    $0x40
 3ad:	c3                   	ret    
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 42e:	56                   	push   %esi
 42f:	57                   	push   %edi
 430:	e8 d9 fe ff ff       	call   30e <write>
  while(--i >= 0)
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 62 fe ff ff       	call   30e <write>
 ...
 4fe:	e8 0b fe ff ff       	call   30e <write>
        putc(fd, c);
 ...
 50f:	57                   	push   %edi
 510:	56                   	push   %esi
 511:	e8 f8 fd ff ff       	call   30e <write>
        putc(fd, c);
 ...
 57b:	57                   	push   %edi
 57c:	56                   	push   %esi
 57d:	e8 8c fd ff ff       	call   30e <write>
        while(*s != 0){
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 4a fd ff ff       	call   30e <write>
        ap++;
...
free(void *ap)
{
 ...
 601:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
 ...
 6f3:	e8 7e fc ff ff       	call   376 <sbrk>
  if(p == (char*)-1)
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf f8 0a 00 00       	mov    $0xaf8,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 772:	00 00 00 
    if(p->s.size >= nunits){
