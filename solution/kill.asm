...
main(int argc, char **argv)
{
  ...
  39:	e8 3f 03 00 00       	call   37d <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 03 03 00 00       	call   34d <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 e8 07 00 00       	push   $0x7e8
  51:	6a 02                	push   $0x2
  53:	e8 68 04 00 00       	call   4c0 <printf>
    exit();
  58:	e8 f0 02 00 00       	call   34d <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 c8 01 00 00       	call   365 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 8b 01 00 00       	call   38d <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 8e 01 00 00       	call   3a5 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 54 01 00 00       	call   375 <close>
  return r;
...
thread_create(void (*fn)(void *), void *arg)
{
 ...
 2bc:	e8 2f 04 00 00       	call   6f0 <malloc>
  if(mem == 0)
 2c1:	83 c4 10             	add    $0x10,%esp
 2c4:	85 c0                	test   %eax,%eax
 2c6:	74 32                	je     2fa <thread_create+0x4a>
 ...
 2cf:	74 12                	je     2e3 <thread_create+0x33>
 2d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    p++;
 2d8:	83 c3 01             	add    $0x1,%ebx
  while ((uint)p % 4096 != 0) {
 2db:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 2e1:	75 f5                	jne    2d8 <thread_create+0x28>
    printf(1, "LOLOLOL %p\n", fn);
    free(stack);
    return -1;
  }
 ...
 2e6:	53                   	push   %ebx
 2e7:	e8 01 01 00 00       	call   3ed <clone>
  if(tid < 0){
 2ec:	83 c4 10             	add    $0x10,%esp
 2ef:	85 c0                	test   %eax,%eax
 2f1:	78 0e                	js     301 <thread_create+0x51>
    free(stack);
    return -1;
  }
  ...
  if(tid == 0){
 2f3:	74 1f                	je     314 <thread_create+0x64>
    exit();
  }
 ...
 2ff:	eb f4                	jmp    2f5 <thread_create+0x45>
    free(stack);
 301:	83 ec 0c             	sub    $0xc,%esp
 304:	53                   	push   %ebx
 305:	e8 56 03 00 00       	call   660 <free>
    return -1;
 30a:	83 c4 10             	add    $0x10,%esp
 30d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 312:	eb e1                	jmp    2f5 <thread_create+0x45>
    printf(1, "Entering thread function at %p\n", fn);
 314:	50                   	push   %eax
 315:	ff 75 08             	pushl  0x8(%ebp)
 318:	68 fc 07 00 00       	push   $0x7fc
 31d:	6a 01                	push   $0x1
 31f:	e8 9c 01 00 00       	call   4c0 <printf>
    fn(arg);
 324:	5a                   	pop    %edx
 325:	ff 75 0c             	pushl  0xc(%ebp)
 328:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 32b:	89 1c 24             	mov    %ebx,(%esp)
 32e:	e8 2d 03 00 00       	call   660 <free>
    exit();
 333:	e8 15 00 00 00       	call   34d <exit>
...
{
  return join();
 340:	e9 c0 00 00 00       	jmp    405 <join>
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 7c 08 00 00 	movzbl 0x87c(%edx),%edx
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 d8 fe ff ff       	call   36d <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 61 fe ff ff       	call   36d <write>
 ...
 539:	ff 24 85 24 08 00 00 	jmp    *0x824(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 55e:	e8 0a fe ff ff       	call   36d <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 f7 fd ff ff       	call   36d <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 8b fd ff ff       	call   36d <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 49 fd ff ff       	call   36d <write>
        ap++;
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 1c 08 00 00       	mov    $0x81c,%edx
        while(*s != 0){
 ...
 661:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 70 0b 00 00    	mov    %edx,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 753:	e8 7d fc ff ff       	call   3d5 <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 7d2:	00 00 00 
    if(p->s.size >= nunits){
