...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 f2 03 00 00       	call   42e <open>
  ...
  59:	e8 b8 03 00 00       	call   416 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 83 03 00 00       	call   3ee <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	pushl  (%ebx)
  ...
  75:	e8 e6 04 00 00       	call   560 <printf>
      exit();
  7a:	e8 6f 03 00 00       	call   3ee <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 5c 03 00 00       	call   3ee <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 31 03 00 00       	call   406 <read>
 ...
 16f:	e8 ec 03 00 00       	call   560 <printf>
    exit();
 174:	e8 75 02 00 00       	call   3ee <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 49 01 00 00       	call   406 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 0c 01 00 00       	call   42e <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 0f 01 00 00       	call   446 <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 d5 00 00 00       	call   416 <close>
  return r;
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 52e:	56                   	push   %esi
 52f:	57                   	push   %edi
 530:	e8 d9 fe ff ff       	call   40e <write>
  while(--i >= 0)
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a5:	57                   	push   %edi
 5a6:	56                   	push   %esi
 5a7:	e8 62 fe ff ff       	call   40e <write>
 ...
 5fe:	e8 0b fe ff ff       	call   40e <write>
        putc(fd, c);
 ...
 60f:	57                   	push   %edi
 610:	56                   	push   %esi
 611:	e8 f8 fd ff ff       	call   40e <write>
        putc(fd, c);
 ...
 67b:	57                   	push   %edi
 67c:	56                   	push   %esi
 67d:	e8 8c fd ff ff       	call   40e <write>
        while(*s != 0){
 ...
 6bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6bf:	e8 4a fd ff ff       	call   40e <write>
        ap++;
...
free(void *ap)
{
 ...
 701:	a1 40 0e 00 00       	mov    0xe40,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 40 0e 00 00    	mov    %edx,0xe40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 40 0e 00 00    	mov    0xe40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 40 0e 00 00    	mov    0xe40,%edi
 ...
 7f3:	e8 7e fc ff ff       	call   476 <sbrk>
  if(p == (char*)-1)
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 40 0e 00 00    	mov    0xe40,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 40 0e 00 00 44 	movl   $0xe44,0xe40
 857:	0e 00 00 
    base.s.size = 0;
 85a:	bf 44 0e 00 00       	mov    $0xe44,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 44 0e 00 00 44 	movl   $0xe44,0xe44
 866:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 872:	00 00 00 
    if(p->s.size >= nunits){
