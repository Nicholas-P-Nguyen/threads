...
main(void)
{
  ...
  19:	e8 80 03 00 00       	call   39e <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 a3 03 00 00       	call   3d6 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 97 03 00 00       	call   3d6 <dup>
  ...
  52:	e8 79 04 00 00       	call   4d0 <printf>
    pid = fork();
  57:	e8 fa 02 00 00       	call   356 <fork>
    if(pid < 0){
  ...
  70:	e8 f1 02 00 00       	call   366 <wait>
  ...
  9a:	e8 31 04 00 00       	call   4d0 <printf>
      exit();
  9f:	e8 ba 02 00 00       	call   35e <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 7c 0b 00 00       	push   $0xb7c
  ab:	68 26 08 00 00       	push   $0x826
  b0:	e8 e1 02 00 00       	call   396 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 0d 04 00 00       	call   4d0 <printf>
      exit();
  c3:	e8 96 02 00 00       	call   35e <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 f8 07 00 00       	push   $0x7f8
  d2:	e8 cf 02 00 00       	call   3a6 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 f8 07 00 00       	push   $0x7f8
  e0:	e8 b9 02 00 00       	call   39e <open>
...
free(void *ap)
{
 ...
 671:	a1 84 0b 00 00       	mov    0xb84,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 84 0b 00 00    	mov    %edx,0xb84
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 84 0b 00 00    	mov    %edx,0xb84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 84 0b 00 00    	mov    0xb84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 84 0b 00 00    	mov    0xb84,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 84 0b 00 00    	mov    0xb84,%edx
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 88 0b 00 00       	mov    $0xb88,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 8c 0b 00 00 00 	movl   $0x0,0xb8c
 7e2:	00 00 00 
    if(p->s.size >= nunits){
