...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 82 39 00 00       	call   39ad <open>
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      32:	52                   	push   %edx
      33:	52                   	push   %edx
      34:	68 74 55 00 00       	push   $0x5574
      39:	6a 01                	push   $0x1
      3b:	e8 a0 3a 00 00       	call   3ae0 <printf>
    exit();
      40:	e8 28 39 00 00       	call   396d <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 57 39 00 00       	call   39ad <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 37 39 00 00       	call   3995 <close>
  ...
  exit();
     10d:	e8 5b 38 00 00       	call   396d <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 87 38 00 00       	call   39dd <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 4f 38 00 00       	call   39bd <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 5b 38 00 00       	call   39dd <chdir>
     182:	83 c4 10             	add    $0x10,%esp
     185:	85 c0                	test   %eax,%eax
     187:	78 2f                	js     1b8 <iputtest+0x98>
  printf(stdout, "iput test ok\n");
     189:	83 ec 08             	sub    $0x8,%esp
     18c:	68 d4 3e 00 00       	push   $0x3ed4
     191:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    printf(stdout, "mkdir failed\n");
     1a1:	50                   	push   %eax
     1a2:	50                   	push   %eax
     1a3:	68 08 3e 00 00       	push   $0x3e08
     1a8:	ff 35 54 5f 00 00    	pushl  0x5f54
     1ae:	e8 2d 39 00 00       	call   3ae0 <printf>
    exit();
     1b3:	e8 b5 37 00 00       	call   396d <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 53 3e 00 00       	push   $0x3e53
     1bf:	ff 35 54 5f 00 00    	pushl  0x5f54
     1c5:	e8 16 39 00 00       	call   3ae0 <printf>
    exit();
     1ca:	e8 9e 37 00 00       	call   396d <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 37 3e 00 00       	push   $0x3e37
     1d6:	ff 35 54 5f 00 00    	pushl  0x5f54
     1dc:	e8 ff 38 00 00       	call   3ae0 <printf>
    exit();
     1e1:	e8 87 37 00 00       	call   396d <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 16 3e 00 00       	push   $0x3e16
     1ed:	ff 35 54 5f 00 00    	pushl  0x5f54
     1f3:	e8 e8 38 00 00       	call   3ae0 <printf>
    exit();
     1f8:	e8 70 37 00 00       	call   396d <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 54 5f 00 00    	pushl  0x5f54
     211:	e8 ca 38 00 00       	call   3ae0 <printf>
  pid = fork();
     216:	e8 4a 37 00 00       	call   3965 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 a0 37 00 00       	call   39d5 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 90 37 00 00       	call   39dd <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 58 37 00 00       	call   39bd <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 fc 36 00 00       	call   396d <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 f8 36 00 00       	call   3975 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 86 3e 00 00       	push   $0x3e86
     285:	ff 35 54 5f 00 00    	pushl  0x5f54
     28b:	e8 50 38 00 00       	call   3ae0 <printf>
}
     ...
     2a0:	ff 35 54 5f 00 00    	pushl  0x5f54
     2a6:	e8 35 38 00 00       	call   3ae0 <printf>
      exit();
     2ab:	e8 bd 36 00 00       	call   396d <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 49 4d 00 00       	push   $0x4d49
     2b7:	ff 35 54 5f 00 00    	pushl  0x5f54
     2bd:	e8 1e 38 00 00       	call   3ae0 <printf>
    exit();
     2c2:	e8 a6 36 00 00       	call   396d <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 08 3e 00 00       	push   $0x3e08
     2ce:	ff 35 54 5f 00 00    	pushl  0x5f54
     2d4:	e8 07 38 00 00       	call   3ae0 <printf>
      exit();
     2d9:	e8 8f 36 00 00       	call   396d <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 72 3e 00 00       	push   $0x3e72
     2e5:	ff 35 54 5f 00 00    	pushl  0x5f54
     2eb:	e8 f0 37 00 00       	call   3ae0 <printf>
      exit();
     2f0:	e8 78 36 00 00       	call   396d <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 66 36 00 00       	call   39ad <open>
    if(fd >= 0){
     ...
     351:	68 2c 4e 00 00       	push   $0x4e2c
     356:	ff 35 54 5f 00 00    	pushl  0x5f54
     35c:	e8 7f 37 00 00       	call   3ae0 <printf>
      exit();
     361:	e8 07 36 00 00       	call   396d <exit>
     366:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     36d:	8d 76 00             	lea    0x0(%esi),%esi
  sleep(1);
     370:	83 ec 0c             	sub    $0xc,%esp
     373:	6a 01                	push   $0x1
     375:	e8 83 36 00 00       	call   39fd <sleep>
  if(unlink("oidir") != 0){
     37a:	c7 04 24 a7 3e 00 00 	movl   $0x3ea7,(%esp)
     381:	e8 37 36 00 00       	call   39bd <unlink>
     386:	83 c4 10             	add    $0x10,%esp
     389:	85 c0                	test   %eax,%eax
     38b:	75 56                	jne    3e3 <openiputtest+0xe3>
  wait();
     38d:	e8 e3 35 00 00       	call   3975 <wait>
  printf(stdout, "openiput test ok\n");
     392:	83 ec 08             	sub    $0x8,%esp
     395:	68 d0 3e 00 00       	push   $0x3ed0
     39a:	ff 35 54 5f 00 00    	pushl  0x5f54
     3a0:	e8 3b 37 00 00       	call   3ae0 <printf>
}
    ...
    exit();
     3b0:	e8 b8 35 00 00       	call   396d <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 49 4d 00 00       	push   $0x4d49
     3bc:	ff 35 54 5f 00 00    	pushl  0x5f54
     3c2:	e8 19 37 00 00       	call   3ae0 <printf>
    exit();
     3c7:	e8 a1 35 00 00       	call   396d <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 ad 3e 00 00       	push   $0x3ead
     3d3:	ff 35 54 5f 00 00    	pushl  0x5f54
     3d9:	e8 02 37 00 00       	call   3ae0 <printf>
    exit();
     3de:	e8 8a 35 00 00       	call   396d <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 c1 3e 00 00       	push   $0x3ec1
     3ea:	ff 35 54 5f 00 00    	pushl  0x5f54
     3f0:	e8 eb 36 00 00       	call   3ae0 <printf>
    exit();
     3f5:	e8 73 35 00 00       	call   396d <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 89 35 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 61 35 00 00       	call   3995 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 05 3f 00 00       	push   $0x3f05
     43d:	e8 6b 35 00 00       	call   39ad <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     44c:	68 30 3f 00 00       	push   $0x3f30
     451:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    printf(stdout, "open echo failed!\n");
     461:	50                   	push   %eax
     462:	50                   	push   %eax
     463:	68 f2 3e 00 00       	push   $0x3ef2
     468:	ff 35 54 5f 00 00    	pushl  0x5f54
     46e:	e8 6d 36 00 00       	call   3ae0 <printf>
    exit();
     473:	e8 f5 34 00 00       	call   396d <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 12 3f 00 00       	push   $0x3f12
     47f:	ff 35 54 5f 00 00    	pushl  0x5f54
     485:	e8 56 36 00 00       	call   3ae0 <printf>
    exit();
     48a:	e8 de 34 00 00       	call   396d <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 f4 34 00 00       	call   39ad <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4cb:	68 55 3f 00 00       	push   $0x3f55
     4d0:	ff 35 54 5f 00 00    	pushl  0x5f54
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 9d 34 00 00       	call   398d <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 81 34 00 00       	call   398d <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 54 5f 00 00    	pushl  0x5f54
     52e:	e8 ad 35 00 00       	call   3ae0 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 5a 34 00 00       	call   3995 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 4f 3f 00 00       	push   $0x3f4f
     544:	e8 64 34 00 00       	call   39ad <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     559:	68 ad 3f 00 00       	push   $0x3fad
     55e:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 09 34 00 00       	call   3985 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     58d:	68 e1 3f 00 00       	push   $0x3fe1
     592:	ff 35 54 5f 00 00    	pushl  0x5f54
     598:	e8 43 35 00 00       	call   3ae0 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 f0 33 00 00       	call   3995 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 4f 3f 00 00 	movl   $0x3f4f,(%esp)
     5ac:	e8 0c 34 00 00       	call   39bd <unlink>
     5b1:	83 c4 10             	add    $0x10,%esp
     5b4:	85 c0                	test   %eax,%eax
     5b6:	78 7d                	js     635 <writetest+0x1a5>
  printf(stdout, "small file test ok\n");
     5b8:	83 ec 08             	sub    $0x8,%esp
     5bb:	68 09 40 00 00       	push   $0x4009
     5c0:	ff 35 54 5f 00 00    	pushl  0x5f54
     ...
     5d8:	53                   	push   %ebx
     5d9:	68 50 4e 00 00       	push   $0x4e50
     5de:	ff 35 54 5f 00 00    	pushl  0x5f54
     5e4:	e8 f7 34 00 00       	call   3ae0 <printf>
      exit();
     5e9:	e8 7f 33 00 00       	call   396d <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5ee:	83 ec 04             	sub    $0x4,%esp
     5f1:	53                   	push   %ebx
     5f2:	68 74 4e 00 00       	push   $0x4e74
     5f7:	ff 35 54 5f 00 00    	pushl  0x5f54
     5fd:	e8 de 34 00 00       	call   3ae0 <printf>
      exit();
     602:	e8 66 33 00 00       	call   396d <exit>
    printf(stdout, "error: open small failed!\n");
     607:	51                   	push   %ecx
     608:	51                   	push   %ecx
     609:	68 c6 3f 00 00       	push   $0x3fc6
     60e:	ff 35 54 5f 00 00    	pushl  0x5f54
     614:	e8 c7 34 00 00       	call   3ae0 <printf>
    exit();
     619:	e8 4f 33 00 00       	call   396d <exit>
    printf(stdout, "read failed\n");
     61e:	52                   	push   %edx
     61f:	52                   	push   %edx
     620:	68 0d 43 00 00       	push   $0x430d
     625:	ff 35 54 5f 00 00    	pushl  0x5f54
     62b:	e8 b0 34 00 00       	call   3ae0 <printf>
    exit();
     630:	e8 38 33 00 00       	call   396d <exit>
    printf(stdout, "unlink small failed\n");
     635:	50                   	push   %eax
     636:	50                   	push   %eax
     637:	68 f4 3f 00 00       	push   $0x3ff4
     63c:	ff 35 54 5f 00 00    	pushl  0x5f54
     642:	e8 99 34 00 00       	call   3ae0 <printf>
    exit();
     647:	e8 21 33 00 00       	call   396d <exit>
    printf(stdout, "error: creat small failed!\n");
     64c:	50                   	push   %eax
     64d:	50                   	push   %eax
     64e:	68 70 3f 00 00       	push   $0x3f70
     653:	ff 35 54 5f 00 00    	pushl  0x5f54
     659:	e8 82 34 00 00       	call   3ae0 <printf>
    exit();
     65e:	e8 0a 33 00 00       	call   396d <exit>
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     678:	68 1d 40 00 00       	push   $0x401d
     67d:	ff 35 54 5f 00 00    	pushl  0x5f54
     683:	e8 58 34 00 00       	call   3ae0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     688:	58                   	pop    %eax
     689:	5a                   	pop    %edx
     68a:	68 02 02 00 00       	push   $0x202
     68f:	68 97 40 00 00       	push   $0x4097
     694:	e8 14 33 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 c4 32 00 00       	call   398d <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 aa 32 00 00       	call   3995 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 97 40 00 00       	push   $0x4097
     6f4:	e8 b4 32 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 4b 32 00 00       	call   3985 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 3f 32 00 00       	call   3995 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 97 40 00 00 	movl   $0x4097,(%esp)
     75d:	e8 5b 32 00 00       	call   39bd <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     770:	68 be 40 00 00       	push   $0x40be
     775:	ff 35 54 5f 00 00    	pushl  0x5f54
     ...
     78d:	53                   	push   %ebx
     78e:	68 47 40 00 00       	push   $0x4047
     793:	ff 35 54 5f 00 00    	pushl  0x5f54
     799:	e8 42 33 00 00       	call   3ae0 <printf>
      exit();
     79e:	e8 ca 31 00 00       	call   396d <exit>
      printf(stdout, "read content of block %d is %d\n",
     7a3:	50                   	push   %eax
     7a4:	56                   	push   %esi
     7a5:	68 98 4e 00 00       	push   $0x4e98
     7aa:	ff 35 54 5f 00 00    	pushl  0x5f54
     7b0:	e8 2b 33 00 00       	call   3ae0 <printf>
      exit();
     7b5:	e8 b3 31 00 00       	call   396d <exit>
      printf(stdout, "read failed %d\n", i);
     7ba:	83 ec 04             	sub    $0x4,%esp
     7bd:	50                   	push   %eax
     7be:	68 9b 40 00 00       	push   $0x409b
     7c3:	ff 35 54 5f 00 00    	pushl  0x5f54
     7c9:	e8 12 33 00 00       	call   3ae0 <printf>
      exit();
     7ce:	e8 9a 31 00 00       	call   396d <exit>
        printf(stdout, "read only %d blocks from big", n);
     7d3:	52                   	push   %edx
     7d4:	68 8b 00 00 00       	push   $0x8b
     7d9:	68 7e 40 00 00       	push   $0x407e
     7de:	ff 35 54 5f 00 00    	pushl  0x5f54
     7e4:	e8 f7 32 00 00       	call   3ae0 <printf>
        exit();
     7e9:	e8 7f 31 00 00       	call   396d <exit>
    printf(stdout, "error: open big failed!\n");
     7ee:	51                   	push   %ecx
     7ef:	51                   	push   %ecx
     7f0:	68 65 40 00 00       	push   $0x4065
     7f5:	ff 35 54 5f 00 00    	pushl  0x5f54
     7fb:	e8 e0 32 00 00       	call   3ae0 <printf>
    exit();
     800:	e8 68 31 00 00       	call   396d <exit>
    printf(stdout, "error: creat big failed!\n");
     805:	50                   	push   %eax
     806:	50                   	push   %eax
     807:	68 2d 40 00 00       	push   $0x402d
     80c:	ff 35 54 5f 00 00    	pushl  0x5f54
     812:	e8 c9 32 00 00       	call   3ae0 <printf>
    exit();
     817:	e8 51 31 00 00       	call   396d <exit>
    printf(stdout, "unlink big failed\n");
     81c:	50                   	push   %eax
     81d:	50                   	push   %eax
     81e:	68 ab 40 00 00       	push   $0x40ab
     823:	ff 35 54 5f 00 00    	pushl  0x5f54
     829:	e8 b2 32 00 00       	call   3ae0 <printf>
    exit();
     82e:	e8 3a 31 00 00       	call   396d <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     84c:	68 b8 4e 00 00       	push   $0x4eb8
     851:	ff 35 54 5f 00 00    	pushl  0x5f54
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 22 31 00 00       	call   39ad <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 02 31 00 00       	call   3995 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 f7 30 00 00       	call   39bd <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d1:	68 e0 4e 00 00       	push   $0x4ee0
     8d6:	ff 35 54 5f 00 00    	pushl  0x5f54
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    printf(stdout, "mkdir failed\n");
     971:	50                   	push   %eax
     972:	50                   	push   %eax
     973:	68 08 3e 00 00       	push   $0x3e08
     978:	ff 35 54 5f 00 00    	pushl  0x5f54
     97e:	e8 5d 31 00 00       	call   3ae0 <printf>
    exit();
     983:	e8 e5 2f 00 00       	call   396d <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 01 41 00 00       	push   $0x4101
     98f:	ff 35 54 5f 00 00    	pushl  0x5f54
     995:	e8 46 31 00 00       	call   3ae0 <printf>
    exit();
     99a:	e8 ce 2f 00 00       	call   396d <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 f0 40 00 00       	push   $0x40f0
     9a6:	ff 35 54 5f 00 00    	pushl  0x5f54
     9ac:	e8 2f 31 00 00       	call   3ae0 <printf>
    exit();
     9b1:	e8 b7 2f 00 00       	call   396d <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 dd 40 00 00       	push   $0x40dd
     9bd:	ff 35 54 5f 00 00    	pushl  0x5f54
     9c3:	e8 18 31 00 00       	call   3ae0 <printf>
    exit();
     9c8:	e8 a0 2f 00 00       	call   396d <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9d6:	68 24 41 00 00       	push   $0x4124
     9db:	ff 35 54 5f 00 00    	pushl  0x5f54
     9e1:	e8 fa 30 00 00       	call   3ae0 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 58 5f 00 00       	push   $0x5f58
     9ed:	68 ed 3e 00 00       	push   $0x3eed
     9f2:	e8 ae 2f 00 00       	call   39a5 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     a00:	50                   	push   %eax
     a01:	50                   	push   %eax
     a02:	68 2f 41 00 00       	push   $0x412f
     a07:	ff 35 54 5f 00 00    	pushl  0x5f54
     a0d:	e8 ce 30 00 00       	call   3ae0 <printf>
    exit();
     a12:	e8 56 2f 00 00       	call   396d <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 33 2f 00 00       	call   3995 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 08 2f 00 00       	call   3985 <read>
     ...
     ab8:	68 5e 41 00 00       	push   $0x415e
     abd:	6a 01                	push   $0x1
     abf:	e8 1c 30 00 00       	call   3ae0 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 b9 2e 00 00       	call   3995 <close>
     ...
     b11:	e8 77 2e 00 00       	call   398d <write>
    ...
    exit();
     b28:	e8 40 2e 00 00       	call   396d <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 54 2e 00 00       	call   3995 <close>
    wait();
     b41:	e8 2f 2e 00 00       	call   3975 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     b48:	68 83 41 00 00       	push   $0x4183
     b4d:	6a 01                	push   $0x1
     b4f:	e8 8c 2f 00 00       	call   3ae0 <printf>
     b54:	83 c4 10             	add    $0x10,%esp
     b57:	e9 6b ff ff ff       	jmp    ac7 <pipe1+0xa7>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b5c:	53                   	push   %ebx
     b5d:	ff 75 d4             	pushl  -0x2c(%ebp)
     b60:	68 6c 41 00 00       	push   $0x416c
     b65:	6a 01                	push   $0x1
     b67:	e8 74 2f 00 00       	call   3ae0 <printf>
      exit();
     b6c:	e8 fc 2d 00 00       	call   396d <exit>
    printf(1, "pipe() failed\n");
     b71:	57                   	push   %edi
     b72:	57                   	push   %edi
     b73:	68 41 41 00 00       	push   $0x4141
     b78:	6a 01                	push   $0x1
     b7a:	e8 61 2f 00 00       	call   3ae0 <printf>
    exit();
     b7f:	e8 e9 2d 00 00       	call   396d <exit>
    printf(1, "fork() failed\n");
     b84:	50                   	push   %eax
     b85:	50                   	push   %eax
     b86:	68 8d 41 00 00       	push   $0x418d
     b8b:	6a 01                	push   $0x1
     b8d:	e8 4e 2f 00 00       	call   3ae0 <printf>
    exit();
     b92:	e8 d6 2d 00 00       	call   396d <exit>
        printf(1, "pipe1 oops 1\n");
     b97:	56                   	push   %esi
     b98:	56                   	push   %esi
     b99:	68 50 41 00 00       	push   $0x4150
     b9e:	6a 01                	push   $0x1
     ba0:	e8 3b 2f 00 00       	call   3ae0 <printf>
        exit();
     ba5:	e8 c3 2d 00 00       	call   396d <exit>
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bb9:	68 9c 41 00 00       	push   $0x419c
     bbe:	6a 01                	push   $0x1
     bc0:	e8 1b 2f 00 00       	call   3ae0 <printf>
  pid1 = fork();
     bc5:	e8 9b 2d 00 00       	call   3965 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 86 2d 00 00       	call   3965 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 81 2d 00 00       	call   397d <pipe>
  pid3 = fork();
     bfc:	e8 64 2d 00 00       	call   3965 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c10:	e8 80 2d 00 00       	call   3995 <close>
    if(write(pfds[1], "x", 1) != 1)
     c15:	83 c4 0c             	add    $0xc,%esp
     c18:	6a 01                	push   $0x1
     c1a:	68 61 47 00 00       	push   $0x4761
     c1f:	ff 75 e4             	pushl  -0x1c(%ebp)
     c22:	e8 66 2d 00 00       	call   398d <write>
    ...
    close(pfds[1]);
     ...
     c39:	e8 57 2d 00 00       	call   3995 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 1a 2d 00 00       	call   3995 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
     c7d:	68 cd 41 00 00       	push   $0x41cd
     c82:	6a 01                	push   $0x1
     c84:	e8 57 2e 00 00       	call   3ae0 <printf>
  kill(pid1);
     c89:	89 1c 24             	mov    %ebx,(%esp)
     c8c:	e8 0c 2d 00 00       	call   399d <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 04 2d 00 00       	call   399d <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 fc 2c 00 00       	call   399d <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
     ca3:	68 d6 41 00 00       	push   $0x41d6
     ca8:	6a 01                	push   $0x1
     caa:	e8 31 2e 00 00       	call   3ae0 <printf>
  wait();
     caf:	e8 c1 2c 00 00       	call   3975 <wait>
  wait();
     cb4:	e8 bc 2c 00 00       	call   3975 <wait>
  wait();
     cb9:	e8 b7 2c 00 00       	call   3975 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
     cc0:	68 df 41 00 00       	push   $0x41df
     cc5:	6a 01                	push   $0x1
     cc7:	e8 14 2e 00 00       	call   3ae0 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cda:	68 ba 41 00 00       	push   $0x41ba
     cdf:	6a 01                	push   $0x1
     ce1:	e8 fa 2d 00 00       	call   3ae0 <printf>
     ce6:	83 c4 10             	add    $0x10,%esp
     ce9:	eb e4                	jmp    ccf <preempt+0x11f>
      printf(1, "preempt write error");
     ceb:	83 ec 08             	sub    $0x8,%esp
     cee:	68 a6 41 00 00       	push   $0x41a6
     cf3:	6a 01                	push   $0x1
     cf5:	e8 e6 2d 00 00       	call   3ae0 <printf>
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 4e 2c 00 00       	call   3975 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 30 2c 00 00       	call   3965 <fork>
    ...
    if(pid < 0){
     ...
     d3e:	68 49 4d 00 00       	push   $0x4d49
     d43:	6a 01                	push   $0x1
     ...
     d5b:	68 eb 41 00 00       	push   $0x41eb
     d60:	6a 01                	push   $0x1
     d62:	e8 79 2d 00 00       	call   3ae0 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d74:	68 fb 41 00 00       	push   $0x41fb
     d79:	6a 01                	push   $0x1
     d7b:	e8 60 2d 00 00       	call   3ae0 <printf>
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 de 2b 00 00       	call   396d <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     d9a:	68 08 42 00 00       	push   $0x4208
     d9f:	6a 01                	push   $0x1
     da1:	e8 3a 2d 00 00       	call   3ae0 <printf>
  ppid = getpid();
     da6:	e8 42 2c 00 00       	call   39ed <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 b3 2b 00 00       	call   3965 <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dcc:	e8 3f 2f 00 00       	call   3d10 <malloc>
    ...
    while(m1){
     ...
     de5:	8b 36                	mov    (%esi),%esi
      free(m1);
     de7:	50                   	push   %eax
     de8:	e8 93 2e 00 00       	call   3c80 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     dfc:	e8 0f 2f 00 00       	call   3d10 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     e0b:	50                   	push   %eax
     e0c:	e8 6f 2e 00 00       	call   3c80 <free>
    printf(1, "mem ok\n");
     e11:	58                   	pop    %eax
     e12:	5a                   	pop    %edx
     e13:	68 2c 42 00 00       	push   $0x422c
     e18:	6a 01                	push   $0x1
     e1a:	e8 c1 2c 00 00       	call   3ae0 <printf>
    exit();
     e1f:	e8 49 2b 00 00       	call   396d <exit>
     e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e28:	83 ec 08             	sub    $0x8,%esp
     e2b:	68 12 42 00 00       	push   $0x4212
     e30:	6a 01                	push   $0x1
     e32:	e8 a9 2c 00 00       	call   3ae0 <printf>
      kill(ppid);
     e37:	89 1c 24             	mov    %ebx,(%esp)
     e3a:	e8 5e 2b 00 00       	call   399d <kill>
      exit();
     e3f:	e8 29 2b 00 00       	call   396d <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 22 2b 00 00       	jmp    3975 <wait>
...
00000e60 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e69:	68 34 42 00 00       	push   $0x4234
     e6e:	6a 01                	push   $0x1
     e70:	e8 6b 2c 00 00       	call   3ae0 <printf>
  unlink("sharedfd");
     e75:	c7 04 24 43 42 00 00 	movl   $0x4243,(%esp)
     e7c:	e8 3c 2b 00 00       	call   39bd <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 43 42 00 00       	push   $0x4243
     e8d:	e8 1b 2b 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 b9 2a 00 00       	call   3965 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 6a 2a 00 00       	call   3975 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 7c 2a 00 00       	call   3995 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 43 42 00 00       	push   $0x4243
     f22:	e8 86 2a 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 34 2a 00 00       	call   3985 <read>
  ...
  close(fd);
     ...
     f86:	e8 0a 2a 00 00       	call   3995 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 43 42 00 00 	movl   $0x4243,(%esp)
     f92:	e8 26 2a 00 00       	call   39bd <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fb0:	68 4c 42 00 00       	push   $0x424c
     fb5:	6a 01                	push   $0x1
     fb7:	e8 24 2b 00 00       	call   3ae0 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fca:	68 08 4f 00 00       	push   $0x4f08
     fcf:	6a 01                	push   $0x1
     fd1:	e8 0a 2b 00 00       	call   3ae0 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe4:	68 54 4f 00 00       	push   $0x4f54
     fe9:	6a 01                	push   $0x1
     feb:	e8 f0 2a 00 00       	call   3ae0 <printf>
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 6d 29 00 00       	call   396d <exit>
    printf(1, "sharedfd oops %d %d\n", nc, np);
    1000:	53                   	push   %ebx
    1001:	52                   	push   %edx
    1002:	68 59 42 00 00       	push   $0x4259
    1007:	6a 01                	push   $0x1
    1009:	e8 d2 2a 00 00       	call   3ae0 <printf>
    exit();
    100e:	e8 5a 29 00 00       	call   396d <exit>
...
00001020 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1025:	be 6e 42 00 00       	mov    $0x426e,%esi
{
    102a:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1030:	c7 45 d8 6e 42 00 00 	movl   $0x426e,-0x28(%ebp)
  printf(1, "fourfiles test\n");
    1037:	68 74 42 00 00       	push   $0x4274
    103c:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    103e:	c7 45 dc b7 43 00 00 	movl   $0x43b7,-0x24(%ebp)
    1045:	c7 45 e0 bb 43 00 00 	movl   $0x43bb,-0x20(%ebp)
    104c:	c7 45 e4 71 42 00 00 	movl   $0x4271,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1053:	e8 88 2a 00 00       	call   3ae0 <printf>
    1058:	83 c4 10             	add    $0x10,%esp
    unlink(fname);
    105b:	83 ec 0c             	sub    $0xc,%esp
    105e:	56                   	push   %esi
    105f:	e8 59 29 00 00       	call   39bd <unlink>
    pid = fork();
    1064:	e8 fc 28 00 00       	call   3965 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 e8 28 00 00       	call   3975 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 e1 28 00 00       	call   3975 <wait>
    1094:	e8 dc 28 00 00       	call   3975 <wait>
    1099:	e8 d7 28 00 00       	call   3975 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 fb 28 00 00       	call   39ad <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 b0 28 00 00       	call   3985 <read>
    ...
    1104:	e8 8c 28 00 00       	call   3995 <close>
    if(total != 12*500){
    ...
    111e:	e8 9a 28 00 00       	call   39bd <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    112e:	68 b2 42 00 00       	push   $0x42b2
    1133:	6a 01                	push   $0x1
    1135:	e8 a6 29 00 00       	call   3ae0 <printf>
}
    ...
    1152:	68 95 42 00 00       	push   $0x4295
    1157:	6a 01                	push   $0x1
    1159:	e8 82 29 00 00       	call   3ae0 <printf>
          exit();
    115e:	e8 0a 28 00 00       	call   396d <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 3c 28 00 00       	call   39ad <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 e2 27 00 00       	call   398d <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 ae 27 00 00       	call   396d <exit>
        printf(1, "create failed\n");
    11bf:	51                   	push   %ecx
    11c0:	51                   	push   %ecx
    11c1:	68 0f 45 00 00       	push   $0x450f
    11c6:	6a 01                	push   $0x1
    11c8:	e8 13 29 00 00       	call   3ae0 <printf>
        exit();
    11cd:	e8 9b 27 00 00       	call   396d <exit>
    11d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      printf(1, "fork failed\n");
    11d8:	83 ec 08             	sub    $0x8,%esp
    11db:	68 49 4d 00 00       	push   $0x4d49
    11e0:	6a 01                	push   $0x1
    11e2:	e8 f9 28 00 00       	call   3ae0 <printf>
      exit();
    11e7:	e8 81 27 00 00       	call   396d <exit>
      printf(1, "wrong length %d\n", total);
    11ec:	50                   	push   %eax
    11ed:	53                   	push   %ebx
    11ee:	68 a1 42 00 00       	push   $0x42a1
    11f3:	6a 01                	push   $0x1
    11f5:	e8 e6 28 00 00       	call   3ae0 <printf>
      exit();
    11fa:	e8 6e 27 00 00       	call   396d <exit>
          printf(1, "write failed %d\n", n);
    11ff:	52                   	push   %edx
    1200:	50                   	push   %eax
    1201:	68 84 42 00 00       	push   $0x4284
    1206:	6a 01                	push   $0x1
    1208:	e8 d3 28 00 00       	call   3ae0 <printf>
          exit();
    120d:	e8 5b 27 00 00       	call   396d <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    122b:	68 c0 42 00 00       	push   $0x42c0
    1230:	6a 01                	push   $0x1
    1232:	e8 a9 28 00 00       	call   3ae0 <printf>
    1237:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    123a:	e8 26 27 00 00       	call   3965 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 1b 27 00 00       	call   3975 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 11 27 00 00       	call   3975 <wait>
    1264:	e8 0c 27 00 00       	call   3975 <wait>
    1269:	e8 07 27 00 00       	call   3975 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 ff 26 00 00       	call   39ad <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 c3 26 00 00       	call   3995 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 ad 26 00 00       	call   39bd <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1324:	68 d3 42 00 00       	push   $0x42d3
    1329:	6a 01                	push   $0x1
    132b:	e8 b0 27 00 00       	call   3ae0 <printf>
}
    ...
    1344:	50                   	push   %eax
    1345:	57                   	push   %edi
    1346:	68 a4 4f 00 00       	push   $0x4fa4
    134b:	6a 01                	push   $0x1
    134d:	e8 8e 27 00 00       	call   3ae0 <printf>
        exit();
    1352:	e8 16 26 00 00       	call   396d <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 0e 26 00 00       	call   39ad <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 e6 25 00 00       	call   3995 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 ef 25 00 00       	call   39bd <unlink>
    ...
    13d5:	52                   	push   %edx
    13d6:	52                   	push   %edx
    13d7:	68 c1 3e 00 00       	push   $0x3ec1
    13dc:	6a 01                	push   $0x1
    13de:	e8 fd 26 00 00       	call   3ae0 <printf>
            exit();
    13e3:	e8 85 25 00 00       	call   396d <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 78 25 00 00       	call   396d <exit>
        printf(1, "oops createdelete %s didn't exist\n", name);
    13f5:	83 ec 04             	sub    $0x4,%esp
    13f8:	57                   	push   %edi
    13f9:	68 80 4f 00 00       	push   $0x4f80
    13fe:	6a 01                	push   $0x1
    1400:	e8 db 26 00 00       	call   3ae0 <printf>
        exit();
    1405:	e8 63 25 00 00       	call   396d <exit>
      printf(1, "fork failed\n");
    140a:	83 ec 08             	sub    $0x8,%esp
    140d:	68 49 4d 00 00       	push   $0x4d49
    1412:	6a 01                	push   $0x1
    1414:	e8 c7 26 00 00       	call   3ae0 <printf>
      exit();
    1419:	e8 4f 25 00 00       	call   396d <exit>
          printf(1, "create failed\n");
    141e:	83 ec 08             	sub    $0x8,%esp
    1421:	68 0f 45 00 00       	push   $0x450f
    1426:	6a 01                	push   $0x1
    1428:	e8 b3 26 00 00       	call   3ae0 <printf>
          exit();
    142d:	e8 3b 25 00 00       	call   396d <exit>
...
00001440 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1448:	68 e4 42 00 00       	push   $0x42e4
    144d:	6a 01                	push   $0x1
    144f:	e8 8c 26 00 00       	call   3ae0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1454:	5b                   	pop    %ebx
    1455:	5e                   	pop    %esi
    1456:	68 02 02 00 00       	push   $0x202
    145b:	68 f5 42 00 00       	push   $0x42f5
    1460:	e8 48 25 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    1475:	6a 05                	push   $0x5
    1477:	68 1a 43 00 00       	push   $0x431a
    147c:	50                   	push   %eax
    147d:	e8 0b 25 00 00       	call   398d <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 0b 25 00 00       	call   3995 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 f5 42 00 00       	push   $0x42f5
    1493:	e8 15 25 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14a8:	68 f5 42 00 00       	push   $0x42f5
    14ad:	e8 0b 25 00 00       	call   39bd <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14c5:	68 f5 42 00 00       	push   $0x42f5
    14ca:	e8 de 24 00 00       	call   39ad <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    14d6:	68 52 43 00 00       	push   $0x4352
    14db:	50                   	push   %eax
    14dc:	e8 ac 24 00 00       	call   398d <write>
  close(fd1);
    14e1:	89 34 24             	mov    %esi,(%esp)
    14e4:	e8 ac 24 00 00       	call   3995 <close>
  if(read(fd, buf, sizeof(buf)) != 5){
    14e9:	83 c4 0c             	add    $0xc,%esp
    14ec:	68 00 20 00 00       	push   $0x2000
    14f1:	68 a0 86 00 00       	push   $0x86a0
    14f6:	53                   	push   %ebx
    14f7:	e8 89 24 00 00       	call   3985 <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 6c 24 00 00       	call   398d <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 63 24 00 00       	call   3995 <close>
  unlink("unlinkread");
    1532:	c7 04 24 f5 42 00 00 	movl   $0x42f5,(%esp)
    1539:	e8 7f 24 00 00       	call   39bd <unlink>
  printf(1, "unlinkread ok\n");
    153e:	58                   	pop    %eax
    153f:	5a                   	pop    %edx
    1540:	68 9d 43 00 00       	push   $0x439d
    1545:	6a 01                	push   $0x1
    1547:	e8 94 25 00 00       	call   3ae0 <printf>
}
    ...
    1556:	51                   	push   %ecx
    1557:	51                   	push   %ecx
    1558:	68 00 43 00 00       	push   $0x4300
    155d:	6a 01                	push   $0x1
    155f:	e8 7c 25 00 00       	call   3ae0 <printf>
    exit();
    1564:	e8 04 24 00 00       	call   396d <exit>
    printf(1, "unlinkread write failed\n");
    1569:	51                   	push   %ecx
    156a:	51                   	push   %ecx
    156b:	68 84 43 00 00       	push   $0x4384
    1570:	6a 01                	push   $0x1
    1572:	e8 69 25 00 00       	call   3ae0 <printf>
    exit();
    1577:	e8 f1 23 00 00       	call   396d <exit>
    printf(1, "unlinkread wrong data\n");
    157c:	53                   	push   %ebx
    157d:	53                   	push   %ebx
    157e:	68 6d 43 00 00       	push   $0x436d
    1583:	6a 01                	push   $0x1
    1585:	e8 56 25 00 00       	call   3ae0 <printf>
    exit();
    158a:	e8 de 23 00 00       	call   396d <exit>
    printf(1, "unlinkread read failed");
    158f:	56                   	push   %esi
    1590:	56                   	push   %esi
    1591:	68 56 43 00 00       	push   $0x4356
    1596:	6a 01                	push   $0x1
    1598:	e8 43 25 00 00       	call   3ae0 <printf>
    exit();
    159d:	e8 cb 23 00 00       	call   396d <exit>
    printf(1, "unlink unlinkread failed\n");
    15a2:	50                   	push   %eax
    15a3:	50                   	push   %eax
    15a4:	68 38 43 00 00       	push   $0x4338
    15a9:	6a 01                	push   $0x1
    15ab:	e8 30 25 00 00       	call   3ae0 <printf>
    exit();
    15b0:	e8 b8 23 00 00       	call   396d <exit>
    printf(1, "open unlinkread failed\n");
    15b5:	50                   	push   %eax
    15b6:	50                   	push   %eax
    15b7:	68 20 43 00 00       	push   $0x4320
    15bc:	6a 01                	push   $0x1
    15be:	e8 1d 25 00 00       	call   3ae0 <printf>
    exit();
    15c3:	e8 a5 23 00 00       	call   396d <exit>
...
000015d0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15d7:	68 ac 43 00 00       	push   $0x43ac
    15dc:	6a 01                	push   $0x1
    15de:	e8 fd 24 00 00       	call   3ae0 <printf>
  unlink("lf1");
    15e3:	c7 04 24 b6 43 00 00 	movl   $0x43b6,(%esp)
    15ea:	e8 ce 23 00 00       	call   39bd <unlink>
  unlink("lf2");
    15ef:	c7 04 24 ba 43 00 00 	movl   $0x43ba,(%esp)
    15f6:	e8 c2 23 00 00       	call   39bd <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15fb:	58                   	pop    %eax
    15fc:	5a                   	pop    %edx
    15fd:	68 02 02 00 00       	push   $0x202
    1602:	68 b6 43 00 00       	push   $0x43b6
    1607:	e8 a1 23 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    161c:	6a 05                	push   $0x5
    161e:	68 1a 43 00 00       	push   $0x431a
    1623:	50                   	push   %eax
    1624:	e8 64 23 00 00       	call   398d <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 57 23 00 00       	call   3995 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 ba 43 00 00       	push   $0x43ba
    1645:	68 b6 43 00 00       	push   $0x43b6
    164a:	e8 7e 23 00 00       	call   39cd <link>
    164f:	83 c4 10             	add    $0x10,%esp
    1652:	85 c0                	test   %eax,%eax
    1654:	0f 88 60 01 00 00    	js     17ba <linktest+0x1ea>
  unlink("lf1");
    165a:	83 ec 0c             	sub    $0xc,%esp
    165d:	68 b6 43 00 00       	push   $0x43b6
    1662:	e8 56 23 00 00       	call   39bd <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 b6 43 00 00       	push   $0x43b6
    1670:	e8 38 23 00 00       	call   39ad <open>
  ...
  fd = open("lf2", 0);
    ...
    1683:	6a 00                	push   $0x0
    1685:	68 ba 43 00 00       	push   $0x43ba
    168a:	e8 1e 23 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 d6 22 00 00       	call   3985 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 d1 22 00 00       	call   3995 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 ba 43 00 00       	push   $0x43ba
    16cb:	68 ba 43 00 00       	push   $0x43ba
    16d0:	e8 f8 22 00 00       	call   39cd <link>
    16d5:	83 c4 10             	add    $0x10,%esp
    16d8:	85 c0                	test   %eax,%eax
    16da:	0f 89 8e 00 00 00    	jns    176e <linktest+0x19e>
  unlink("lf2");
    16e0:	83 ec 0c             	sub    $0xc,%esp
    16e3:	68 ba 43 00 00       	push   $0x43ba
    16e8:	e8 d0 22 00 00       	call   39bd <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 b6 43 00 00       	push   $0x43b6
    16f4:	68 ba 43 00 00       	push   $0x43ba
    16f9:	e8 cf 22 00 00       	call   39cd <link>
    16fe:	83 c4 10             	add    $0x10,%esp
    1701:	85 c0                	test   %eax,%eax
    1703:	79 56                	jns    175b <linktest+0x18b>
  if(link(".", "lf1") >= 0){
    1705:	83 ec 08             	sub    $0x8,%esp
    1708:	68 b6 43 00 00       	push   $0x43b6
    170d:	68 7e 46 00 00       	push   $0x467e
    1712:	e8 b6 22 00 00       	call   39cd <link>
    1717:	83 c4 10             	add    $0x10,%esp
    171a:	85 c0                	test   %eax,%eax
    171c:	79 2a                	jns    1748 <linktest+0x178>
  printf(1, "linktest ok\n");
    171e:	83 ec 08             	sub    $0x8,%esp
    1721:	68 54 44 00 00       	push   $0x4454
    1726:	6a 01                	push   $0x1
    1728:	e8 b3 23 00 00       	call   3ae0 <printf>
}
    ...
    1735:	50                   	push   %eax
    1736:	50                   	push   %eax
    1737:	68 be 43 00 00       	push   $0x43be
    173c:	6a 01                	push   $0x1
    173e:	e8 9d 23 00 00       	call   3ae0 <printf>
    exit();
    1743:	e8 25 22 00 00       	call   396d <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1748:	50                   	push   %eax
    1749:	50                   	push   %eax
    174a:	68 38 44 00 00       	push   $0x4438
    174f:	6a 01                	push   $0x1
    1751:	e8 8a 23 00 00       	call   3ae0 <printf>
    exit();
    1756:	e8 12 22 00 00       	call   396d <exit>
    printf(1, "link non-existant succeeded! oops\n");
    175b:	52                   	push   %edx
    175c:	52                   	push   %edx
    175d:	68 ec 4f 00 00       	push   $0x4fec
    1762:	6a 01                	push   $0x1
    1764:	e8 77 23 00 00       	call   3ae0 <printf>
    exit();
    1769:	e8 ff 21 00 00       	call   396d <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    176e:	50                   	push   %eax
    176f:	50                   	push   %eax
    1770:	68 1a 44 00 00       	push   $0x441a
    1775:	6a 01                	push   $0x1
    1777:	e8 64 23 00 00       	call   3ae0 <printf>
    exit();
    177c:	e8 ec 21 00 00       	call   396d <exit>
    printf(1, "read lf2 failed\n");
    1781:	51                   	push   %ecx
    1782:	51                   	push   %ecx
    1783:	68 09 44 00 00       	push   $0x4409
    1788:	6a 01                	push   $0x1
    178a:	e8 51 23 00 00       	call   3ae0 <printf>
    exit();
    178f:	e8 d9 21 00 00       	call   396d <exit>
    printf(1, "open lf2 failed\n");
    1794:	53                   	push   %ebx
    1795:	53                   	push   %ebx
    1796:	68 f8 43 00 00       	push   $0x43f8
    179b:	6a 01                	push   $0x1
    179d:	e8 3e 23 00 00       	call   3ae0 <printf>
    exit();
    17a2:	e8 c6 21 00 00       	call   396d <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    17a7:	50                   	push   %eax
    17a8:	50                   	push   %eax
    17a9:	68 c4 4f 00 00       	push   $0x4fc4
    17ae:	6a 01                	push   $0x1
    17b0:	e8 2b 23 00 00       	call   3ae0 <printf>
    exit();
    17b5:	e8 b3 21 00 00       	call   396d <exit>
    printf(1, "link lf1 lf2 failed\n");
    17ba:	51                   	push   %ecx
    17bb:	51                   	push   %ecx
    17bc:	68 e3 43 00 00       	push   $0x43e3
    17c1:	6a 01                	push   $0x1
    17c3:	e8 18 23 00 00       	call   3ae0 <printf>
    exit();
    17c8:	e8 a0 21 00 00       	call   396d <exit>
    printf(1, "write lf1 failed\n");
    17cd:	50                   	push   %eax
    17ce:	50                   	push   %eax
    17cf:	68 d1 43 00 00       	push   $0x43d1
    17d4:	6a 01                	push   $0x1
    17d6:	e8 05 23 00 00       	call   3ae0 <printf>
    exit();
    17db:	e8 8d 21 00 00       	call   396d <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17ee:	68 61 44 00 00       	push   $0x4461
    17f3:	6a 01                	push   $0x1
    17f5:	e8 e6 22 00 00       	call   3ae0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 7e 21 00 00       	call   39ad <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 53 21 00 00       	call   3995 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 2b 21 00 00       	call   3975 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 5b 21 00 00       	call   39bd <unlink>
    pid = fork();
    1862:	e8 fe 20 00 00       	call   3965 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 23 21 00 00       	call   39ad <open>
      if(fd < 0){
    ...
    1898:	53                   	push   %ebx
    1899:	68 74 44 00 00       	push   $0x4474
    189e:	6a 01                	push   $0x1
    18a0:	e8 3b 22 00 00       	call   3ae0 <printf>
        exit();
    18a5:	e8 c3 20 00 00       	call   396d <exit>
    18aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("C0", file);
    18b0:	83 ec 08             	sub    $0x8,%esp
    18b3:	53                   	push   %ebx
    18b4:	68 71 44 00 00       	push   $0x4471
    18b9:	e8 0f 21 00 00       	call   39cd <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 a7 20 00 00       	call   396d <exit>
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 71 44 00 00       	push   $0x4471
    18dc:	e8 ec 20 00 00       	call   39cd <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 8c 20 00 00       	call   3975 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    1903:	5f                   	pop    %edi
    1904:	6a 00                	push   $0x0
    1906:	68 7e 46 00 00       	push   $0x467e
    190b:	8d 7d b0             	lea    -0x50(%ebp),%edi
    190e:	e8 9a 20 00 00       	call   39ad <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 59 20 00 00       	call   3985 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 1c 20 00 00       	call   3995 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 1b 20 00 00       	call   39bd <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 13 20 00 00       	call   39bd <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 0b 20 00 00       	call   39bd <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 03 20 00 00       	call   39bd <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 ab 1f 00 00       	call   3975 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 84 1f 00 00       	call   3965 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 9d 1f 00 00       	call   39ad <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 7d 1f 00 00       	call   3995 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 8b 1f 00 00       	call   39ad <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 6b 1f 00 00       	call   3995 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 79 1f 00 00       	call   39ad <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 59 1f 00 00       	call   3995 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 67 1f 00 00       	call   39ad <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 47 1f 00 00       	call   3995 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a63:	68 c6 44 00 00       	push   $0x44c6
    1a68:	6a 01                	push   $0x1
    1a6a:	e8 71 20 00 00       	call   3ae0 <printf>
}
    ...
    1a7a:	68 49 4d 00 00       	push   $0x4d49
    1a7f:	6a 01                	push   $0x1
    1a81:	e8 5a 20 00 00       	call   3ae0 <printf>
      exit();
    1a86:	e8 e2 1e 00 00       	call   396d <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a8b:	51                   	push   %ecx
    1a8c:	51                   	push   %ecx
    1a8d:	68 10 50 00 00       	push   $0x5010
    1a92:	6a 01                	push   $0x1
    1a94:	e8 47 20 00 00       	call   3ae0 <printf>
    exit();
    1a99:	e8 cf 1e 00 00       	call   396d <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1a9e:	83 ec 04             	sub    $0x4,%esp
    1aa1:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1aa4:	50                   	push   %eax
    1aa5:	68 a9 44 00 00       	push   $0x44a9
    1aaa:	6a 01                	push   $0x1
    1aac:	e8 2f 20 00 00       	call   3ae0 <printf>
        exit();
    1ab1:	e8 b7 1e 00 00       	call   396d <exit>
        printf(1, "concreate weird file %s\n", de.name);
    1ab6:	83 ec 04             	sub    $0x4,%esp
    1ab9:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1abc:	50                   	push   %eax
    1abd:	68 90 44 00 00       	push   $0x4490
    1ac2:	6a 01                	push   $0x1
    1ac4:	e8 17 20 00 00       	call   3ae0 <printf>
        exit();
    1ac9:	e8 9f 1e 00 00       	call   396d <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 be 1e 00 00       	call   3995 <close>
...
00001ae0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ae9:	68 d4 44 00 00       	push   $0x44d4
    1aee:	6a 01                	push   $0x1
    1af0:	e8 eb 1f 00 00       	call   3ae0 <printf>
  unlink("x");
    1af5:	c7 04 24 61 47 00 00 	movl   $0x4761,(%esp)
    1afc:	e8 bc 1e 00 00       	call   39bd <unlink>
  pid = fork();
    1b01:	e8 5f 1e 00 00       	call   3965 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b38:	68 61 47 00 00       	push   $0x4761
    1b3d:	e8 7b 1e 00 00       	call   39bd <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b71:	68 61 47 00 00       	push   $0x4761
    1b76:	e8 32 1e 00 00       	call   39ad <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 12 1e 00 00       	call   3995 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 de 1d 00 00       	call   3975 <wait>
  printf(1, "linkunlink ok\n");
    1b97:	83 ec 08             	sub    $0x8,%esp
    1b9a:	68 e9 44 00 00       	push   $0x44e9
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 3a 1f 00 00       	call   3ae0 <printf>
}
    ...
    1bb3:	68 61 47 00 00       	push   $0x4761
    1bb8:	68 e5 44 00 00       	push   $0x44e5
    1bbd:	e8 0b 1e 00 00       	call   39cd <link>
    1bc2:	83 c4 10             	add    $0x10,%esp
    1bc5:	e9 7b ff ff ff       	jmp    1b45 <linkunlink+0x65>
    printf(1, "fork failed\n");
    1bca:	52                   	push   %edx
    1bcb:	52                   	push   %edx
    1bcc:	68 49 4d 00 00       	push   $0x4d49
    1bd1:	6a 01                	push   $0x1
    1bd3:	e8 08 1f 00 00       	call   3ae0 <printf>
    exit();
    1bd8:	e8 90 1d 00 00       	call   396d <exit>
    exit();
    1bdd:	e8 8b 1d 00 00       	call   396d <exit>
...
00001bf0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bf9:	68 f8 44 00 00       	push   $0x44f8
    1bfe:	6a 01                	push   $0x1
    1c00:	e8 db 1e 00 00       	call   3ae0 <printf>
  unlink("bd");
    1c05:	c7 04 24 05 45 00 00 	movl   $0x4505,(%esp)
    1c0c:	e8 ac 1d 00 00       	call   39bd <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 05 45 00 00       	push   $0x4505
    1c1d:	e8 8b 1d 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 5a 1d 00 00       	call   3995 <close>
    ...
    if(link("bd", name) != 0){
    1c50:	68 05 45 00 00       	push   $0x4505
    name[1] = '0' + (i / 64);
    ...
    if(link("bd", name) != 0){
    1c67:	e8 61 1d 00 00       	call   39cd <link>
  ...
  unlink("bd");
    ...
    1c83:	68 05 45 00 00       	push   $0x4505
    1c88:	e8 30 1d 00 00       	call   39bd <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 06 1d 00 00       	call   39bd <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ccc:	68 47 45 00 00       	push   $0x4547
    1cd1:	6a 01                	push   $0x1
    1cd3:	e8 08 1e 00 00       	call   3ae0 <printf>
    ...
    1ce6:	68 1e 45 00 00       	push   $0x451e
    1ceb:	6a 01                	push   $0x1
    1ced:	e8 ee 1d 00 00       	call   3ae0 <printf>
      exit();
    1cf2:	e8 76 1c 00 00       	call   396d <exit>
      printf(1, "bigdir unlink failed");
    1cf7:	83 ec 08             	sub    $0x8,%esp
    1cfa:	68 32 45 00 00       	push   $0x4532
    1cff:	6a 01                	push   $0x1
    1d01:	e8 da 1d 00 00       	call   3ae0 <printf>
      exit();
    1d06:	e8 62 1c 00 00       	call   396d <exit>
    printf(1, "bigdir create failed\n");
    1d0b:	50                   	push   %eax
    1d0c:	50                   	push   %eax
    1d0d:	68 08 45 00 00       	push   $0x4508
    1d12:	6a 01                	push   $0x1
    1d14:	e8 c7 1d 00 00       	call   3ae0 <printf>
    exit();
    1d19:	e8 4f 1c 00 00       	call   396d <exit>
...
00001d20 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d27:	68 52 45 00 00       	push   $0x4552
    1d2c:	6a 01                	push   $0x1
    1d2e:	e8 ad 1d 00 00       	call   3ae0 <printf>
  unlink("ff");
    1d33:	c7 04 24 db 45 00 00 	movl   $0x45db,(%esp)
    1d3a:	e8 7e 1c 00 00       	call   39bd <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 78 46 00 00 	movl   $0x4678,(%esp)
    1d46:	e8 8a 1c 00 00       	call   39d5 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d5e:	68 b1 45 00 00       	push   $0x45b1
    1d63:	e8 45 1c 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d78:	6a 02                	push   $0x2
    1d7a:	68 db 45 00 00       	push   $0x45db
    1d7f:	50                   	push   %eax
    1d80:	e8 08 1c 00 00       	call   398d <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 08 1c 00 00       	call   3995 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 78 46 00 00 	movl   $0x4678,(%esp)
    1d94:	e8 24 1c 00 00       	call   39bd <unlink>
    1d99:	83 c4 10             	add    $0x10,%esp
    1d9c:	85 c0                	test   %eax,%eax
    1d9e:	0f 89 3f 05 00 00    	jns    22e3 <subdir+0x5c3>
  if(mkdir("/dd/dd") != 0){
    1da4:	83 ec 0c             	sub    $0xc,%esp
    1da7:	68 8c 45 00 00       	push   $0x458c
    1dac:	e8 24 1c 00 00       	call   39d5 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc4:	68 ae 45 00 00       	push   $0x45ae
    1dc9:	e8 df 1b 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dde:	6a 02                	push   $0x2
    1de0:	68 cf 45 00 00       	push   $0x45cf
    1de5:	50                   	push   %eax
    1de6:	e8 a2 1b 00 00       	call   398d <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 a2 1b 00 00       	call   3995 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 d2 45 00 00       	push   $0x45d2
    1dfc:	e8 ac 1b 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 64 1b 00 00       	call   3985 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 52 1b 00 00       	call   3995 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 12 46 00 00       	push   $0x4612
    1e4a:	68 ae 45 00 00       	push   $0x45ae
    1e4f:	e8 79 1b 00 00       	call   39cd <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e62:	68 ae 45 00 00       	push   $0x45ae
    1e67:	e8 51 1b 00 00       	call   39bd <unlink>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ef4:	6a 00                	push   $0x0
    1ef6:	68 12 46 00 00       	push   $0x4612
    1efb:	e8 ad 1a 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 65 1a 00 00       	call   3985 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 60 1a 00 00       	call   3995 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 ae 45 00 00       	push   $0x45ae
    1f3e:	e8 6a 1a 00 00       	call   39ad <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f56:	68 c6 46 00 00       	push   $0x46c6
    1f5b:	e8 4d 1a 00 00       	call   39ad <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f73:	68 eb 46 00 00       	push   $0x46eb
    1f78:	e8 30 1a 00 00       	call   39ad <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f90:	68 78 46 00 00       	push   $0x4678
    1f95:	e8 13 1a 00 00       	call   39ad <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1fa8:	6a 02                	push   $0x2
    1faa:	68 78 46 00 00       	push   $0x4678
    1faf:	e8 f9 19 00 00       	call   39ad <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc2:	6a 01                	push   $0x1
    1fc4:	68 78 46 00 00       	push   $0x4678
    1fc9:	e8 df 19 00 00       	call   39ad <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fdc:	68 5a 47 00 00       	push   $0x475a
    1fe1:	68 c6 46 00 00       	push   $0x46c6
    1fe6:	e8 e2 19 00 00       	call   39cd <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff9:	68 5a 47 00 00       	push   $0x475a
    1ffe:	68 eb 46 00 00       	push   $0x46eb
    2003:	e8 c5 19 00 00       	call   39cd <link>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2063:	68 12 46 00 00       	push   $0x4612
    2068:	e8 68 19 00 00       	call   39d5 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    207b:	68 eb 46 00 00       	push   $0x46eb
    2080:	e8 38 19 00 00       	call   39bd <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2167:	50                   	push   %eax
    2168:	50                   	push   %eax
    2169:	68 f7 45 00 00       	push   $0x45f7
    216e:	6a 01                	push   $0x1
    2170:	e8 6b 19 00 00       	call   3ae0 <printf>
    exit();
    2175:	e8 f3 17 00 00       	call   396d <exit>
    printf(1, "chdir dd/../../dd failed\n");
    217a:	50                   	push   %eax
    217b:	50                   	push   %eax
    217c:	68 52 46 00 00       	push   $0x4652
    2181:	6a 01                	push   $0x1
    2183:	e8 58 19 00 00       	call   3ae0 <printf>
    exit();
    2188:	e8 e0 17 00 00       	call   396d <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    218d:	50                   	push   %eax
    218e:	50                   	push   %eax
    218f:	68 1d 46 00 00       	push   $0x461d
    2194:	6a 01                	push   $0x1
    2196:	e8 45 19 00 00       	call   3ae0 <printf>
    exit();
    219b:	e8 cd 17 00 00       	call   396d <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    21a0:	51                   	push   %ecx
    21a1:	51                   	push   %ecx
    21a2:	68 cf 46 00 00       	push   $0x46cf
    21a7:	6a 01                	push   $0x1
    21a9:	e8 32 19 00 00       	call   3ae0 <printf>
    exit();
    21ae:	e8 ba 17 00 00       	call   396d <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21b3:	53                   	push   %ebx
    21b4:	53                   	push   %ebx
    21b5:	68 b4 50 00 00       	push   $0x50b4
    21ba:	6a 01                	push   $0x1
    21bc:	e8 1f 19 00 00       	call   3ae0 <printf>
    exit();
    21c1:	e8 a7 17 00 00       	call   396d <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21c6:	51                   	push   %ecx
    21c7:	51                   	push   %ecx
    21c8:	68 63 47 00 00       	push   $0x4763
    21cd:	6a 01                	push   $0x1
    21cf:	e8 0c 19 00 00       	call   3ae0 <printf>
    exit();
    21d4:	e8 94 17 00 00       	call   396d <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21d9:	53                   	push   %ebx
    21da:	53                   	push   %ebx
    21db:	68 24 51 00 00       	push   $0x5124
    21e0:	6a 01                	push   $0x1
    21e2:	e8 f9 18 00 00       	call   3ae0 <printf>
    exit();
    21e7:	e8 81 17 00 00       	call   396d <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21ec:	50                   	push   %eax
    21ed:	50                   	push   %eax
    21ee:	68 de 45 00 00       	push   $0x45de
    21f3:	6a 01                	push   $0x1
    21f5:	e8 e6 18 00 00       	call   3ae0 <printf>
    exit();
    21fa:	e8 6e 17 00 00       	call   396d <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ff:	51                   	push   %ecx
    2200:	51                   	push   %ecx
    2201:	68 b7 45 00 00       	push   $0x45b7
    2206:	6a 01                	push   $0x1
    2208:	e8 d3 18 00 00       	call   3ae0 <printf>
    exit();
    220d:	e8 5b 17 00 00       	call   396d <exit>
    printf(1, "chdir ./.. failed\n");
    2212:	50                   	push   %eax
    2213:	50                   	push   %eax
    2214:	68 80 46 00 00       	push   $0x4680
    2219:	6a 01                	push   $0x1
    221b:	e8 c0 18 00 00       	call   3ae0 <printf>
    exit();
    2220:	e8 48 17 00 00       	call   396d <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2225:	52                   	push   %edx
    2226:	52                   	push   %edx
    2227:	68 6c 50 00 00       	push   $0x506c
    222c:	6a 01                	push   $0x1
    222e:	e8 ad 18 00 00       	call   3ae0 <printf>
    exit();
    2233:	e8 35 17 00 00       	call   396d <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2238:	50                   	push   %eax
    2239:	50                   	push   %eax
    223a:	68 00 51 00 00       	push   $0x5100
    223f:	6a 01                	push   $0x1
    2241:	e8 9a 18 00 00       	call   3ae0 <printf>
    exit();
    2246:	e8 22 17 00 00       	call   396d <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    224b:	50                   	push   %eax
    224c:	50                   	push   %eax
    224d:	68 dc 50 00 00       	push   $0x50dc
    2252:	6a 01                	push   $0x1
    2254:	e8 87 18 00 00       	call   3ae0 <printf>
    exit();
    2259:	e8 0f 17 00 00       	call   396d <exit>
    printf(1, "open dd wronly succeeded!\n");
    225e:	50                   	push   %eax
    225f:	50                   	push   %eax
    2260:	68 3f 47 00 00       	push   $0x473f
    2265:	6a 01                	push   $0x1
    2267:	e8 74 18 00 00       	call   3ae0 <printf>
    exit();
    226c:	e8 fc 16 00 00       	call   396d <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2271:	50                   	push   %eax
    2272:	50                   	push   %eax
    2273:	68 26 47 00 00       	push   $0x4726
    2278:	6a 01                	push   $0x1
    227a:	e8 61 18 00 00       	call   3ae0 <printf>
    exit();
    227f:	e8 e9 16 00 00       	call   396d <exit>
    printf(1, "create dd succeeded!\n");
    2284:	50                   	push   %eax
    2285:	50                   	push   %eax
    2286:	68 10 47 00 00       	push   $0x4710
    228b:	6a 01                	push   $0x1
    228d:	e8 4e 18 00 00       	call   3ae0 <printf>
    exit();
    2292:	e8 d6 16 00 00       	call   396d <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2297:	52                   	push   %edx
    2298:	52                   	push   %edx
    2299:	68 f4 46 00 00       	push   $0x46f4
    229e:	6a 01                	push   $0x1
    22a0:	e8 3b 18 00 00       	call   3ae0 <printf>
    exit();
    22a5:	e8 c3 16 00 00       	call   396d <exit>
    printf(1, "chdir dd failed\n");
    22aa:	50                   	push   %eax
    22ab:	50                   	push   %eax
    22ac:	68 35 46 00 00       	push   $0x4635
    22b1:	6a 01                	push   $0x1
    22b3:	e8 28 18 00 00       	call   3ae0 <printf>
    exit();
    22b8:	e8 b0 16 00 00       	call   396d <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    22bf:	68 90 50 00 00       	push   $0x5090
    22c4:	6a 01                	push   $0x1
    22c6:	e8 15 18 00 00       	call   3ae0 <printf>
    exit();
    22cb:	e8 9d 16 00 00       	call   396d <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22d0:	53                   	push   %ebx
    22d1:	53                   	push   %ebx
    22d2:	68 93 45 00 00       	push   $0x4593
    22d7:	6a 01                	push   $0x1
    22d9:	e8 02 18 00 00       	call   3ae0 <printf>
    exit();
    22de:	e8 8a 16 00 00       	call   396d <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22e3:	50                   	push   %eax
    22e4:	50                   	push   %eax
    22e5:	68 44 50 00 00       	push   $0x5044
    22ea:	6a 01                	push   $0x1
    22ec:	e8 ef 17 00 00       	call   3ae0 <printf>
    exit();
    22f1:	e8 77 16 00 00       	call   396d <exit>
    printf(1, "create dd/ff failed\n");
    22f6:	50                   	push   %eax
    22f7:	50                   	push   %eax
    22f8:	68 77 45 00 00       	push   $0x4577
    22fd:	6a 01                	push   $0x1
    22ff:	e8 dc 17 00 00       	call   3ae0 <printf>
    exit();
    2304:	e8 64 16 00 00       	call   396d <exit>
    printf(1, "subdir mkdir dd failed\n");
    2309:	50                   	push   %eax
    230a:	50                   	push   %eax
    230b:	68 5f 45 00 00       	push   $0x455f
    2310:	6a 01                	push   $0x1
    2312:	e8 c9 17 00 00       	call   3ae0 <printf>
    exit();
    2317:	e8 51 16 00 00       	call   396d <exit>
    printf(1, "unlink dd failed\n");
    231c:	50                   	push   %eax
    231d:	50                   	push   %eax
    231e:	68 48 48 00 00       	push   $0x4848
    2323:	6a 01                	push   $0x1
    2325:	e8 b6 17 00 00       	call   3ae0 <printf>
    exit();
    232a:	e8 3e 16 00 00       	call   396d <exit>
    printf(1, "unlink dd/dd failed\n");
    232f:	52                   	push   %edx
    2330:	52                   	push   %edx
    2331:	68 33 48 00 00       	push   $0x4833
    2336:	6a 01                	push   $0x1
    2338:	e8 a3 17 00 00       	call   3ae0 <printf>
    exit();
    233d:	e8 2b 16 00 00       	call   396d <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2342:	51                   	push   %ecx
    2343:	51                   	push   %ecx
    2344:	68 48 51 00 00       	push   $0x5148
    2349:	6a 01                	push   $0x1
    234b:	e8 90 17 00 00       	call   3ae0 <printf>
    exit();
    2350:	e8 18 16 00 00       	call   396d <exit>
    printf(1, "unlink dd/ff failed\n");
    2355:	53                   	push   %ebx
    2356:	53                   	push   %ebx
    2357:	68 1e 48 00 00       	push   $0x481e
    235c:	6a 01                	push   $0x1
    235e:	e8 7d 17 00 00       	call   3ae0 <printf>
    exit();
    2363:	e8 05 16 00 00       	call   396d <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2368:	50                   	push   %eax
    2369:	50                   	push   %eax
    236a:	68 06 48 00 00       	push   $0x4806
    236f:	6a 01                	push   $0x1
    2371:	e8 6a 17 00 00       	call   3ae0 <printf>
    exit();
    2376:	e8 f2 15 00 00       	call   396d <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    237b:	50                   	push   %eax
    237c:	50                   	push   %eax
    237d:	68 ee 47 00 00       	push   $0x47ee
    2382:	6a 01                	push   $0x1
    2384:	e8 57 17 00 00       	call   3ae0 <printf>
    exit();
    2389:	e8 df 15 00 00       	call   396d <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    238e:	50                   	push   %eax
    238f:	50                   	push   %eax
    2390:	68 d2 47 00 00       	push   $0x47d2
    2395:	6a 01                	push   $0x1
    2397:	e8 44 17 00 00       	call   3ae0 <printf>
    exit();
    239c:	e8 cc 15 00 00       	call   396d <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    23a1:	50                   	push   %eax
    23a2:	50                   	push   %eax
    23a3:	68 b6 47 00 00       	push   $0x47b6
    23a8:	6a 01                	push   $0x1
    23aa:	e8 31 17 00 00       	call   3ae0 <printf>
    exit();
    23af:	e8 b9 15 00 00       	call   396d <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23b4:	50                   	push   %eax
    23b5:	50                   	push   %eax
    23b6:	68 99 47 00 00       	push   $0x4799
    23bb:	6a 01                	push   $0x1
    23bd:	e8 1e 17 00 00       	call   3ae0 <printf>
    exit();
    23c2:	e8 a6 15 00 00       	call   396d <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23c7:	52                   	push   %edx
    23c8:	52                   	push   %edx
    23c9:	68 7e 47 00 00       	push   $0x477e
    23ce:	6a 01                	push   $0x1
    23d0:	e8 0b 17 00 00       	call   3ae0 <printf>
    exit();
    23d5:	e8 93 15 00 00       	call   396d <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23da:	51                   	push   %ecx
    23db:	51                   	push   %ecx
    23dc:	68 ab 46 00 00       	push   $0x46ab
    23e1:	6a 01                	push   $0x1
    23e3:	e8 f8 16 00 00       	call   3ae0 <printf>
    exit();
    23e8:	e8 80 15 00 00       	call   396d <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23ed:	53                   	push   %ebx
    23ee:	53                   	push   %ebx
    23ef:	68 93 46 00 00       	push   $0x4693
    23f4:	6a 01                	push   $0x1
    23f6:	e8 e5 16 00 00       	call   3ae0 <printf>
    exit();
    23fb:	e8 6d 15 00 00       	call   396d <exit>
...
00002400 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    240d:	68 65 48 00 00       	push   $0x4865
    2412:	6a 01                	push   $0x1
    2414:	e8 c7 16 00 00       	call   3ae0 <printf>
  unlink("bigwrite");
    2419:	c7 04 24 74 48 00 00 	movl   $0x4874,(%esp)
    2420:	e8 98 15 00 00       	call   39bd <unlink>
    ...
    2438:	68 74 48 00 00       	push   $0x4874
    243d:	e8 6b 15 00 00       	call   39ad <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 33 15 00 00       	call   398d <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 1d 15 00 00       	call   398d <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 0f 15 00 00       	call   3995 <close>
    unlink("bigwrite");
    2486:	c7 04 24 74 48 00 00 	movl   $0x4874,(%esp)
    248d:	e8 2b 15 00 00       	call   39bd <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24a0:	68 a7 48 00 00       	push   $0x48a7
    24a5:	6a 01                	push   $0x1
    24a7:	e8 34 16 00 00       	call   3ae0 <printf>
}
    ...
    24b6:	50                   	push   %eax
    24b7:	53                   	push   %ebx
    24b8:	68 95 48 00 00       	push   $0x4895
    24bd:	6a 01                	push   $0x1
    24bf:	e8 1c 16 00 00       	call   3ae0 <printf>
        exit();
    24c4:	e8 a4 14 00 00       	call   396d <exit>
      printf(1, "cannot create bigwrite\n");
    24c9:	83 ec 08             	sub    $0x8,%esp
    24cc:	68 7d 48 00 00       	push   $0x487d
    24d1:	6a 01                	push   $0x1
    24d3:	e8 08 16 00 00       	call   3ae0 <printf>
      exit();
    24d8:	e8 90 14 00 00       	call   396d <exit>
...
000024e0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24e9:	68 b4 48 00 00       	push   $0x48b4
    24ee:	6a 01                	push   $0x1
    24f0:	e8 eb 15 00 00       	call   3ae0 <printf>
  unlink("bigfile");
    24f5:	c7 04 24 d0 48 00 00 	movl   $0x48d0,(%esp)
    24fc:	e8 bc 14 00 00       	call   39bd <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 d0 48 00 00       	push   $0x48d0
    250d:	e8 9b 14 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 3f 14 00 00       	call   398d <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 28 14 00 00       	call   3995 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 d0 48 00 00       	push   $0x48d0
    2576:	e8 32 14 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 b4 13 00 00       	call   3985 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 b2 13 00 00       	call   3995 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 be 13 00 00       	call   39bd <unlink>
  printf(1, "bigfile test ok\n");
    25ff:	58                   	pop    %eax
    2600:	5a                   	pop    %edx
    2601:	68 5f 49 00 00       	push   $0x495f
    2606:	6a 01                	push   $0x1
    2608:	e8 d3 14 00 00       	call   3ae0 <printf>
}
    ...
    2620:	6a 01                	push   $0x1
    2622:	e8 b9 14 00 00       	call   3ae0 <printf>
      exit();
    2627:	e8 41 13 00 00       	call   396d <exit>
      printf(1, "short read bigfile\n");
    262c:	83 ec 08             	sub    $0x8,%esp
    262f:	68 18 49 00 00       	push   $0x4918
    2634:	6a 01                	push   $0x1
    2636:	e8 a5 14 00 00       	call   3ae0 <printf>
      exit();
    263b:	e8 2d 13 00 00       	call   396d <exit>
      printf(1, "read bigfile failed\n");
    2640:	83 ec 08             	sub    $0x8,%esp
    2643:	68 03 49 00 00       	push   $0x4903
    2648:	6a 01                	push   $0x1
    264a:	e8 91 14 00 00       	call   3ae0 <printf>
      exit();
    264f:	e8 19 13 00 00       	call   396d <exit>
      printf(1, "write bigfile failed\n");
    2654:	83 ec 08             	sub    $0x8,%esp
    2657:	68 d8 48 00 00       	push   $0x48d8
    265c:	6a 01                	push   $0x1
    265e:	e8 7d 14 00 00       	call   3ae0 <printf>
      exit();
    2663:	e8 05 13 00 00       	call   396d <exit>
    printf(1, "cannot open bigfile\n");
    2668:	53                   	push   %ebx
    2669:	53                   	push   %ebx
    266a:	68 ee 48 00 00       	push   $0x48ee
    266f:	6a 01                	push   $0x1
    2671:	e8 6a 14 00 00       	call   3ae0 <printf>
    exit();
    2676:	e8 f2 12 00 00       	call   396d <exit>
    printf(1, "cannot create bigfile");
    267b:	50                   	push   %eax
    267c:	50                   	push   %eax
    267d:	68 c2 48 00 00       	push   $0x48c2
    2682:	6a 01                	push   $0x1
    2684:	e8 57 14 00 00       	call   3ae0 <printf>
    exit();
    2689:	e8 df 12 00 00       	call   396d <exit>
    printf(1, "read bigfile wrong total\n");
    268e:	51                   	push   %ecx
    268f:	51                   	push   %ecx
    2690:	68 45 49 00 00       	push   $0x4945
    2695:	6a 01                	push   $0x1
    2697:	e8 44 14 00 00       	call   3ae0 <printf>
    exit();
    269c:	e8 cc 12 00 00       	call   396d <exit>
...
000026b0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    ...
    26bb:	6a 01                	push   $0x1
    26bd:	e8 1e 14 00 00       	call   3ae0 <printf>
  if(mkdir("12345678901234") != 0){
    26c2:	c7 04 24 ab 49 00 00 	movl   $0x49ab,(%esp)
    26c9:	e8 07 13 00 00       	call   39d5 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26dc:	68 68 51 00 00       	push   $0x5168
    26e1:	e8 ef 12 00 00       	call   39d5 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26f9:	68 b8 51 00 00       	push   $0x51b8
    26fe:	e8 aa 12 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 7e 12 00 00       	call   3995 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 28 52 00 00       	push   $0x5228
    2720:	e8 88 12 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  printf(1, "fourteen ok\n");
    ...
    2764:	6a 01                	push   $0x1
    2766:	e8 75 13 00 00       	call   3ae0 <printf>
}
    ...
    2777:	6a 01                	push   $0x1
    2779:	e8 62 13 00 00       	call   3ae0 <printf>
    exit();
    277e:	e8 ea 11 00 00       	call   396d <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2783:	50                   	push   %eax
    2784:	50                   	push   %eax
    2785:	68 e4 52 00 00       	push   $0x52e4
    278a:	6a 01                	push   $0x1
    278c:	e8 4f 13 00 00       	call   3ae0 <printf>
    exit();
    2791:	e8 d7 11 00 00       	call   396d <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2796:	52                   	push   %edx
    2797:	52                   	push   %edx
    2798:	68 94 52 00 00       	push   $0x5294
    279d:	6a 01                	push   $0x1
    279f:	e8 3c 13 00 00       	call   3ae0 <printf>
    exit();
    27a4:	e8 c4 11 00 00       	call   396d <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    27a9:	51                   	push   %ecx
    27aa:	51                   	push   %ecx
    27ab:	68 58 52 00 00       	push   $0x5258
    27b0:	6a 01                	push   $0x1
    27b2:	e8 29 13 00 00       	call   3ae0 <printf>
    exit();
    27b7:	e8 b1 11 00 00       	call   396d <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27bc:	51                   	push   %ecx
    27bd:	51                   	push   %ecx
    27be:	68 e8 51 00 00       	push   $0x51e8
    27c3:	6a 01                	push   $0x1
    27c5:	e8 16 13 00 00       	call   3ae0 <printf>
    exit();
    27ca:	e8 9e 11 00 00       	call   396d <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27cf:	50                   	push   %eax
    27d0:	50                   	push   %eax
    27d1:	68 88 51 00 00       	push   $0x5188
    27d6:	6a 01                	push   $0x1
    27d8:	e8 03 13 00 00       	call   3ae0 <printf>
    exit();
    27dd:	e8 8b 11 00 00       	call   396d <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 c7 11 00 00       	call   39d5 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 b7 11 00 00       	call   39dd <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 7f 11 00 00       	call   39bd <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 67 11 00 00       	call   39bd <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 6f 11 00 00       	call   39dd <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 37 11 00 00       	call   39bd <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 23 11 00 00       	call   39bd <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 0f 11 00 00       	call   39bd <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    28bd:	6a 01                	push   $0x1
    28bf:	e8 1c 12 00 00       	call   3ae0 <printf>
}
    ...
    28d0:	6a 01                	push   $0x1
    28d2:	e8 09 12 00 00       	call   3ae0 <printf>
    exit();
    28d7:	e8 91 10 00 00       	call   396d <exit>
    printf(1, "unlink dots failed!\n");
    28dc:	50                   	push   %eax
    28dd:	50                   	push   %eax
    28de:	68 59 4a 00 00       	push   $0x4a59
    28e3:	6a 01                	push   $0x1
    28e5:	e8 f6 11 00 00       	call   3ae0 <printf>
    exit();
    28ea:	e8 7e 10 00 00       	call   396d <exit>
    printf(1, "unlink dots/.. worked!\n");
    28ef:	52                   	push   %edx
    28f0:	52                   	push   %edx
    28f1:	68 41 4a 00 00       	push   $0x4a41
    28f6:	6a 01                	push   $0x1
    28f8:	e8 e3 11 00 00       	call   3ae0 <printf>
    exit();
    28fd:	e8 6b 10 00 00       	call   396d <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    2904:	68 22 4a 00 00       	push   $0x4a22
    2909:	6a 01                	push   $0x1
    290b:	e8 d0 11 00 00       	call   3ae0 <printf>
    exit();
    2910:	e8 58 10 00 00       	call   396d <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    2917:	68 53 3e 00 00       	push   $0x3e53
    291c:	6a 01                	push   $0x1
    291e:	e8 bd 11 00 00       	call   3ae0 <printf>
    exit();
    2923:	e8 45 10 00 00       	call   396d <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    292a:	68 0c 4a 00 00       	push   $0x4a0c
    292f:	6a 01                	push   $0x1
    2931:	e8 aa 11 00 00       	call   3ae0 <printf>
    exit();
    2936:	e8 32 10 00 00       	call   396d <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    293d:	68 fe 49 00 00       	push   $0x49fe
    2942:	6a 01                	push   $0x1
    2944:	e8 97 11 00 00       	call   3ae0 <printf>
    exit();
    2949:	e8 1f 10 00 00       	call   396d <exit>
    printf(1, "chdir dots failed\n");
    294e:	50                   	push   %eax
    294f:	50                   	push   %eax
    2950:	68 eb 49 00 00       	push   $0x49eb
    2955:	6a 01                	push   $0x1
    2957:	e8 84 11 00 00       	call   3ae0 <printf>
    exit();
    295c:	e8 0c 10 00 00       	call   396d <exit>
...
00002970 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    ...
    297c:	6a 01                	push   $0x1
    297e:	e8 5d 11 00 00       	call   3ae0 <printf>
  fd = open("dirfile", O_CREATE);
    2983:	5b                   	pop    %ebx
    2984:	58                   	pop    %eax
    2985:	68 00 02 00 00       	push   $0x200
    298a:	68 85 4a 00 00       	push   $0x4a85
    298f:	e8 19 10 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 ed 0f 00 00       	call   3995 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 85 4a 00 00 	movl   $0x4a85,(%esp)
    29af:	e8 29 10 00 00       	call   39dd <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 df 0f 00 00       	call   39ad <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 c2 0f 00 00       	call   39ad <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 d2 0f 00 00       	call   39d5 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 a2 0f 00 00       	call   39bd <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 95 0f 00 00       	call   39cd <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 6d 0f 00 00       	call   39bd <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 43 0f 00 00       	call   39ad <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 29 0f 00 00       	call   39ad <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 f7 0e 00 00       	call   398d <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 ef 0e 00 00       	call   3995 <close>
  printf(1, "dir vs file OK\n");
    2aa6:	58                   	pop    %eax
    2aa7:	5a                   	pop    %edx
    2aa8:	68 55 4b 00 00       	push   $0x4b55
    2aad:	6a 01                	push   $0x1
    2aaf:	e8 2c 10 00 00       	call   3ae0 <printf>
}
    ...
    2ac3:	6a 01                	push   $0x1
    2ac5:	e8 16 10 00 00       	call   3ae0 <printf>
    exit();
    2aca:	e8 9e 0e 00 00       	call   396d <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2acf:	52                   	push   %edx
    2ad0:	52                   	push   %edx
    2ad1:	68 a4 4a 00 00       	push   $0x4aa4
    2ad6:	6a 01                	push   $0x1
    2ad8:	e8 03 10 00 00       	call   3ae0 <printf>
    exit();
    2add:	e8 8b 0e 00 00       	call   396d <exit>
    printf(1, "create dirfile failed\n");
    2ae2:	51                   	push   %ecx
    2ae3:	51                   	push   %ecx
    2ae4:	68 8d 4a 00 00       	push   $0x4a8d
    2ae9:	6a 01                	push   $0x1
    2aeb:	e8 f0 0f 00 00       	call   3ae0 <printf>
    exit();
    2af0:	e8 78 0e 00 00       	call   396d <exit>
    printf(1, "write . succeeded!\n");
    2af5:	51                   	push   %ecx
    2af6:	51                   	push   %ecx
    2af7:	68 41 4b 00 00       	push   $0x4b41
    2afc:	6a 01                	push   $0x1
    2afe:	e8 dd 0f 00 00       	call   3ae0 <printf>
    exit();
    2b03:	e8 65 0e 00 00       	call   396d <exit>
    printf(1, "open . for writing succeeded!\n");
    2b08:	53                   	push   %ebx
    2b09:	53                   	push   %ebx
    2b0a:	68 38 53 00 00       	push   $0x5338
    2b0f:	6a 01                	push   $0x1
    2b11:	e8 ca 0f 00 00       	call   3ae0 <printf>
    exit();
    2b16:	e8 52 0e 00 00       	call   396d <exit>
    printf(1, "unlink dirfile failed!\n");
    2b1b:	50                   	push   %eax
    2b1c:	50                   	push   %eax
    2b1d:	68 29 4b 00 00       	push   $0x4b29
    2b22:	6a 01                	push   $0x1
    2b24:	e8 b7 0f 00 00       	call   3ae0 <printf>
    exit();
    2b29:	e8 3f 0e 00 00       	call   396d <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b2e:	50                   	push   %eax
    2b2f:	50                   	push   %eax
    2b30:	68 18 53 00 00       	push   $0x5318
    2b35:	6a 01                	push   $0x1
    2b37:	e8 a4 0f 00 00       	call   3ae0 <printf>
    exit();
    2b3c:	e8 2c 0e 00 00       	call   396d <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b41:	50                   	push   %eax
    2b42:	50                   	push   %eax
    2b43:	68 04 4b 00 00       	push   $0x4b04
    2b48:	6a 01                	push   $0x1
    2b4a:	e8 91 0f 00 00       	call   3ae0 <printf>
    exit();
    2b4f:	e8 19 0e 00 00       	call   396d <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b54:	50                   	push   %eax
    2b55:	50                   	push   %eax
    2b56:	68 e7 4a 00 00       	push   $0x4ae7
    2b5b:	6a 01                	push   $0x1
    2b5d:	e8 7e 0f 00 00       	call   3ae0 <printf>
    exit();
    2b62:	e8 06 0e 00 00       	call   396d <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b81:	6a 01                	push   $0x1
    2b83:	e8 58 0f 00 00       	call   3ae0 <printf>
    ...
    2b98:	e8 38 0e 00 00       	call   39d5 <mkdir>
    ...
    2bb0:	e8 28 0e 00 00       	call   39dd <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 71 0d 00 00       	call   3995 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 60 47 00 00       	push   $0x4760
    2c2f:	e8 89 0d 00 00       	call   39bd <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 90 0d 00 00       	call   39dd <chdir>
  printf(1, "empty file name OK\n");
    2c4d:	58                   	pop    %eax
    2c4e:	5a                   	pop    %edx
    2c4f:	68 a4 4b 00 00       	push   $0x4ba4
    2c54:	6a 01                	push   $0x1
    2c56:	e8 85 0e 00 00       	call   3ae0 <printf>
}
    ...
    2c6b:	6a 01                	push   $0x1
    2c6d:	e8 6e 0e 00 00       	call   3ae0 <printf>
      exit();
    2c72:	e8 f6 0c 00 00       	call   396d <exit>
      printf(1, "chdir irefd failed\n");
    2c77:	83 ec 08             	sub    $0x8,%esp
    2c7a:	68 90 4b 00 00       	push   $0x4b90
    2c7f:	6a 01                	push   $0x1
    2c81:	e8 5a 0e 00 00       	call   3ae0 <printf>
      exit();
    2c86:	e8 e2 0c 00 00       	call   396d <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    ...
    2c9e:	6a 01                	push   $0x1
    2ca0:	e8 3b 0e 00 00       	call   3ae0 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 a3 0c 00 00       	call   3965 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 a0 0c 00 00       	call   3975 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 92 0c 00 00       	call   3975 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cf0:	6a 01                	push   $0x1
    2cf2:	e8 e9 0d 00 00       	call   3ae0 <printf>
}
    2cf7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2cfa:	c9                   	leave  
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 6c 0c 00 00       	call   396d <exit>
      printf(1, "wait stopped early\n");
    2d01:	83 ec 08             	sub    $0x8,%esp
    2d04:	68 c3 4b 00 00       	push   $0x4bc3
    2d09:	6a 01                	push   $0x1
    2d0b:	e8 d0 0d 00 00       	call   3ae0 <printf>
      exit();
    2d10:	e8 58 0c 00 00       	call   396d <exit>
    printf(1, "wait got too many\n");
    2d15:	52                   	push   %edx
    2d16:	52                   	push   %edx
    2d17:	68 d7 4b 00 00       	push   $0x4bd7
    2d1c:	6a 01                	push   $0x1
    2d1e:	e8 bd 0d 00 00       	call   3ae0 <printf>
    exit();
    2d23:	e8 45 0c 00 00       	call   396d <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d28:	50                   	push   %eax
    2d29:	50                   	push   %eax
    2d2a:	68 58 53 00 00       	push   $0x5358
    2d2f:	6a 01                	push   $0x1
    2d31:	e8 aa 0d 00 00       	call   3ae0 <printf>
    exit();
    2d36:	e8 32 0c 00 00       	call   396d <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 54 5f 00 00    	pushl  0x5f54
    2d56:	e8 85 0d 00 00       	call   3ae0 <printf>
  oldbrk = sbrk(0);
    2d5b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d62:	e8 8e 0c 00 00       	call   39f5 <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 7f 0c 00 00       	call   39f5 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 69 0c 00 00       	call   39f5 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 b8 0b 00 00       	call   3965 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 31 0c 00 00       	call   39f5 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 25 0c 00 00       	call   39f5 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 8d 0b 00 00       	call   3975 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 03 0c 00 00       	call   39f5 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 f2 0b 00 00       	call   39f5 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 d6 0b 00 00       	call   39f5 <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 c8 0b 00 00       	call   39f5 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 b2 0b 00 00       	call   39f5 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 97 0b 00 00       	call   39f5 <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 89 0b 00 00       	call   39f5 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 72 0b 00 00       	call   39f5 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 08 0b 00 00       	call   39ed <getpid>
    2ee5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ee7:	e8 79 0a 00 00       	call   3965 <fork>
    if(pid < 0){
    ...
    wait();
    2efa:	e8 76 0a 00 00       	call   3975 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 64 0a 00 00       	call   397d <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f30:	e8 30 0a 00 00       	call   3965 <fork>
    ...
    2f50:	e8 30 0a 00 00       	call   3985 <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 89 0a 00 00       	call   39f5 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 15 0a 00 00       	call   399d <kill>
    wait();
    2f88:	e8 e8 09 00 00       	call   3975 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 4b 0a 00 00       	call   39f5 <sbrk>
    2faa:	83 c4 10             	add    $0x10,%esp
    2fad:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fb0:	72 60                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2fb2:	83 ec 08             	sub    $0x8,%esp
    2fb5:	68 a0 4c 00 00       	push   $0x4ca0
    2fba:	ff 35 54 5f 00 00    	pushl  0x5f54
    2fc0:	e8 1b 0b 00 00       	call   3ae0 <printf>
}
    ...
    3037:	53                   	push   %ebx
    3038:	56                   	push   %esi
    3039:	68 03 4c 00 00       	push   $0x4c03
    303e:	ff 35 54 5f 00 00    	pushl  0x5f54
    3044:	e8 97 0a 00 00       	call   3ae0 <printf>
      exit();
    3049:	83 c4 20             	add    $0x20,%esp
    304c:	e8 1c 09 00 00       	call   396d <exit>
      printf(stdout, "fork failed\n");
    3051:	83 ec 08             	sub    $0x8,%esp
    3054:	68 49 4d 00 00       	push   $0x4d49
    3059:	ff 35 54 5f 00 00    	pushl  0x5f54
    305f:	e8 7c 0a 00 00       	call   3ae0 <printf>
      exit();
    3064:	e8 04 09 00 00       	call   396d <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3069:	0f be 03             	movsbl (%ebx),%eax
    306c:	50                   	push   %eax
    306d:	53                   	push   %ebx
    306e:	68 6c 4c 00 00       	push   $0x4c6c
    3073:	ff 35 54 5f 00 00    	pushl  0x5f54
    3079:	e8 62 0a 00 00       	call   3ae0 <printf>
      kill(ppid);
    307e:	89 34 24             	mov    %esi,(%esp)
    3081:	e8 17 09 00 00       	call   399d <kill>
      exit();
    3086:	e8 e2 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 4c 54 00 00       	push   $0x544c
    3092:	ff 35 54 5f 00 00    	pushl  0x5f54
    3098:	e8 43 0a 00 00       	call   3ae0 <printf>
    exit();
    309d:	e8 cb 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 7c 53 00 00       	push   $0x537c
    30a9:	ff 35 54 5f 00 00    	pushl  0x5f54
    30af:	e8 2c 0a 00 00       	call   3ae0 <printf>
    exit();
    30b4:	e8 b4 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b9:	50                   	push   %eax
    30ba:	50                   	push   %eax
    30bb:	68 1e 4c 00 00       	push   $0x4c1e
    30c0:	ff 35 54 5f 00 00    	pushl  0x5f54
    30c6:	e8 15 0a 00 00       	call   3ae0 <printf>
    exit();
    30cb:	e8 9d 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 1c 54 00 00       	push   $0x541c
    30d7:	ff 35 54 5f 00 00    	pushl  0x5f54
    30dd:	e8 fe 09 00 00       	call   3ae0 <printf>
    exit();
    30e2:	e8 86 08 00 00       	call   396d <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e7:	50                   	push   %eax
    30e8:	50                   	push   %eax
    30e9:	68 85 4c 00 00       	push   $0x4c85
    30ee:	ff 35 54 5f 00 00    	pushl  0x5f54
    30f4:	e8 e7 09 00 00       	call   3ae0 <printf>
    exit();
    30f9:	e8 6f 08 00 00       	call   396d <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    3100:	68 41 41 00 00       	push   $0x4141
    3105:	6a 01                	push   $0x1
    3107:	e8 d4 09 00 00       	call   3ae0 <printf>
    exit();
    310c:	e8 5c 08 00 00       	call   396d <exit>
    exit();
    3111:	e8 57 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 35 4c 00 00       	push   $0x4c35
    311d:	ff 35 54 5f 00 00    	pushl  0x5f54
    3123:	e8 b8 09 00 00       	call   3ae0 <printf>
    exit();
    3128:	e8 40 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 f4 53 00 00       	push   $0x53f4
    3134:	ff 35 54 5f 00 00    	pushl  0x5f54
    313a:	e8 a1 09 00 00       	call   3ae0 <printf>
    exit();
    313f:	e8 29 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 bc 53 00 00       	push   $0x53bc
    314b:	ff 35 54 5f 00 00    	pushl  0x5f54
    3151:	e8 8a 09 00 00       	call   3ae0 <printf>
    exit();
    3156:	e8 12 08 00 00       	call   396d <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 51 4c 00 00       	push   $0x4c51
    3162:	ff 35 54 5f 00 00    	pushl  0x5f54
    3168:	e8 73 09 00 00       	call   3ae0 <printf>
    exit();
    316d:	e8 fb 07 00 00       	call   396d <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 54 5f 00 00    	pushl  0x5f54
    31a5:	e8 36 09 00 00       	call   3ae0 <printf>
    31aa:	83 c4 10             	add    $0x10,%esp
    31ad:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31b0:	e8 b0 07 00 00       	call   3965 <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 38 08 00 00       	call   39fd <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 2c 08 00 00       	call   39fd <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 c4 07 00 00       	call   399d <kill>
    wait();
    31d9:	e8 97 07 00 00       	call   3975 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 bd 4c 00 00       	push   $0x4cbd
    31e6:	e8 e2 07 00 00       	call   39cd <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 54 5f 00 00    	pushl  0x5f54
    320f:	e8 cc 08 00 00       	call   3ae0 <printf>
}
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 4a 07 00 00       	call   396d <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 c8 4c 00 00       	push   $0x4cc8
    322b:	ff 35 54 5f 00 00    	pushl  0x5f54
    3231:	e8 aa 08 00 00       	call   3ae0 <printf>
      exit();
    3236:	e8 32 07 00 00       	call   396d <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 54 5f 00 00    	pushl  0x5f54
    3251:	e8 8a 08 00 00       	call   3ae0 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 54 5f 00 00    	pushl  0x5f54
    3281:	e8 5a 08 00 00       	call   3ae0 <printf>
}
    ...
    3293:	ff 35 54 5f 00 00    	pushl  0x5f54
    3299:	e8 42 08 00 00       	call   3ae0 <printf>
      exit();
    329e:	e8 ca 06 00 00       	call   396d <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 fd 06 00 00       	call   39bd <unlink>
  pid = fork();
    32c0:	e8 a0 06 00 00       	call   3965 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 9e 06 00 00       	call   3975 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 16 4d 00 00       	push   $0x4d16
    32e1:	e8 c7 06 00 00       	call   39ad <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 9b 06 00 00       	call   3995 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 16 4d 00 00 	movl   $0x4d16,(%esp)
    3301:	e8 b7 06 00 00       	call   39bd <unlink>
}
    ...
    3310:	c7 04 85 a0 a6 00 00 	movl   $0x5470,0xa6a0(,%eax,4)
    3317:	70 54 00 00 
    ...
    3323:	51                   	push   %ecx
    3324:	51                   	push   %ecx
    3325:	68 20 4d 00 00       	push   $0x4d20
    332a:	ff 35 54 5f 00 00    	pushl  0x5f54
    args[MAXARG-1] = 0;
    3330:	c7 05 1c a7 00 00 00 	movl   $0x0,0xa71c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    333a:	e8 a1 07 00 00       	call   3ae0 <printf>
    exec("echo", args);
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 a0 a6 00 00       	push   $0xa6a0
    3346:	68 ed 3e 00 00       	push   $0x3eed
    334b:	e8 55 06 00 00       	call   39a5 <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 2d 4d 00 00       	push   $0x4d2d
    3357:	ff 35 54 5f 00 00    	pushl  0x5f54
    335d:	e8 7e 07 00 00       	call   3ae0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3362:	58                   	pop    %eax
    3363:	5a                   	pop    %edx
    3364:	68 00 02 00 00       	push   $0x200
    3369:	68 16 4d 00 00       	push   $0x4d16
    336e:	e8 3a 06 00 00       	call   39ad <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 1a 06 00 00       	call   3995 <close>
    exit();
    337b:	e8 ed 05 00 00       	call   396d <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 56 4d 00 00       	push   $0x4d56
    3387:	ff 35 54 5f 00 00    	pushl  0x5f54
    338d:	e8 4e 07 00 00       	call   3ae0 <printf>
    exit();
    3392:	e8 d6 05 00 00       	call   396d <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 3d 4d 00 00       	push   $0x4d3d
    339e:	ff 35 54 5f 00 00    	pushl  0x5f54
    33a4:	e8 37 07 00 00       	call   3ae0 <printf>
    exit();
    33a9:	e8 bf 05 00 00       	call   396d <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33bb:	68 6b 4d 00 00       	push   $0x4d6b
    33c0:	6a 01                	push   $0x1
    33c2:	e8 19 07 00 00       	call   3ae0 <printf>
    ...
    3441:	50                   	push   %eax
    3442:	68 78 4d 00 00       	push   $0x4d78
    3447:	6a 01                	push   $0x1
    3449:	e8 92 06 00 00       	call   3ae0 <printf>
    ...
    3458:	50                   	push   %eax
    3459:	e8 4f 05 00 00       	call   39ad <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 08 05 00 00       	call   398d <write>
      if(cc < 512)
    ...
    3492:	53                   	push   %ebx
    3493:	68 94 4d 00 00       	push   $0x4d94
    3498:	6a 01                	push   $0x1
    349a:	e8 41 06 00 00       	call   3ae0 <printf>
    close(fd);
    349f:	89 3c 24             	mov    %edi,(%esp)
    34a2:	e8 ee 04 00 00       	call   3995 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34bc:	50                   	push   %eax
    34bd:	68 84 4d 00 00       	push   $0x4d84
    34c2:	6a 01                	push   $0x1
    34c4:	e8 17 06 00 00       	call   3ae0 <printf>
      break;
    ...
    354b:	50                   	push   %eax
    354c:	e8 6c 04 00 00       	call   39bd <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    355c:	68 a4 4d 00 00       	push   $0x4da4
    3561:	6a 01                	push   $0x1
    3563:	e8 78 05 00 00       	call   3ae0 <printf>
}
...
00003580 <uio>:
{
  ...
  printf(1, "uio test\n");
    3586:	68 ba 4d 00 00       	push   $0x4dba
    358b:	6a 01                	push   $0x1
    358d:	e8 4e 05 00 00       	call   3ae0 <printf>
  pid = fork();
    3592:	e8 ce 03 00 00       	call   3965 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 d0 03 00 00       	call   3975 <wait>
  printf(1, "uio test done\n");
    35a5:	83 ec 08             	sub    $0x8,%esp
    35a8:	68 c4 4d 00 00       	push   $0x4dc4
    35ad:	6a 01                	push   $0x1
    35af:	e8 2c 05 00 00       	call   3ae0 <printf>
}
    ...
    35ca:	52                   	push   %edx
    35cb:	52                   	push   %edx
    35cc:	68 50 55 00 00       	push   $0x5550
    35d1:	6a 01                	push   $0x1
    35d3:	e8 08 05 00 00       	call   3ae0 <printf>
    exit();
    35d8:	e8 90 03 00 00       	call   396d <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    35df:	68 49 4d 00 00       	push   $0x4d49
    35e4:	6a 01                	push   $0x1
    35e6:	e8 f5 04 00 00       	call   3ae0 <printf>
    exit();
    35eb:	e8 7d 03 00 00       	call   396d <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35f7:	6a 00                	push   $0x0
    35f9:	68 d3 4d 00 00       	push   $0x4dd3
    35fe:	e8 aa 03 00 00       	call   39ad <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 df 03 00 00       	call   39f5 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 60 03 00 00       	call   3985 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 68 03 00 00       	call   3995 <close>
  printf(1, "arg test passed\n");
    362d:	58                   	pop    %eax
    362e:	5a                   	pop    %edx
    362f:	68 e5 4d 00 00       	push   $0x4de5
    3634:	6a 01                	push   $0x1
    3636:	e8 a5 04 00 00       	call   3ae0 <printf>
}
    ...
    3643:	51                   	push   %ecx
    3644:	51                   	push   %ecx
    3645:	68 d8 4d 00 00       	push   $0x4dd8
    364a:	6a 02                	push   $0x2
    364c:	e8 8f 04 00 00       	call   3ae0 <printf>
    exit();
    3651:	e8 17 03 00 00       	call   396d <exit>
    3656:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    365d:	8d 76 00             	lea    0x0(%esi),%esi

00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 50 5f 00 00 0d 	imul   $0x19660d,0x5f50,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 50 5f 00 00       	mov    %eax,0x5f50
}
    3674:	c3                   	ret    
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 c8 01 00 00       	call   3985 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 8b 01 00 00       	call   39ad <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 8e 01 00 00       	call   39c5 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 54 01 00 00       	call   3995 <close>
  return r;
...
thread_create(void (*fn)(void *), void *arg)
{
  ...
  void *mem = malloc(4096 * 2);
    ...
    38dc:	e8 2f 04 00 00       	call   3d10 <malloc>
  if(mem == 0)
    38e1:	83 c4 10             	add    $0x10,%esp
    38e4:	85 c0                	test   %eax,%eax
    38e6:	74 32                	je     391a <thread_create+0x4a>
    38e8:	89 c3                	mov    %eax,%ebx
    return -1;
  
  char *p = (char *)mem;
  while ((uint)p % 4096 != 0) {
    38ea:	a9 ff 0f 00 00       	test   $0xfff,%eax
    38ef:	74 12                	je     3903 <thread_create+0x33>
    38f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    p++;
    38f8:	83 c3 01             	add    $0x1,%ebx
  while ((uint)p % 4096 != 0) {
    38fb:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
    3901:	75 f5                	jne    38f8 <thread_create+0x28>
    printf(1, "LOLOLOL %p\n", fn);
    free(stack);
    return -1;
  }
  ...
  int tid = clone(stack);
    ...
    3906:	53                   	push   %ebx
    3907:	e8 01 01 00 00       	call   3a0d <clone>
  if(tid < 0){
    390c:	83 c4 10             	add    $0x10,%esp
    390f:	85 c0                	test   %eax,%eax
    3911:	78 0e                	js     3921 <thread_create+0x51>
    free(stack);
    return -1;
  }
  ...
  if(tid == 0){
    3913:	74 1f                	je     3934 <thread_create+0x64>
    exit();
  }
  ...
  return tid;
    ...
    3915:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3918:	c9                   	leave  
    3919:	c3                   	ret    
    return -1;
    391a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    391f:	eb f4                	jmp    3915 <thread_create+0x45>
    free(stack);
    3921:	83 ec 0c             	sub    $0xc,%esp
    3924:	53                   	push   %ebx
    3925:	e8 56 03 00 00       	call   3c80 <free>
    return -1;
    392a:	83 c4 10             	add    $0x10,%esp
    392d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3932:	eb e1                	jmp    3915 <thread_create+0x45>
    printf(1, "Entering thread function at %p\n", fn);
    3934:	50                   	push   %eax
    3935:	ff 75 08             	pushl  0x8(%ebp)
    3938:	68 a0 55 00 00       	push   $0x55a0
    393d:	6a 01                	push   $0x1
    393f:	e8 9c 01 00 00       	call   3ae0 <printf>
    fn(arg);
    3944:	5a                   	pop    %edx
    3945:	ff 75 0c             	pushl  0xc(%ebp)
    3948:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
    394b:	89 1c 24             	mov    %ebx,(%esp)
    394e:	e8 2d 03 00 00       	call   3c80 <free>
    exit();
    3953:	e8 15 00 00 00       	call   396d <exit>
    3958:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    395f:	90                   	nop

00003960 <thread_join>:

int
thread_join(void)
{
  return join();
    3960:	e9 c0 00 00 00       	jmp    3a25 <join>
...
0000396d <exit>:
SYSCALL(exit)
    396d:	b8 02 00 00 00       	mov    $0x2,%eax
    3972:	cd 40                	int    $0x40
    3974:	c3                   	ret    

00003975 <wait>:
SYSCALL(wait)
    3975:	b8 03 00 00 00       	mov    $0x3,%eax
    397a:	cd 40                	int    $0x40
    397c:	c3                   	ret    

0000397d <pipe>:
SYSCALL(pipe)
    397d:	b8 04 00 00 00       	mov    $0x4,%eax
    3982:	cd 40                	int    $0x40
    3984:	c3                   	ret    

00003985 <read>:
SYSCALL(read)
    3985:	b8 05 00 00 00       	mov    $0x5,%eax
    398a:	cd 40                	int    $0x40
    398c:	c3                   	ret    

0000398d <write>:
SYSCALL(write)
    398d:	b8 10 00 00 00       	mov    $0x10,%eax
    3992:	cd 40                	int    $0x40
    3994:	c3                   	ret    

00003995 <close>:
SYSCALL(close)
    3995:	b8 15 00 00 00       	mov    $0x15,%eax
    399a:	cd 40                	int    $0x40
    399c:	c3                   	ret    

0000399d <kill>:
SYSCALL(kill)
    399d:	b8 06 00 00 00       	mov    $0x6,%eax
    39a2:	cd 40                	int    $0x40
    39a4:	c3                   	ret    

000039a5 <exec>:
SYSCALL(exec)
    39a5:	b8 07 00 00 00       	mov    $0x7,%eax
    39aa:	cd 40                	int    $0x40
    39ac:	c3                   	ret    

000039ad <open>:
SYSCALL(open)
    39ad:	b8 0f 00 00 00       	mov    $0xf,%eax
    39b2:	cd 40                	int    $0x40
    39b4:	c3                   	ret    

000039b5 <mknod>:
SYSCALL(mknod)
    39b5:	b8 11 00 00 00       	mov    $0x11,%eax
    39ba:	cd 40                	int    $0x40
    39bc:	c3                   	ret    

000039bd <unlink>:
SYSCALL(unlink)
    39bd:	b8 12 00 00 00       	mov    $0x12,%eax
    39c2:	cd 40                	int    $0x40
    39c4:	c3                   	ret    

000039c5 <fstat>:
SYSCALL(fstat)
    39c5:	b8 08 00 00 00       	mov    $0x8,%eax
    39ca:	cd 40                	int    $0x40
    39cc:	c3                   	ret    

000039cd <link>:
SYSCALL(link)
    39cd:	b8 13 00 00 00       	mov    $0x13,%eax
    39d2:	cd 40                	int    $0x40
    39d4:	c3                   	ret    

000039d5 <mkdir>:
SYSCALL(mkdir)
    39d5:	b8 14 00 00 00       	mov    $0x14,%eax
    39da:	cd 40                	int    $0x40
    39dc:	c3                   	ret    

000039dd <chdir>:
SYSCALL(chdir)
    39dd:	b8 09 00 00 00       	mov    $0x9,%eax
    39e2:	cd 40                	int    $0x40
    39e4:	c3                   	ret    

000039e5 <dup>:
SYSCALL(dup)
    39e5:	b8 0a 00 00 00       	mov    $0xa,%eax
    39ea:	cd 40                	int    $0x40
    39ec:	c3                   	ret    

000039ed <getpid>:
SYSCALL(getpid)
    39ed:	b8 0b 00 00 00       	mov    $0xb,%eax
    39f2:	cd 40                	int    $0x40
    39f4:	c3                   	ret    

000039f5 <sbrk>:
SYSCALL(sbrk)
    39f5:	b8 0c 00 00 00       	mov    $0xc,%eax
    39fa:	cd 40                	int    $0x40
    39fc:	c3                   	ret    

000039fd <sleep>:
SYSCALL(sleep)
    39fd:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a02:	cd 40                	int    $0x40
    3a04:	c3                   	ret    

00003a05 <uptime>:
SYSCALL(uptime)
    3a05:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a0a:	cd 40                	int    $0x40
    3a0c:	c3                   	ret    

00003a0d <clone>:
SYSCALL(clone)
    3a0d:	b8 16 00 00 00       	mov    $0x16,%eax
    3a12:	cd 40                	int    $0x40
    3a14:	c3                   	ret    

00003a15 <lock>:
SYSCALL(lock)
    3a15:	b8 17 00 00 00       	mov    $0x17,%eax
    3a1a:	cd 40                	int    $0x40
    3a1c:	c3                   	ret    

00003a1d <unlock>:
SYSCALL(unlock)
    3a1d:	b8 18 00 00 00       	mov    $0x18,%eax
    3a22:	cd 40                	int    $0x40
    3a24:	c3                   	ret    

00003a25 <join>:
SYSCALL(join)
    3a25:	b8 19 00 00 00       	mov    $0x19,%eax
    3a2a:	cd 40                	int    $0x40
    3a2c:	c3                   	ret    
    ...
    3a3c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    3a69:	0f b6 92 20 56 00 00 	movzbl 0x5620(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    3aae:	56                   	push   %esi
    3aaf:	57                   	push   %edi
    3ab0:	e8 d8 fe ff ff       	call   398d <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3ae9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    3aec:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    3aef:	0f b6 13             	movzbl (%ebx),%edx
    3af2:	84 d2                	test   %dl,%dl
    3af4:	74 6a                	je     3b60 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    3af6:	8d 45 10             	lea    0x10(%ebp),%eax
    3af9:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3afc:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    3aff:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    3b01:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3b04:	eb 36                	jmp    3b3c <printf+0x5c>
    ...
    if(state == 0){
      if(c == '%'){
        state = '%';
    3b13:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    3b18:	83 f8 25             	cmp    $0x25,%eax
    3b1b:	74 15                	je     3b32 <printf+0x52>
  write(fd, &c, 1);
    ...
    3b25:	57                   	push   %edi
    3b26:	56                   	push   %esi
    3b27:	e8 61 fe ff ff       	call   398d <write>
    3b2c:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    3b2f:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3b32:	0f b6 13             	movzbl (%ebx),%edx
    3b35:	83 c3 01             	add    $0x1,%ebx
    3b38:	84 d2                	test   %dl,%dl
    3b3a:	74 24                	je     3b60 <printf+0x80>
    c = fmt[i] & 0xff;
    3b3c:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    3b3f:	85 c9                	test   %ecx,%ecx
    3b41:	74 cd                	je     3b10 <printf+0x30>
      }
    } else if(state == '%'){
    3b43:	83 f9 25             	cmp    $0x25,%ecx
    3b46:	75 ea                	jne    3b32 <printf+0x52>
      if(c == 'd'){
    3b48:	83 f8 25             	cmp    $0x25,%eax
    3b4b:	0f 84 07 01 00 00    	je     3c58 <printf+0x178>
    3b51:	83 e8 63             	sub    $0x63,%eax
    3b54:	83 f8 15             	cmp    $0x15,%eax
    3b57:	77 17                	ja     3b70 <printf+0x90>
    3b59:	ff 24 85 c8 55 00 00 	jmp    *0x55c8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3b73:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    3b76:	6a 01                	push   $0x1
    3b78:	57                   	push   %edi
    3b79:	56                   	push   %esi
    3b7a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3b7e:	e8 0a fe ff ff       	call   398d <write>
        putc(fd, c);
    3b83:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    3b87:	83 c4 0c             	add    $0xc,%esp
    3b8a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3b8d:	6a 01                	push   $0x1
    3b8f:	57                   	push   %edi
    3b90:	56                   	push   %esi
    3b91:	e8 f7 fd ff ff       	call   398d <write>
        putc(fd, c);
    3b96:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b99:	31 c9                	xor    %ecx,%ecx
    3b9b:	eb 95                	jmp    3b32 <printf+0x52>
    3b9d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3ba0:	83 ec 0c             	sub    $0xc,%esp
    3ba3:	b9 10 00 00 00       	mov    $0x10,%ecx
    3ba8:	6a 00                	push   $0x0
    3baa:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3bad:	8b 10                	mov    (%eax),%edx
    3baf:	89 f0                	mov    %esi,%eax
    3bb1:	e8 7a fe ff ff       	call   3a30 <printint>
        ap++;
    3bb6:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3bba:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bbd:	31 c9                	xor    %ecx,%ecx
    3bbf:	e9 6e ff ff ff       	jmp    3b32 <printf+0x52>
    3bc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3bc8:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3bcb:	8b 10                	mov    (%eax),%edx
        ap++;
    3bcd:	83 c0 04             	add    $0x4,%eax
    3bd0:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3bd3:	85 d2                	test   %edx,%edx
    3bd5:	0f 84 8d 00 00 00    	je     3c68 <printf+0x188>
        while(*s != 0){
    3bdb:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    3bde:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    3be0:	84 c0                	test   %al,%al
    3be2:	0f 84 4a ff ff ff    	je     3b32 <printf+0x52>
    3be8:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3beb:	89 d3                	mov    %edx,%ebx
    3bed:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    3bf0:	83 ec 04             	sub    $0x4,%esp
          s++;
    3bf3:	83 c3 01             	add    $0x1,%ebx
    3bf6:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3bf9:	6a 01                	push   $0x1
    3bfb:	57                   	push   %edi
    3bfc:	56                   	push   %esi
    3bfd:	e8 8b fd ff ff       	call   398d <write>
        while(*s != 0){
    3c02:	0f b6 03             	movzbl (%ebx),%eax
    3c05:	83 c4 10             	add    $0x10,%esp
    3c08:	84 c0                	test   %al,%al
    3c0a:	75 e4                	jne    3bf0 <printf+0x110>
      state = 0;
    3c0c:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    3c0f:	31 c9                	xor    %ecx,%ecx
    3c11:	e9 1c ff ff ff       	jmp    3b32 <printf+0x52>
    ...
    3c28:	6a 01                	push   $0x1
    3c2a:	e9 7b ff ff ff       	jmp    3baa <printf+0xca>
    3c2f:	90                   	nop
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    3c33:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    3c36:	8b 00                	mov    (%eax),%eax
  write(fd, &c, 1);
    3c38:	6a 01                	push   $0x1
    3c3a:	57                   	push   %edi
    3c3b:	56                   	push   %esi
        putc(fd, *ap);
    3c3c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3c3f:	e8 49 fd ff ff       	call   398d <write>
        ap++;
    3c44:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3c48:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c4b:	31 c9                	xor    %ecx,%ecx
    3c4d:	e9 e0 fe ff ff       	jmp    3b32 <printf+0x52>
    3c52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    3c58:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3c5b:	83 ec 04             	sub    $0x4,%esp
    3c5e:	e9 2a ff ff ff       	jmp    3b8d <printf+0xad>
    3c63:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3c67:	90                   	nop
          s = "(null)";
    3c68:	ba c0 55 00 00       	mov    $0x55c0,%edx
        while(*s != 0){
    3c6d:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3c70:	b8 28 00 00 00       	mov    $0x28,%eax
    3c75:	89 d3                	mov    %edx,%ebx
    3c77:	e9 74 ff ff ff       	jmp    3bf0 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c81:	a1 20 a7 00 00       	mov    0xa720,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3c98:	89 c2                	mov    %eax,%edx
    3c9a:	8b 00                	mov    (%eax),%eax
    3c9c:	39 ca                	cmp    %ecx,%edx
    3c9e:	73 30                	jae    3cd0 <free+0x50>
    3ca0:	39 c1                	cmp    %eax,%ecx
    3ca2:	72 04                	jb     3ca8 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3ca4:	39 c2                	cmp    %eax,%edx
    3ca6:	72 f0                	jb     3c98 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3ca8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3cab:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3cae:	39 f8                	cmp    %edi,%eax
    3cb0:	74 30                	je     3ce2 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    3cb2:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3cb5:	8b 42 04             	mov    0x4(%edx),%eax
    3cb8:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3cbb:	39 f1                	cmp    %esi,%ecx
    3cbd:	74 3a                	je     3cf9 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3cbf:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    3cc1:	5b                   	pop    %ebx
  freep = p;
    3cc2:	89 15 20 a7 00 00    	mov    %edx,0xa720
}
    3cc8:	5e                   	pop    %esi
    3cc9:	5f                   	pop    %edi
    3cca:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3cd0:	39 c2                	cmp    %eax,%edx
    3cd2:	72 c4                	jb     3c98 <free+0x18>
    3cd4:	39 c1                	cmp    %eax,%ecx
    3cd6:	73 c0                	jae    3c98 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    3cd8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3cdb:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3cde:	39 f8                	cmp    %edi,%eax
    3ce0:	75 d0                	jne    3cb2 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    3ce2:	03 70 04             	add    0x4(%eax),%esi
    3ce5:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3ce8:	8b 02                	mov    (%edx),%eax
    3cea:	8b 00                	mov    (%eax),%eax
    3cec:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3cef:	8b 42 04             	mov    0x4(%edx),%eax
    3cf2:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3cf5:	39 f1                	cmp    %esi,%ecx
    3cf7:	75 c6                	jne    3cbf <free+0x3f>
    p->s.size += bp->s.size;
    3cf9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    3cfc:	89 15 20 a7 00 00    	mov    %edx,0xa720
    p->s.size += bp->s.size;
    3d02:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3d05:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3d08:	89 0a                	mov    %ecx,(%edx)
}
    3d0a:	5b                   	pop    %ebx
    3d0b:	5e                   	pop    %esi
    3d0c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d1c:	8b 3d 20 a7 00 00    	mov    0xa720,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3d22:	8d 70 07             	lea    0x7(%eax),%esi
    3d25:	c1 ee 03             	shr    $0x3,%esi
    3d28:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    3d2b:	85 ff                	test   %edi,%edi
    3d2d:	0f 84 9d 00 00 00    	je     3dd0 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d33:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    3d35:	8b 4a 04             	mov    0x4(%edx),%ecx
    3d38:	39 f1                	cmp    %esi,%ecx
    3d3a:	73 6a                	jae    3da6 <malloc+0x96>
    3d3c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3d41:	39 de                	cmp    %ebx,%esi
    3d43:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3d46:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3d4d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3d50:	eb 17                	jmp    3d69 <malloc+0x59>
    3d52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d58:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3d5a:	8b 48 04             	mov    0x4(%eax),%ecx
    3d5d:	39 f1                	cmp    %esi,%ecx
    3d5f:	73 4f                	jae    3db0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3d61:	8b 3d 20 a7 00 00    	mov    0xa720,%edi
    3d67:	89 c2                	mov    %eax,%edx
    3d69:	39 d7                	cmp    %edx,%edi
    3d6b:	75 eb                	jne    3d58 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    3d6d:	83 ec 0c             	sub    $0xc,%esp
    3d70:	ff 75 e4             	pushl  -0x1c(%ebp)
    3d73:	e8 7d fc ff ff       	call   39f5 <sbrk>
  if(p == (char*)-1)
    3d78:	83 c4 10             	add    $0x10,%esp
    3d7b:	83 f8 ff             	cmp    $0xffffffff,%eax
    3d7e:	74 1c                	je     3d9c <malloc+0x8c>
  hp->s.size = nu;
    3d80:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3d83:	83 ec 0c             	sub    $0xc,%esp
    3d86:	83 c0 08             	add    $0x8,%eax
    3d89:	50                   	push   %eax
    3d8a:	e8 f1 fe ff ff       	call   3c80 <free>
  return freep;
    3d8f:	8b 15 20 a7 00 00    	mov    0xa720,%edx
      if((p = morecore(nunits)) == 0)
    3d95:	83 c4 10             	add    $0x10,%esp
    3d98:	85 d2                	test   %edx,%edx
    3d9a:	75 bc                	jne    3d58 <malloc+0x48>
        return 0;
  }
}
    3d9c:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3da8:	89 fa                	mov    %edi,%edx
    3daa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3db0:	39 ce                	cmp    %ecx,%esi
    3db2:	74 4c                	je     3e00 <malloc+0xf0>
        p->s.size -= nunits;
    3db4:	29 f1                	sub    %esi,%ecx
    3db6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3db9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3dbc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3dbf:	89 15 20 a7 00 00    	mov    %edx,0xa720
}
    ...
    3dcf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3dd0:	c7 05 20 a7 00 00 24 	movl   $0xa724,0xa720
    3dd7:	a7 00 00 
    base.s.size = 0;
    3dda:	bf 24 a7 00 00       	mov    $0xa724,%edi
    base.s.ptr = freep = prevp = &base;
    3ddf:	c7 05 24 a7 00 00 24 	movl   $0xa724,0xa724
    3de6:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3de9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3deb:	c7 05 28 a7 00 00 00 	movl   $0x0,0xa728
    3df2:	00 00 00 
    if(p->s.size >= nunits){
    3df5:	e9 42 ff ff ff       	jmp    3d3c <malloc+0x2c>
    3dfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3e00:	8b 08                	mov    (%eax),%ecx
    3e02:	89 0a                	mov    %ecx,(%edx)
    3e04:	eb b9                	jmp    3dbf <malloc+0xaf>
