...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 9b 03 00 00       	call   3d5 <mkdir>
  ...
  exit();
  4b:	e8 1d 03 00 00       	call   36d <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 6e 04 00 00       	call   4e0 <printf>
    exit();
  72:	e8 f6 02 00 00       	call   36d <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 c8 01 00 00       	call   385 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 8b 01 00 00       	call   3ad <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 8e 01 00 00       	call   3c5 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 54 01 00 00       	call   395 <close>
  return r;
...
thread_create(void (*fn)(void *), void *arg)
{
 ...
 2d7:	68 00 20 00 00       	push   $0x2000
 2dc:	e8 2f 04 00 00       	call   710 <malloc>
  if(mem == 0)
 2e1:	83 c4 10             	add    $0x10,%esp
 2e4:	85 c0                	test   %eax,%eax
 2e6:	74 32                	je     31a <thread_create+0x4a>
 2e8:	89 c3                	mov    %eax,%ebx
    return -1;
  
  char *p = (char *)mem;
  while ((uint)p % 4096 != 0) {
 2ea:	a9 ff 0f 00 00       	test   $0xfff,%eax
 2ef:	74 12                	je     303 <thread_create+0x33>
 2f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    p++;
 2f8:	83 c3 01             	add    $0x1,%ebx
  while ((uint)p % 4096 != 0) {
 2fb:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
 301:	75 f5                	jne    2f8 <thread_create+0x28>
    printf(1, "LOLOLOL %p\n", fn);
    free(stack);
    return -1;
  }
 ...
 306:	53                   	push   %ebx
 307:	e8 01 01 00 00       	call   40d <clone>
  if(tid < 0){
 30c:	83 c4 10             	add    $0x10,%esp
 30f:	85 c0                	test   %eax,%eax
 311:	78 0e                	js     321 <thread_create+0x51>
    free(stack);
    return -1;
  }
  ...
  if(tid == 0){
 313:	74 1f                	je     334 <thread_create+0x64>
    exit();
  }
 ...
 31f:	eb f4                	jmp    315 <thread_create+0x45>
    free(stack);
 321:	83 ec 0c             	sub    $0xc,%esp
 324:	53                   	push   %ebx
 325:	e8 56 03 00 00       	call   680 <free>
    return -1;
 32a:	83 c4 10             	add    $0x10,%esp
 32d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 332:	eb e1                	jmp    315 <thread_create+0x45>
    printf(1, "Entering thread function at %p\n", fn);
 334:	50                   	push   %eax
 335:	ff 75 08             	pushl  0x8(%ebp)
 338:	68 3c 08 00 00       	push   $0x83c
 33d:	6a 01                	push   $0x1
 33f:	e8 9c 01 00 00       	call   4e0 <printf>
    fn(arg);
 344:	5a                   	pop    %edx
 345:	ff 75 0c             	pushl  0xc(%ebp)
 348:	ff 55 08             	call   *0x8(%ebp)
    free(stack);
 34b:	89 1c 24             	mov    %ebx,(%esp)
 34e:	e8 2d 03 00 00       	call   680 <free>
    exit();
 353:	e8 15 00 00 00       	call   36d <exit>
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 64 08 00 00 	jmp    *0x864(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 5c 08 00 00       	mov    $0x85c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 b0 0b 00 00       	mov    0xbb0,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 b0 0b 00 00 b4 	movl   $0xbb4,0xbb0
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf b4 0b 00 00       	mov    $0xbb4,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 b4 0b 00 00 b4 	movl   $0xbb4,0xbb4
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 7f2:	00 00 00 
    if(p->s.size >= nunits){
