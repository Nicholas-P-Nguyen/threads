...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 1c 03 00 00       	call   356 <mkdir>
...
free(void *ap)
{
 ...
 601:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 fc 0a 00 00    	mov    %edx,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 757:	0b 00 00 
    base.s.size = 0;
 75a:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 772:	00 00 00 
    if(p->s.size >= nunits){
