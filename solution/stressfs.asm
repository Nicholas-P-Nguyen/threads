  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 43 03 00 00       	call   3a6 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 46 03 00 00       	call   3ee <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 0f 03 00 00       	call   3ce <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 06 03 00 00       	call   3d6 <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 fb 02 00 00       	call   3ee <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 b7 02 00 00       	call   3c6 <read>
  for (i = 0; i < 20; i++)
 ...
 11b:	e8 b6 02 00 00       	call   3d6 <close>
  ...
  wait();
 120:	e8 91 02 00 00       	call   3b6 <wait>

  exit();
 125:	e8 84 02 00 00       	call   3ae <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 49 01 00 00       	call   3c6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 0c 01 00 00       	call   3ee <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 0f 01 00 00       	call   406 <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 d5 00 00 00       	call   3d6 <close>
  return r;
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4ee:	56                   	push   %esi
 4ef:	57                   	push   %edi
 4f0:	e8 d9 fe ff ff       	call   3ce <write>
  while(--i >= 0)
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 565:	57                   	push   %edi
 566:	56                   	push   %esi
 567:	e8 62 fe ff ff       	call   3ce <write>
 ...
 5be:	e8 0b fe ff ff       	call   3ce <write>
        putc(fd, c);
 ...
 5cf:	57                   	push   %edi
 5d0:	56                   	push   %esi
 5d1:	e8 f8 fd ff ff       	call   3ce <write>
        putc(fd, c);
 ...
 63b:	57                   	push   %edi
 63c:	56                   	push   %esi
 63d:	e8 8c fd ff ff       	call   3ce <write>
        while(*s != 0){
 ...
 67c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 67f:	e8 4a fd ff ff       	call   3ce <write>
        ap++;
 ...
 6c1:	a1 ac 0b 00 00       	mov    0xbac,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 ac 0b 00 00    	mov    %edx,0xbac
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 ac 0b 00 00    	mov    %edx,0xbac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d ac 0b 00 00    	mov    0xbac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d ac 0b 00 00    	mov    0xbac,%edi
 ...
 7b3:	e8 7e fc ff ff       	call   436 <sbrk>
  if(p == (char*)-1)
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 ac 0b 00 00    	mov    0xbac,%edx
 ...
 817:	0b 00 00 
    base.s.size = 0;
 81a:	bf b0 0b 00 00       	mov    $0xbb0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 b4 0b 00 00 00 	movl   $0x0,0xbb4
 832:	00 00 00 
    if(p->s.size >= nunits){
