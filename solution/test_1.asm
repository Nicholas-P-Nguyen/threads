...
main(int argc, char* argv[])
{
  ...
  18:	e8 e1 03 00 00       	call   3fe <clone>
  ...
  2e:	83 05 00 10 00 00 01 	addl   $0x1,0x1000
        sleep(10);
  35:	6a 0a                	push   $0xa
  37:	e8 b2 03 00 00       	call   3ee <sleep>
      for(int i = 0; i < 5; i++) {
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	83 eb 01             	sub    $0x1,%ebx
  42:	75 e7                	jne    2b <main+0x2b>
      exit();
  44:	e8 15 03 00 00       	call   35e <exit>
  ...
  60:	01 c3                	add    %eax,%ebx
        sleep(5);
  62:	e8 87 03 00 00       	call   3ee <sleep>
      for(int i = 0; i < 20; i++) {
  ...
  77:	6a 21                	push   $0x21
  79:	68 f8 07 00 00       	push   $0x7f8
  7e:	68 01 08 00 00       	push   $0x801
  83:	68 0b 08 00 00       	push   $0x80b
  88:	6a 01                	push   $0x1
  8a:	e8 41 04 00 00       	call   4d0 <printf>
  8f:	83 c4 18             	add    $0x18,%esp
  92:	68 2c 08 00 00       	push   $0x82c
  97:	6a 01                	push   $0x1
  99:	e8 32 04 00 00       	call   4d0 <printf>
  9e:	5b                   	pop    %ebx
  9f:	5e                   	pop    %esi
  a0:	68 15 08 00 00       	push   $0x815
  a5:	6a 01                	push   $0x1
  a7:	e8 24 04 00 00       	call   4d0 <printf>
  ac:	e8 ad 02 00 00       	call   35e <exit>
                        printf(1, "\n");
...
static void test_passed() {
  ...
  b1:	50                   	push   %eax
  b2:	68 01 08 00 00       	push   $0x801
  b7:	68 17 08 00 00       	push   $0x817
  bc:	6a 01                	push   $0x1
  be:	e8 0d 04 00 00       	call   4d0 <printf>
  c3:	83 c4 0c             	add    $0xc,%esp
  c6:	68 1c 08 00 00       	push   $0x81c
  cb:	68 28 08 00 00       	push   $0x828
  d0:	6a 01                	push   $0x1
  d2:	e8 f9 03 00 00       	call   4d0 <printf>
  d7:	5a                   	pop    %edx
  d8:	59                   	pop    %ecx
  d9:	68 15 08 00 00       	push   $0x815
  de:	6a 01                	push   $0x1
  e0:	e8 eb 03 00 00       	call   4d0 <printf>
      test_passed();
    }

    join();
  e5:	e8 2c 03 00 00       	call   416 <join>
    exit();
  ea:	e8 6f 02 00 00       	call   35e <exit>
  ef:	90                   	nop
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 58 08 00 00 	jmp    *0x858(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 50 08 00 00       	mov    $0x850,%edx
        while(*s != 0){
