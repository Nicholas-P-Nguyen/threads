...
main(int argc, char* argv[])
{
  ...
  18:	e8 40 04 00 00       	call   45d <clone>
  ...
  2e:	83 05 00 10 00 00 01 	addl   $0x1,0x1000
        sleep(10);
  35:	6a 0a                	push   $0xa
  37:	e8 11 04 00 00       	call   44d <sleep>
      for(int i = 0; i < 5; i++) {
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	83 eb 01             	sub    $0x1,%ebx
  42:	75 e7                	jne    2b <main+0x2b>
      exit();
  44:	e8 74 03 00 00       	call   3bd <exit>
  ...
  60:	01 c3                	add    %eax,%ebx
        sleep(5);
  62:	e8 e6 03 00 00       	call   44d <sleep>
      for(int i = 0; i < 20; i++) {
  ...
  77:	6a 21                	push   $0x21
  79:	68 58 08 00 00       	push   $0x858
  7e:	68 61 08 00 00       	push   $0x861
  83:	68 6b 08 00 00       	push   $0x86b
  88:	6a 01                	push   $0x1
  8a:	e8 a1 04 00 00       	call   530 <printf>
  8f:	83 c4 18             	add    $0x18,%esp
  92:	68 8c 08 00 00       	push   $0x88c
  97:	6a 01                	push   $0x1
  99:	e8 92 04 00 00       	call   530 <printf>
  9e:	5b                   	pop    %ebx
  9f:	5e                   	pop    %esi
  a0:	68 75 08 00 00       	push   $0x875
  a5:	6a 01                	push   $0x1
  a7:	e8 84 04 00 00       	call   530 <printf>
  ac:	e8 0c 03 00 00       	call   3bd <exit>
                        printf(1, "\n");
...
static void test_passed() {
  ...
  b1:	50                   	push   %eax
  b2:	68 61 08 00 00       	push   $0x861
  b7:	68 77 08 00 00       	push   $0x877
  bc:	6a 01                	push   $0x1
  be:	e8 6d 04 00 00       	call   530 <printf>
  c3:	83 c4 0c             	add    $0xc,%esp
  c6:	68 7c 08 00 00       	push   $0x87c
  cb:	68 88 08 00 00       	push   $0x888
  d0:	6a 01                	push   $0x1
  d2:	e8 59 04 00 00       	call   530 <printf>
  d7:	5a                   	pop    %edx
  d8:	59                   	pop    %ecx
  d9:	68 75 08 00 00       	push   $0x875
  de:	6a 01                	push   $0x1
  e0:	e8 4b 04 00 00       	call   530 <printf>
      test_passed();
    }

    join();
  e5:	e8 8b 03 00 00       	call   475 <join>
    exit();
  ea:	e8 ce 02 00 00       	call   3bd <exit>
  ef:	90                   	nop
